...
export const GLOSSARY = [
  ...
  { key: 'sarm', match: { hu: ['sarm'], en: ['sarm'], pl: ['sarm'] },
    ...
    def: { hu: 'Szelektív androgénreceptor-modulátor: az androgénreceptorra szövet-szelektíven ható, nem-szteroid vegyület.', en: 'Selective androgen receptor modulator: a non-steroidal compound that acts tissue-selectively on the androgen receptor.', pl: 'Selektywny modulator receptora androgenowego: niesteroidowy związek działający tkankowo-selektywnie na receptor androgenowy.' } },
