...
export default {
  ...
  "defaultBacMl": 1,
  "defaultDoseMcg": 10,
  "shortDesc": "9-aminokwasowy neuropeptyd, więzi społeczne i poród",
  "description": "Oksytocyna (Pitocin) to 9-aminokwasowy neuropeptyd używany klinicznie do stymulacji macicy i wsparcia laktacji; donosowo badana w zachowaniu społecznym i psychiatrii.",
  "keyInfo": [
    {
      "label": "Typ",
      "value": "Nonapeptyd"
