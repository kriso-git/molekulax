...
export default {
  "id": "metformin",
  "sideEffects": [
    { "hu": "Laktát-acidózis (ritka, de életveszélyes, FDA boxed warning): izomgyengeség, hasi fájdalom, gyors légzés, hipotermia; kockázat fokozott vesekárosodás, dehidráció, alkohol vagy hipoxia esetén.", "en": "Lactic acidosis (rare but life-threatening, FDA boxed warning): muscle weakness, abdominal pain, rapid breathing, hypothermia; risk increased with renal impairment, dehydration, alcohol or hypoxia.", "pl": "Kwasica mleczanowa (rzadka, ale zagrażająca życiu, ostrzeżenie w ramce FDA): osłabienie mięśni, ból brzucha, przyspieszony oddech, hipotermia; ryzyko większe przy niewydolności nerek, odwodnieniu, alkoholu lub hipoksji." },
    { "hu": "Gasztrointesztinális zavarok (20-30%): hányinger, hasmenés, hasi diszkomfort, puffadás; étkezéssel és lassú titrációval, illetve XR-készítménnyel csökkenthető.", "en": "Gastrointestinal effects (20-30%): nausea, diarrhea, abdominal discomfort, bloating; reduced by taking with food, slow titration, or an extended-release formulation.", "pl": "Zaburzenia żołądkowo-jelitowe (20-30%): nudności, biegunka, dyskomfort w jamie brzusznej, wzdęcia; łagodzone przyjmowaniem z posiłkiem, powolnym zwiększaniem dawki lub postacią o przedłużonym uwalnianiu." },
    { "hu": "B12-vitamin felszívódásának csökkenése hosszú távú használat mellett, ami anémiát és perifériás neuropátiát okozhat; évenkénti B12-szint ellenőrzés ajánlott.", "en": "Reduced vitamin B12 absorption with long-term use, which may cause anemia and peripheral neuropathy; annual B12 monitoring is recommended.", "pl": "Zmniejszone wchłanianie witaminy B12 przy długotrwałym stosowaniu, co może powodować anemię i neuropatię obwodową; zalecana coroczna kontrola poziomu B12." },
    { "hu": "Fémes íz a szájban, étvágycsökkenés (általában átmeneti, a kezelés első heteiben).", "en": "Metallic taste, decreased appetite (usually transient, in the first weeks of treatment).", "pl": "Metaliczny posmak, zmniejszenie apetytu (zwykle przejściowe, w pierwszych tygodniach leczenia)." },
    { "hu": "Hipoglikémia: monoterápiában minimális, de inzulinnal vagy szulfonilureával kombinálva fokozott kockázat (remegés, izzadás, zavartság).", "en": "Hypoglycemia: minimal in monotherapy, but increased risk when combined with insulin or sulfonylureas (tremor, sweating, confusion).", "pl": "Hipoglikemia: minimalna w monoterapii, ale zwiększone ryzyko w połączeniu z insuliną lub pochodnymi sulfonylomocznika (drżenie, pocenie, splątanie)." }
  ],
  "contraindications": [
    { "hu": "Súlyos vesefunkció-zavar (eGFR < 30 ml/min/1,73 m²): kontraindikált a laktát-acidózis kockázata miatt; eGFR 30-45 között dóziscsökkentés és fokozott óvatosság.", "en": "Severe renal impairment (eGFR < 30 ml/min/1.73 m²): contraindicated due to lactic acidosis risk; dose reduction and caution required at eGFR 30-45.", "pl": "Ciężka niewydolność nerek (eGFR < 30 ml/min/1,73 m²): przeciwwskazana z powodu ryzyka kwasicy mleczanowej; redukcja dawki i ostrożność przy eGFR 30-45." },
    { "hu": "Akut metabolikus acidózis, beleértve a diabéteszes ketoacidózist; ilyenkor inzulin szükséges, a Metformin tilos.", "en": "Acute metabolic acidosis, including diabetic ketoacidosis; insulin is required and metformin is prohibited.", "pl": "Ostra kwasica metaboliczna, w tym cukrzycowa kwasica ketonowa; wymagana insulina, metformina przeciwwskazana." },
    { "hu": "Jód-tartalmú kontrasztanyaggal végzett képalkotás: a Metformint a vizsgálat napján szüneteltetni kell, és csak a vesefunkció ellenőrzése után, kb. 48 óra múlva újraindítani (laktát-acidózis-kockázat).", "en": "Iodinated contrast imaging: metformin must be paused on the day of the procedure and resumed only after renal function is confirmed, about 48 hours later (lactic acidosis risk).", "pl": "Obrazowanie z kontrastem jodowym: metforminę należy odstawić w dniu badania i wznowić dopiero po potwierdzeniu czynności nerek, około 48 godzin później (ryzyko kwasicy mleczanowej)." },
    { "hu": "Hipoxiát okozó vagy szöveti perfúziót rontó akut állapotok: akut súlyos szívelégtelenség, sokk, szepszis, légzési elégtelenség, friss szívinfarktus.", "en": "Acute conditions causing hypoxia or impaired tissue perfusion: acute severe heart failure, shock, sepsis, respiratory failure, recent myocardial infarction.", "pl": "Ostre stany powodujące hipoksję lub upośledzoną perfuzję tkanek: ostra ciężka niewydolność serca, wstrząs, sepsa, niewydolność oddechowa, świeży zawał serca." },
    { "hu": "Súlyos májkárosodás: csökkent laktát-clearance fokozza a laktát-acidózis kockázatát; krónikus vagy heveny alkoholizmus, akut alkoholmérgezés szintén ellenjavallat.", "en": "Severe hepatic impairment: reduced lactate clearance raises lactic acidosis risk; chronic or acute alcoholism and acute alcohol intoxication are also contraindicated.", "pl": "Ciężka niewydolność wątroby: zmniejszony klirens mleczanu zwiększa ryzyko kwasicy mleczanowej; przewlekły lub ostry alkoholizm oraz ostre zatrucie alkoholem również są przeciwwskazane." },
    { "hu": "Dehidráció és heveny lázas/hasmenéses betegség: a Metformint átmenetileg fel kell függeszteni a vesefunkció romlása és a laktát-acidózis kockázata miatt.", "en": "Dehydration and acute febrile/diarrheal illness: metformin should be temporarily withheld due to declining renal function and lactic acidosis risk.", "pl": "Odwodnienie i ostra choroba gorączkowa/biegunkowa: metforminę należy czasowo odstawić z powodu pogorszenia czynności nerek i ryzyka kwasicy mleczanowej." }
  ],
  "name": "Metformin",
