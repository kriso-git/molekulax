...
export default {
  "id": "bupropion",
  "sideEffects": [
    { "hu": "FIGYELMEZTETÉS (boxed warning): öngyilkossági gondolatok és viselkedés fokozott kockázata gyermekeknél, serdülőknél és fiatal felnőtteknél (<25 év) a kezelés kezdetén vagy dózisváltáskor; szoros monitorozás szükséges.", "en": "BOXED WARNING: increased risk of suicidal thoughts and behavior in children, adolescents and young adults (<25 yrs) at treatment start or dose change; close monitoring required.", "pl": "OSTRZEŻENIE (boxed): zwiększone ryzyko myśli i zachowań samobójczych u dzieci, młodzieży i młodych dorosłych (<25 lat) na początku leczenia lub przy zmianie dawki; konieczne ścisłe monitorowanie." },
    { "hu": "Dózisfüggő görcsroham: ~0,1% standard dózisnál (≤300 mg/nap), ~0,4% 450 mg/napnál, fölötte exponenciálisan emelkedik; ez a leg jellemzőbb súlyos kockázat. Max-dózis (SR 400, XL 450 mg/nap) betartása kötelező, tablettát törni tilos.", "en": "Dose-dependent seizures: ~0.1% at standard dose (≤300 mg/day), ~0.4% at 450 mg/day, exponential above; the hallmark serious risk. Respect max dose (SR 400, XL 450 mg/day); do not crush tablets.", "pl": "Drgawki zależne od dawki: ~0,1% przy dawce standardowej (≤300 mg/dobę), ~0,4% przy 450 mg/dobę, powyżej wykładniczo; główne poważne ryzyko. Przestrzegać dawki maks. (SR 400, XL 450 mg/dobę); nie kruszyć tabletek." },
    { "hu": "Inszomnia (15-20%), szájszárazság (10-15%) és fejfájás (~10%); az álmatlanság miatt az utolsó dózis legkésőbb délutánra (kb. 17 óráig) időzítendő.", "en": "Insomnia (15-20%), dry mouth (10-15%) and headache (~10%); to limit insomnia, take the last dose by early afternoon (around 5 pm).", "pl": "Bezsenność (15-20%), suchość w ustach (10-15%) i ból głowy (~10%); aby ograniczyć bezsenność, ostatnią dawkę przyjmować do wczesnego popołudnia (ok. 17:00)." },
    { "hu": "Agitáció, szorongás, nyugtalanság és tremor, főleg az első hetekben; aktiváló, nem szedáló profil, szűk terápiás ablakkal.", "en": "Agitation, anxiety, restlessness and tremor, especially in the first weeks; an activating, non-sedating profile with a narrow therapeutic window.", "pl": "Pobudzenie, lęk, niepokój i drżenie, zwłaszcza w pierwszych tygodniach; profil aktywujący, nieuspokajający, o wąskim oknie terapeutycznym." },
    { "hu": "Vérnyomás-emelkedés (dózisfüggő, NDRI-hatás); hipertónia kezdetén vérnyomás-monitorozás javasolt, főleg nikotinpótlással vagy más szimpatomimetikummal együtt.", "en": "Blood pressure elevation (dose-dependent NDRI effect); monitor BP at initiation, especially when combined with nicotine replacement or other sympathomimetics.", "pl": "Wzrost ciśnienia tętniczego (zależny od dawki efekt NDRI); monitorować ciśnienie na początku leczenia, zwłaszcza w połączeniu z nikotynową terapią zastępczą lub innymi sympatykomimetykami." },
    { "hu": "Súlyveszteség / étvágycsökkenés (5-8%); súly-neutrális vagy fogyasztó, ellentétben az SSRI-okkal (ez gyakran előny, de táplálkozási zavarban kockázat).", "en": "Weight loss / reduced appetite (5-8%); weight-neutral or weight-reducing unlike SSRIs (often a benefit, but a concern in eating disorders).", "pl": "Utrata masy ciała / zmniejszenie apetytu (5-8%); neutralny lub redukujący masę w przeciwieństwie do SSRI (często zaleta, ale ryzyko w zaburzeniach odżywiania)." },
    { "hu": "Neuropszichiátriai tünetek: mániát/hipomániát válthat ki bipoláris betegeknél (NDRI-aktiváció), ritkán pszichotikus tünetek, hallucináció vagy paranoia, főleg magas dózisnál.", "en": "Neuropsychiatric events: may trigger mania/hypomania in bipolar patients (NDRI activation); rarely psychotic symptoms, hallucinations or paranoia, mainly at high doses.", "pl": "Zdarzenia neuropsychiatryczne: może wywołać manię/hipomanię u chorych z chorobą dwubiegunową (aktywacja NDRI); rzadko objawy psychotyczne, omamy lub paranoja, głównie przy wysokich dawkach." },
    { "hu": "Túlérzékenységi reakciók: bőrkiütés, urticaria, viszketés, ritkán súlyos szérumbetegség-szerű reakció vagy Stevens-Johnson-szindróma; tartós vagy súlyosbodó kiütésnél a szert le kell állítani.", "en": "Hypersensitivity reactions: rash, urticaria, pruritus; rarely serum-sickness-like reaction or Stevens-Johnson syndrome; discontinue if rash persists or worsens.", "pl": "Reakcje nadwrażliwości: wysypka, pokrzywka, świąd; rzadko reakcja podobna do choroby posurowiczej lub zespół Stevensa-Johnsona; odstawić przy utrzymującej się lub nasilającej się wysypce." }
  ],
  "contraindications": [
    { "hu": "Görcsroham-zavar (epilepszia) anamnézis vagy ismert görcs-hajlam: a görcsküszöb-csökkentő hatás miatt abszolút ellenjavallt.", "en": "Seizure disorder (epilepsy) history or known seizure predisposition: absolutely contraindicated due to the seizure-threshold-lowering effect.", "pl": "Padaczka w wywiadzie lub znana predyspozycja do drgawek: bezwzględnie przeciwwskazany ze względu na obniżanie progu drgawkowego." },
    { "hu": "Jelenlegi vagy korábbi bulimia vagy anorexia nervosa: jelentősen emelt görcs-kockázat (elektrolit-zavar miatt) ellenjavallja.", "en": "Current or prior bulimia or anorexia nervosa: contraindicated due to markedly increased seizure risk (electrolyte disturbance).", "pl": "Bulimia lub jadłowstręt psychiczny obecnie lub w przeszłości: przeciwwskazany z powodu znacznie zwiększonego ryzyka drgawek (zaburzenia elektrolitowe)." },
    { "hu": "Akut alkohol-, benzodiazepin- vagy egyéb szedatohipnotikum- / antiepileptikum-elvonás: a hirtelen elvonás drámaian csökkenti a görcsküszöböt.", "en": "Abrupt withdrawal from alcohol, benzodiazepines or other sedatives / antiepileptics: sudden discontinuation sharply lowers the seizure threshold.", "pl": "Nagłe odstawienie alkoholu, benzodiazepin lub innych leków uspokajających / przeciwpadaczkowych: gwałtownie obniża próg drgawkowy." },
    { "hu": "MAO-gátló egyidejű vagy 14 napon belüli alkalmazása (Selegilin, Fenelzin, Tranilcipromin, valamint Linezolid és IV metilénkék): hipertenzív krízis kockázata; minimum 14 nap kimosási idő kötelező.", "en": "Concurrent or within-14-day MAO inhibitor use (selegiline, phenelzine, tranylcypromine, also linezolid and IV methylene blue): risk of hypertensive crisis; a 14-day washout is mandatory.", "pl": "Jednoczesne stosowanie inhibitora MAO lub w ciągu 14 dni (selegilina, fenelzyna, tranylcypromina, a także linezolid i dożylny błękit metylenowy): ryzyko przełomu nadciśnieniowego; obowiązkowy 14-dniowy okres wypłukania." },
    { "hu": "Egyidejűleg több bupropiont tartalmazó készítmény (pl. Wellbutrin + Zyban) szedése: halmozott dózis miatt görcs-kockázat, ellenjavallt.", "en": "Using more than one bupropion-containing product at once (e.g. Wellbutrin + Zyban): cumulative dose causes seizure risk; contraindicated.", "pl": "Stosowanie więcej niż jednego preparatu zawierającego bupropion jednocześnie (np. Wellbutrin + Zyban): ryzyko drgawek z powodu skumulowanej dawki; przeciwwskazane." },
    { "hu": "Ismert túlérzékenység a bupropionnal szemben (korábbi súlyos kiütés, urticaria, anafilaxiás vagy szérumbetegség-szerű reakció).", "en": "Known hypersensitivity to bupropion (prior severe rash, urticaria, anaphylactic or serum-sickness-like reaction).", "pl": "Znana nadwrażliwość na bupropion (wcześniejsza ciężka wysypka, pokrzywka, reakcja anafilaktyczna lub podobna do choroby posurowiczej)." },
    { "hu": "Óvatosság / relatív ellenjavallat: súlyos májkárosodás (Child-Pugh ≥10, csökkentett dózis vagy kerülés), kezeletlen bipoláris zavar (mánia-indukció, mood-stabilizer nélkül), valamint emelkedett görcs-kockázatú állapotok (koponyatrauma, ZNS-tumor).", "en": "Caution / relative contraindication: severe hepatic impairment (Child-Pugh >=10, reduce dose or avoid), untreated bipolar disorder (mania induction without a mood stabilizer), and conditions raising seizure risk (head trauma, CNS tumor).", "pl": "Ostrożność / przeciwwskazanie względne: ciężka niewydolność wątroby (Child-Pugh >=10, zmniejszyć dawkę lub unikać), nieleczona choroba dwubiegunowa (indukcja manii bez stabilizatora nastroju) oraz stany zwiększające ryzyko drgawek (uraz głowy, guz OUN)." }
  ],
  "name": "Bupropion",
