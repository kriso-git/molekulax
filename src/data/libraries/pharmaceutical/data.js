...
export const EXTRA_PHARMACEUTICAL = [
  ...
  // ===== EXTRA. ROSUVASTATIN (Kardio, hidrofil statin) =====
  {
    id: 'rosuvastatin',
    name: 'Rosuvastatin',
    image: null,
    ...
    description: {
      hu: 'A Rosuvastatin egy hidrofil HMG-CoA reduktáz-inhibitor (AstraZeneca Crestor, FDA 2003). Hatás-intenzitásban a legpotensebb statin — 40 mg/nap ~60-63%-os LDL-csökkenést okoz (vs Atorvastatin 80 mg ~55%). A JUPITER-trial (Ridker 2008 NEJM PMID 18997196) primer ASCVD-prevenciót igazolt emelt CRP-szintű, normo-LDL betegeknél. Kevésbé CYP-érintett mint Atorvastatin (főleg CYP2C9, kis CYP3A4), tehát kevesebb gyógyszer-interakció. Mellékhatás-profil hasonló a többi statinhoz.',
      en: 'Rosuvastatin is a hydrophilic HMG-CoA reductase inhibitor (AstraZeneca Crestor, FDA 2003). Most potent statin by intensity — 40 mg/day yields ~60-63% LDL reduction (vs atorvastatin 80 mg ~55%). JUPITER trial (Ridker 2008 NEJM PMID 18997196) established primary ASCVD prevention in elevated-CRP, normo-LDL patients. Less CYP-involved than atorvastatin (mainly CYP2C9, minor CYP3A4), so fewer drug interactions. Side effect profile similar to other statins.',
      pl: 'Rozuwastatyna to hydrofilna inhibitor reduktazy HMG-CoA (AstraZeneca Crestor, FDA 2003). Najmocniejsza statyna pod względem intensywności — 40 mg/dzień daje ~60-63% redukcję LDL (vs atorwastatyna 80 mg ~55%). Badanie JUPITER (Ridker 2008 NEJM PMID 18997196) ustanowiło prewencję pierwotną ASCVD u pacjentów z podwyższonym CRP, normo-LDL. Mniej CYP-zaangażowana niż atorwastatyna (głównie CYP2C9, mały CYP3A4), mniej interakcji. Profil działań podobny do innych statyn.',
    },
    mechanism: { hu: 'HMG-CoA reduktáz hidrofil kompetitív gátlása. Magasabb potencia, kevesebb pleiotróp lipofil-szerű hatás. CRP-csökkentés még normo-LDL-en is.', en: 'Hydrophilic competitive HMG-CoA reductase inhibition. Higher potency, fewer lipophilic-like pleiotropic effects. CRP reduction even at normo-LDL.', pl: 'Hydrofilne konkurencyjne hamowanie reduktazy HMG-CoA. Wyższa potencja, mniej efektów plejotropowych. Redukcja CRP nawet przy normo-LDL.' },
    legalStatus: { hu: 'EU/HU: vényköteles (Crestor, Roswera, generikus). USA: FDA Rx.', en: 'EU/HU: prescription only (Crestor, Roswera, generics). USA: FDA Rx.', pl: 'UE/PL: na receptę (Crestor, Roswera, generyki). USA: FDA Rx.' },
    onsetTime: '1-2 weeks (lipid), 4 weeks (steady-state LDL)',
    halfLife: '19 h (once-daily, any time)',
    atcCode: 'C10AA07',
    prescriptionStatus: { hu: 'Vényköteles (Rx)', en: 'Prescription only (Rx)', pl: 'Na receptę (Rx)' },
    indications: [
      { hu: 'Primer hipercholesterolémia, FH', en: 'Primary hypercholesterolemia, FH', pl: 'Pierwotna hipercholesterolemia, FH' },
      { hu: 'Szekunder ASCVD-prevenció', en: 'Secondary ASCVD prevention', pl: 'Wtórna prewencja ASCVD' },
      { hu: 'Primer prevenció emelt CRP-vel (JUPITER alapján)', en: 'Primary prevention with elevated CRP (JUPITER basis)', pl: 'Prewencja pierwotna z podwyższonym CRP (na podstawie JUPITER)' },
    ],
    contraindications: [
      { hu: 'Aktív májbetegség, terhesség, szoptatás', en: 'Active liver disease, pregnancy, lactation', pl: 'Aktywna choroba wątroby, ciąża, karmienie' },
      { hu: 'Súlyos vesefunkció-zavar (eGFR < 30 — 40 mg dózisra)', en: 'Severe renal impairment (eGFR < 30 — for 40 mg dose)', pl: 'Ciężka niewydolność nerek (eGFR < 30 — dla dawki 40 mg)' },
    ],
    commonSideEffects: [
      { hu: 'Izomfájdalom (3-5%), ALT/AST emelkedés (1-2%)', en: 'Muscle pain (3-5%), ALT/AST elevation (1-2%)', pl: 'Ból mięśni (3-5%), wzrost ALT/AST (1-2%)' },
      { hu: 'Új T2DM kockázat enyhe növekedése', en: 'Slightly increased new-onset T2DM risk', pl: 'Lekko zwiększone ryzyko nowej T2DM' },
      { hu: 'Súlyos, ritka: rhabdomyolysis (proteinuria + hematuria 40 mg-on gyakoribb mint más statinoknál)', en: 'Severe, rare: rhabdomyolysis (proteinuria + hematuria at 40 mg more common than other statins)', pl: 'Ciężkie, rzadkie: rabdomioliza (proteinuria + krwiomocz przy 40 mg częstsze niż inne statyny)' },
    ],
    cyp450: ['CYP2C9 substrate (minor)', 'OATP1B1 substrate (significant)', 'Less CYP3A4-dependent than atorvastatin'],
    crossMolInteractions: [
      { hu: 'Cyclosporine: AUC 7x emelkedés, kontraindikált 5 mg dózis felett', en: 'Cyclosporine: 7x AUC rise, contraindicated above 5 mg', pl: 'Cyklosporyna: 7x wzrost AUC, przeciwwskazane powyżej 5 mg' },
      { hu: 'Gemfibrozil: rhabdomyolysis-kockázat, kerülendő', en: 'Gemfibrozil: rhabdomyolysis risk, avoid', pl: 'Gemfibrozyl: ryzyko rabdomiolizy, unikać' },
      { hu: 'Warfarin: enyhe INR-emelkedés', en: 'Warfarin: mild INR rise', pl: 'Warfaryna: łagodny wzrost INR' },
    ],
    benefits: [
      { hu: 'Legpotensebb statin (40 mg ~60-63% LDL-csökkenés)', en: 'Most potent statin (40 mg ~60-63% LDL drop)', pl: 'Najmocniejsza statyna (40 mg ~60-63% spadek LDL)' },
      { hu: 'Kevesebb CYP-interakció vs Atorvastatin', en: 'Fewer CYP interactions vs atorvastatin', pl: 'Mniej interakcji CYP vs atorwastatyna' },
      { hu: 'JUPITER: primer ASCVD-prevenció CRP-vezérelt', en: 'JUPITER: CRP-driven primary ASCVD prevention', pl: 'JUPITER: prewencja ASCVD kierowana przez CRP' },
    ],
    studies: [
      { title: 'Rosuvastatin to prevent vascular events in men and women with elevated CRP (JUPITER)', authors: 'Ridker PM, Danielson E, Fonseca FA et al.', journal: 'N Engl J Med. 2008;359(21):2195-207.', pmid: '18997196' },
      { title: 'Intensive lipid lowering with atorvastatin in coronary disease (TNT) reference', authors: 'LaRosa JC, Grundy SM, Waters DD et al.', journal: 'N Engl J Med. 2005;352(14):1425-35.', pmid: '15755765' },
      { title: 'Efficacy and safety of cholesterol-lowering treatment (CTT)', authors: 'Baigent C, Blackwell L, Emberson J et al.', journal: 'Lancet. 2010;376(9753):1670-81.', pmid: '21067804' },
    ],
    related: ['atorvastatin'],
    doseCalc: {
      type: 'fixedDose',
      fixedDose: { low: 5, medium: 20, high: 40 },
      unit: 'mg/nap',
      note: {
        hu: 'Alacsony (5 mg ~38%): érzékeny páciens, indító dózis. Mérsékelt (10-20 mg ~46-55%): standard. Magas (40 mg ~60-63%): FH vagy magas-rizikójú szekunder prevenció. Étkezéstől függetlenül.',
        en: 'Low (5 mg ~38%): sensitive patient, start. Moderate (10-20 mg ~46-55%): standard. High (40 mg ~60-63%): FH or high-risk secondary prevention. Food-independent.',
        pl: 'Niska (5 mg ~38%): wrażliwy pacjent, start. Średnia (10-20 mg ~46-55%): standard. Wysoka (40 mg ~60-63%): FH lub wysokie ryzyko. Niezależnie od jedzenia.',
      },
    },
  },

  // ===== EXTRA. RAMIPRIL (Kardio, ACE inhibitor) =====
  {
    id: 'ramipril',
    name: 'Ramipril',
    image: null,
    ...
    description: {
      hu: 'A Ramipril egy pro-drug ACE-inhibitor (aktív metabolit Ramiprilat), amelyet a Sanofi-Aventis fejlesztett ki (Tritace EU, Altace USA, FDA 1991). Az angiotenzin-konvertáló enzim szelektív gátlása csökkenti az angiotenzin-II képződését, ami vazodilatációhoz és aldoszteron-szuppresszióhoz vezet. A HOPE-trial (Yusuf 2000 NEJM PMID 10639539) szerint a Ramipril szignifikáns MACE-csökkenést okoz magas-rizikó kardiovaszkuláris betegekben, függetlenül a vérnyomás-csökkentő hatástól (pleiotróp endotel-funkció-javítás).',
      en: 'Ramipril is a prodrug ACE inhibitor (active metabolite ramiprilat) developed by Sanofi-Aventis (Tritace EU, Altace USA, FDA 1991). Selective inhibition of angiotensin-converting enzyme reduces angiotensin II formation, causing vasodilation and aldosterone suppression. HOPE trial (Yusuf 2000 NEJM PMID 10639539) showed ramipril significantly reduces MACE in high-CV-risk patients independent of BP lowering (pleiotropic endothelial function improvement).',
      pl: 'Ramipril to prolek inhibitora ACE (aktywny metabolit ramiprilat) opracowany przez Sanofi-Aventis (Tritace UE, Altace USA, FDA 1991). Selektywne hamowanie enzymu konwertującego angiotensynę zmniejsza tworzenie angiotensyny II, powodując rozszerzenie naczyń i supresję aldosteronu. Badanie HOPE (Yusuf 2000 NEJM PMID 10639539) wykazało, że ramipril znacznie redukuje MACE u pacjentów wysokiego ryzyka CV niezależnie od obniżenia BP.',
    },
    mechanism: { hu: 'ACE-enzim szelektív gátlása → angiotenzin-II csökkenés → vazodilatáció + aldoszteron-szuppresszió + bradykinin-akkumuláció (köhögés-mechanizmus).', en: 'Selective ACE enzyme inhibition → angiotensin II reduction → vasodilation + aldosterone suppression + bradykinin accumulation (cough mechanism).', pl: 'Selektywne hamowanie ACE → redukcja angiotensyny II → rozszerzenie naczyń + supresja aldosteronu + akumulacja bradykininy (mechanizm kaszlu).' },
    legalStatus: { hu: 'EU/HU: vényköteles (Tritace, Amprilan, Piramil, generikus). USA: FDA Rx (Altace).', en: 'EU/HU: prescription only (Tritace, Amprilan, Piramil, generics). USA: FDA Rx (Altace).', pl: 'UE/PL: na receptę (Tritace, Amprilan, Piramil, generyki). USA: FDA Rx (Altace).' },
    onsetTime: '1-2 h (acute BP), 3-4 weeks (steady-state)',
    halfLife: '13-17 h (active ramiprilat, once-daily)',
    atcCode: 'C09AA05',
    prescriptionStatus: { hu: 'Vényköteles (Rx)', en: 'Prescription only (Rx)', pl: 'Na receptę (Rx)' },
    indications: [
      { hu: 'Hipertenzió, HFrEF', en: 'Hypertension, HFrEF', pl: 'Nadciśnienie, HFrEF' },
      { hu: 'Szekunder MI- és stroke-prevenció (HOPE-evidencia)', en: 'Secondary MI and stroke prevention (HOPE evidence)', pl: 'Wtórna prewencja MI i udaru (dowody HOPE)' },
      { hu: 'Diabéteszes nefropátia', en: 'Diabetic nephropathy', pl: 'Nefropatia cukrzycowa' },
    ],
    contraindications: [
      { hu: 'Terhesség (FDA D-X kategória, fetális vesekárosodás)', en: 'Pregnancy (FDA category D-X, fetal renal damage)', pl: 'Ciąża (kategoria D-X FDA, uszkodzenie nerek płodu)' },
      { hu: 'Bilaterális artéria renalis stenosis', en: 'Bilateral renal artery stenosis', pl: 'Obustronne zwężenie tętnicy nerkowej' },
      { hu: 'Angioedéma anamnézis (különösen örökletes)', en: 'Angioedema history (especially hereditary)', pl: 'Wywiad obrzęku naczynioruchowego (zwłaszcza dziedzicznego)' },
    ],
    commonSideEffects: [
      { hu: 'Száraz, irritáló köhögés (5-20%, bradykinin-mechanizmus — ARB-cserével mitigálható)', en: 'Dry, irritating cough (5-20%, bradykinin mechanism — switchable to ARB)', pl: 'Suchy, irytujący kaszel (5-20%, mechanizm bradykininowy — zmiana na ARB)' },
      { hu: 'Hyperkalémia (különösen vesefunkció-zavarnál vagy K-spóroló diuretikummal)', en: 'Hyperkalemia (especially in renal impairment or with K-sparing diuretics)', pl: 'Hiperkaliemia (zwłaszcza w niewydolności nerek lub z diuretykami K-szczędzącymi)' },
      { hu: 'Ortosztatikus hipotenzió (első dózis), szédülés', en: 'Orthostatic hypotension (first dose), dizziness', pl: 'Hipotensja ortostatyczna (pierwsza dawka), zawroty głowy' },
      { hu: 'Súlyos, ritka: angioedéma (~0,1-0,7%, sürgősségi), akut vesekárosodás bilaterális renalis-stenosisban', en: 'Severe, rare: angioedema (~0.1-0.7%, emergency), acute kidney injury in bilateral renal stenosis', pl: 'Ciężkie, rzadkie: obrzęk naczynioruchowy (~0,1-0,7%, nagłe), ostre uszkodzenie nerek przy obustronnym zwężeniu' },
    ],
    cyp450: ['Hydrolyzed by hepatic carboxylesterase (not CYP-dependent)', 'Active ramiprilat eliminated renally'],
    crossMolInteractions: [
      { hu: 'K-spóroló diuretikum (Spironolactone): hyperkalémia kockázat fokozása', en: 'K-sparing diuretic (spironolactone): increased hyperkalemia risk', pl: 'Diuretyk K-szczędzący (spironolakton): zwiększone ryzyko hiperkaliemii' },
      { hu: 'NSAID: vesefunkció-romlás, BP-csökkentő hatás csökkenése', en: 'NSAID: renal function decline, reduced BP-lowering effect', pl: 'NSAID: pogorszenie nerek, zmniejszony efekt BP' },
      { hu: 'ARB (Losartan), DRI (Aliskiren): dupla RAS-blokk — kerülendő', en: 'ARB (losartan), DRI (aliskiren): dual RAS blockade — avoid', pl: 'ARB (losartan), DRI (aliskiren): podwójna blokada RAS — unikać' },
      { hu: 'Lithium: lithium-szint emelkedhet, monitor', en: 'Lithium: lithium levels may rise, monitor', pl: 'Lit: poziom litu może wzrosnąć, monitor' },
    ],
    benefits: [
      { hu: 'MACE-redukció magas-rizikójú betegen (HOPE, 22%)', en: 'MACE reduction in high-CV-risk patients (HOPE, 22%)', pl: 'Redukcja MACE u wysokiego ryzyka CV (HOPE, 22%)' },
      { hu: 'HFrEF-mortalitás csökkentés', en: 'HFrEF mortality reduction', pl: 'Redukcja śmiertelności HFrEF' },
      { hu: 'Diabéteszes nefropátia-progresszió csökkentés', en: 'Diabetic nephropathy progression reduction', pl: 'Redukcja progresji nefropatii cukrzycowej' },
    ],
    studies: [
      { title: 'Effects of ramipril on cardiovascular and microvascular outcomes (HOPE)', authors: 'Yusuf S, Sleight P, Pogue J et al.', journal: 'N Engl J Med. 2000;342(3):145-53.', pmid: '10639539' },
      { title: 'Ramipril versus placebo in patients with left ventricular dysfunction post-MI (AIRE)', authors: 'AIRE Study Investigators.', journal: 'Lancet. 1993;342(8875):821-8.', pmid: '8104270' },
    ],
    related: ['bisoprolol', 'amlodipine'],
    doseCalc: {
      type: 'titration',
      titration: [
        { phase: { hu: 'Hét 1-2 (start)', en: 'Weeks 1-2 (start)', pl: 'Tygodnie 1-2 (start)' }, dose: '2.5' },
        { phase: { hu: 'Hét 3+ (cél)', en: 'Week 3+ (target)', pl: 'Tydzień 3+ (cel)' }, dose: '5' },
        { phase: { hu: 'Max-dózis', en: 'Max dose', pl: 'Maks. dawka' }, dose: '10' },
      ],
      unit: 'mg/nap',
      note: { hu: 'Reggel bevenni. Első dózisnál ortosztázis-figyelmeztetés. Kreatinin és K+ kontroll 2-4 hét után. Köhögés esetén ARB-csere (Losartan, Telmisartan).', en: 'Take in morning. First-dose orthostasis warning. Creatinine and K+ check at 2-4 weeks. On cough, switch to ARB (losartan, telmisartan).', pl: 'Przyjmuj rano. Ostrzeżenie o ortostazie przy pierwszej dawce. Kontrola kreatyniny i K+ po 2-4 tygodniach. Przy kaszlu zmiana na ARB.' },
    },
  },

  // ===== EXTRA. BISOPROLOL (Kardio, cardio-selective β1 blocker) =====
  {
    id: 'bisoprolol',
    name: 'Bisoprolol',
    image: null,
    ...
    description: {
      hu: 'A Bisoprolol egy magas-szelektivitású β1-adrenerg receptor antagonista (Merck Concor, FDA 1992). A β1/β2 szelektivitás ~75:1, ami a légúti és perifériás β2-mediált mellékhatásokat (bronchospasmus, vazokonstrikció) jelentősen csökkenti vs nem-szelektív β-blokkolók (Propranolol). A CIBIS-II trial (CIBIS-II 1999 Lancet PMID 9988345) szerint HFrEF-betegen 34%-os relatív mortalitás-csökkenést okoz. Standard a hipertenzió-, HFrEF- és post-MI-portfolió.',
      en: 'Bisoprolol is a highly selective β1-adrenergic receptor antagonist (Merck Concor, FDA 1992). β1/β2 selectivity ~75:1 significantly reduces airway and peripheral β2-mediated side effects (bronchospasm, vasoconstriction) vs non-selective β-blockers (propranolol). CIBIS-II trial (CIBIS-II 1999 Lancet PMID 9988345) showed 34% relative mortality reduction in HFrEF. Standard in hypertension, HFrEF, and post-MI portfolio.',
      pl: 'Bisoprolol to wysoce selektywny antagonista β1-adrenergiczny (Merck Concor, FDA 1992). Selektywność β1/β2 ~75:1 znacznie zmniejsza działania pośredniczone przez β2 (skurcz oskrzeli, skurcz obwodowy) vs nieselektywne β-blokery (propranolol). Badanie CIBIS-II (CIBIS-II 1999 Lancet PMID 9988345) wykazało 34% redukcję względnej śmiertelności w HFrEF.',
    },
    mechanism: { hu: 'β1-szelektív kompetitív antagonista. Negatív chronotrop (HR-csökkenés), negatív inotrop, negatív dromotop (AV-konduktancia-lassítás). Renin-csökkentés (juxtaglomeruláris β1-blokk).', en: 'β1-selective competitive antagonist. Negative chronotropic (HR drop), negative inotropic, negative dromotropic (AV conduction slowing). Renin reduction (juxtaglomerular β1 block).', pl: 'Selektywny konkurencyjny antagonista β1. Ujemnie chronotropowy (spadek HR), inotropowy, dromotropowy. Redukcja reniny.' },
    legalStatus: { hu: 'EU/HU: vényköteles (Concor, Bisocard, generikus). USA: FDA Rx (Zebeta).', en: 'EU/HU: prescription only (Concor, Bisocard, generics). USA: FDA Rx (Zebeta).', pl: 'UE/PL: na receptę (Concor, Bisocard, generyki). USA: FDA Rx (Zebeta).' },
    onsetTime: '1-2 h (acute HR), 1-2 weeks (steady BP)',
    halfLife: '10-12 h (once-daily)',
    atcCode: 'C07AB07',
    prescriptionStatus: { hu: 'Vényköteles (Rx)', en: 'Prescription only (Rx)', pl: 'Na receptę (Rx)' },
    indications: [
      { hu: 'Hipertenzió, stabil angina', en: 'Hypertension, stable angina', pl: 'Nadciśnienie, stabilna dławica' },
      { hu: 'HFrEF (CIBIS-II evidencia)', en: 'HFrEF (CIBIS-II evidence)', pl: 'HFrEF (dowody CIBIS-II)' },
      { hu: 'Post-MI szekunder prevenció', en: 'Post-MI secondary prevention', pl: 'Wtórna prewencja po MI' },
    ],
    contraindications: [
      { hu: 'Súlyos bradycardia (HR < 50), II-III fokú AV-blokk, sinusbradycardia', en: 'Severe bradycardia (HR < 50), 2nd-3rd degree AV block, sinus bradycardia', pl: 'Ciężka bradykardia (HR < 50), blok AV 2-3 st., bradykardia zatokowa' },
      { hu: 'Súlyos hipotenzió, kardiogén sokk', en: 'Severe hypotension, cardiogenic shock', pl: 'Ciężka hipotensja, wstrząs kardiogenny' },
      { hu: 'Súlyos asztma, COPD (β2-bronchospasmus relatív kockázat)', en: 'Severe asthma, COPD (β2-bronchospasm relative risk)', pl: 'Ciężka astma, POChP (względne ryzyko skurczu β2)' },
      { hu: 'Akut dekompenzált HFrEF (csak stabil állapotban indítható)', en: 'Acute decompensated HFrEF (only initiate when stable)', pl: 'Ostra zdekompensowana HFrEF (rozpoczynać tylko w stabilnym stanie)' },
    ],
    commonSideEffects: [
      { hu: 'Bradycardia, ortosztatikus hipotenzió, fáradtság', en: 'Bradycardia, orthostatic hypotension, fatigue', pl: 'Bradykardia, hipotensja ortostatyczna, zmęczenie' },
      { hu: 'Hideg végtagok, Raynaud-szerű tünet', en: 'Cold extremities, Raynaud-like symptoms', pl: 'Zimne kończyny, objawy Raynauda' },
      { hu: 'Élénk álmok, depresszió-rizikó (mérsékelt)', en: 'Vivid dreams, depression risk (moderate)', pl: 'Żywe sny, ryzyko depresji (umiarkowane)' },
      { hu: 'Súlyos, ritka: bronchospasmus szelektivitás-elvesztésnél magas dózison, hipoglikémia-tünet-maszkolás diabétesz mellett', en: 'Severe, rare: bronchospasm at higher dose with selectivity loss, hypoglycemia symptom masking in diabetics', pl: 'Ciężkie, rzadkie: skurcz oskrzeli przy utracie selektywności, maskowanie hipoglikemii u cukrzyków' },
    ],
    cyp450: ['CYP3A4, CYP2D6 substrate (mixed)', 'No significant CYP inhibition'],
    crossMolInteractions: [
      { hu: 'CCB non-DHP (Verapamil, Diltiazem): bradycardia + AV-blokk additivitás', en: 'Non-DHP CCB (verapamil, diltiazem): bradycardia + AV block additivity', pl: 'CCB non-DHP (werapamil, diltiazem): addytywność bradykardii + blok AV' },
      { hu: 'Klasszikus β-blokkoló-tüneti gyógyszerek (Digoxin, Amiodarone): additív hatás', en: 'Classic β-blocker-symptomatic drugs (digoxin, amiodarone): additive effect', pl: 'Klasyczne (digoksyna, amiodaron): addytywny efekt' },
      { hu: 'Inzulin/orális antidiabetikum: hipoglikémia-tünet-maszkolás', en: 'Insulin/oral antidiabetic: hypoglycemia symptom masking', pl: 'Insulina/doustny przeciwcukrzycowy: maskowanie objawów hipoglikemii' },
    ],
    benefits: [
      { hu: 'HFrEF-mortalitás 34% relatív csökkenés (CIBIS-II)', en: 'HFrEF mortality 34% relative reduction (CIBIS-II)', pl: 'Śmiertelność HFrEF 34% redukcja względna (CIBIS-II)' },
      { hu: 'Magas β1-szelektivitás → kevés tüdő/perifériás mellékhatás', en: 'High β1 selectivity → few lung/peripheral side effects', pl: 'Wysoka selektywność β1 → mało działań płucnych/obwodowych' },
      { hu: 'Napi egyszer (jó compliance)', en: 'Once-daily (good compliance)', pl: 'Raz dziennie (dobry compliance)' },
    ],
    studies: [
      { title: 'The Cardiac Insufficiency Bisoprolol Study II (CIBIS-II)', authors: 'CIBIS-II Investigators.', journal: 'Lancet. 1999;353(9146):9-13.', pmid: '9988345' },
      { title: 'Effect of carvedilol versus bisoprolol on heart failure outcomes', authors: 'Frommeyer G, Eckardt L.', journal: 'Eur Heart J. 2017;38(33):2624-2627.', pmid: '28645164' },
    ],
    related: ['ramipril', 'amlodipine'],
    doseCalc: {
      type: 'titration',
      titration: [
        { phase: { hu: 'Hét 1-2 (HFrEF start)', en: 'Weeks 1-2 (HFrEF start)', pl: 'Tygodnie 1-2 (start HFrEF)' }, dose: '1.25' },
        { phase: { hu: 'Hipertenzió standard', en: 'Hypertension standard', pl: 'Standard nadciśnienia' }, dose: '5' },
        { phase: { hu: 'Max-dózis', en: 'Max dose', pl: 'Maks. dawka' }, dose: '10' },
      ],
      unit: 'mg/nap',
      note: { hu: 'Reggel. HFrEF-titrációban 2 hét/dózisszint a hemodinamikai-tolerancia érdekében. HR + BP otthoni monitor. NE hagyja abba hirtelen (rebound tachycardia, ischémia).', en: 'Morning. HFrEF titrate 2 wks per dose for hemodynamic tolerance. Home HR + BP monitor. DO NOT stop abruptly (rebound tachycardia, ischemia).', pl: 'Rano. W HFrEF titracja 2 tyg./poziom dawki. Domowy monitor HR + BP. NIE przerywaj nagle (tachykardia z odbicia, niedokrwienie).' },
    },
  },

  // ===== EXTRA. AMLODIPINE (Kardio, dihydropyridine CCB) =====
  {
    id: 'amlodipine',
    name: 'Amlodipine',
    image: null,
    ...
    description: {
      ...
      pl: 'Amlodypina to długodziałający CCB dihydropirydyny (Pfizer Norvasc, FDA 1987). Selektywnie hamuje kanały Ca typu L w mięśniach gładkich naczyń, powodując rozszerzenie tętnic. Badanie ASCOT-BPLA (Dahlöf 2005 Lancet PMID 16154016) wykazało wyższość kombinacji amlodypina + peryndopryl nad atenolol + bendroflumetiazyd dla redukcji MACE.',
    },
    mechanism: { hu: 'L-típusú Ca-csatorna szelektív gátlása érfali simaizomban → értágulat. Minimális szívizom-érintettség.', en: 'Selective L-type Ca channel inhibition in vascular smooth muscle → vasodilation. Minimal myocardial effect.', pl: 'Selektywne hamowanie kanałów Ca typu L w mięśniach gładkich naczyń → rozszerzenie. Minimalny efekt mięśnia sercowego.' },
    legalStatus: { hu: 'EU/HU: vényköteles (Norvasc, Amlodipin, generikus). USA: FDA Rx.', en: 'EU/HU: prescription only (Norvasc, Amlodipine, generics). USA: FDA Rx.', pl: 'UE/PL: na receptę (Norvasc, Amlodypina, generyki). USA: FDA Rx.' },
    ...
    indications: [
      { hu: 'Hipertenzió, stabil angina', en: 'Hypertension, stable angina', pl: 'Nadciśnienie, stabilna dławica' },
      { hu: 'Vasospastikus angina (Prinzmetal)', en: 'Vasospastic angina (Prinzmetal)', pl: 'Dławica naczynioskurczowa (Prinzmetala)' },
    ],
    contraindications: [
      { hu: 'Súlyos hipotenzió, kardiogén sokk, aortastenosis (relatív)', en: 'Severe hypotension, cardiogenic shock, aortic stenosis (relative)', pl: 'Ciężka hipotensja, wstrząs kardiogenny, stenoza aortalna (względne)' },
    ],
    commonSideEffects: [
      { hu: 'Periférialás edéma (boka, gyakori, dóziseffekt — 10-30%)', en: 'Peripheral edema (ankle, common, dose-dependent — 10-30%)', pl: 'Obrzęk obwodowy (kostki, częsty, zależny od dawki — 10-30%)' },
      { hu: 'Fejfájás, kipirult arc, palpitációk', en: 'Headache, facial flushing, palpitations', pl: 'Ból głowy, zaczerwienienie twarzy, kołatania' },
      { hu: 'Gingiva-hiperplázia (krónikus, ritka)', en: 'Gingival hyperplasia (chronic, rare)', pl: 'Przerost dziąseł (przewlekły, rzadki)' },
    ],
    cyp450: ['CYP3A4 substrate (extensive)', 'Long half-life buffers minor interactions'],
    crossMolInteractions: [
      { hu: 'Simvastatin: 20 mg/nap-os Simvastatin-limit kombináció esetén', en: 'Simvastatin: 20 mg/day simvastatin limit when combined', pl: 'Simwastatyna: limit 20 mg/dzień przy kombinacji' },
      { hu: 'Erős CYP3A4 inhibitor (Clarithromycin, Itraconazole): plazma-Amlodipine emelkedhet', en: 'Strong CYP3A4 inhibitor (clarithromycin, itraconazole): plasma amlodipine may rise', pl: 'Silne inhibitory CYP3A4 (klarytromycyna, itrakonazol): poziom amlodypiny może wzrosnąć' },
      { hu: 'Grapefruit-lé: enyhe AUC-emelkedés', en: 'Grapefruit juice: mild AUC rise', pl: 'Sok grejpfrutowy: łagodny wzrost AUC' },
    ],
    benefits: [
      { hu: 'Hosszú felezési idő → forgiving missed dose', en: 'Long half-life → forgiving missed dose', pl: 'Długi okres półtrwania → wybacza pominiętą dawkę' },
      { hu: 'ASCOT-BPLA: szuperior MACE-redukció ACE-i kombinációval', en: 'ASCOT-BPLA: superior MACE reduction with ACEi combination', pl: 'ASCOT-BPLA: lepsza redukcja MACE z kombinacją ACEi' },
      { hu: 'Kombinálható ACE-i, ARB, statin-tal (Caduet = Amlodipine + Atorvastatin)', en: 'Combinable with ACEi, ARB, statin (Caduet = amlodipine + atorvastatin)', pl: 'Można łączyć z ACEi, ARB, statyną (Caduet = amlodypina + atorwastatyna)' },
    ],
    studies: [
      { title: 'Prevention of cardiovascular events with amlodipine + perindopril vs atenolol + bendroflumethiazide (ASCOT-BPLA)', authors: 'Dahlöf B, Sever PS, Poulter NR et al.', journal: 'Lancet. 2005;366(9489):895-906.', pmid: '16154016' },
      { title: 'Amlodipine in coronary artery disease (CAMELOT)', authors: 'Nissen SE, Tuzcu EM, Libby P et al.', journal: 'JAMA. 2004;292(18):2217-25.', pmid: '15536108' },
    ],
    related: ['ramipril', 'bisoprolol'],
    doseCalc: {
      type: 'fixedDose',
      fixedDose: { low: 2.5, medium: 5, high: 10 },
      unit: 'mg/nap',
      note: { hu: 'Alacsony (2,5 mg): idős vagy alacsony testtömeg. Mérsékelt (5 mg): standard. Magas (10 mg): rezisztens hipertenzió. Reggel, étkezéstől függetlenül. Periférialás edéma esetén dóziscsökkentés vagy ACE-i hozzáadás (mitigálja).', en: 'Low (2.5 mg): elderly or low body weight. Moderate (5 mg): standard. High (10 mg): resistant hypertension. Morning, food-independent. On peripheral edema reduce dose or add ACEi (mitigates).', pl: 'Niska (2,5 mg): starsi lub niska masa ciała. Średnia (5 mg): standard. Wysoka (10 mg): oporne nadciśnienie. Rano, niezależnie od jedzenia. Przy obrzęku redukcja dawki lub dodanie ACEi.' },
    },
  },

  // ===== EXTRA. APIXABAN (Kardio, factor Xa inhibitor DOAC) =====
  {
    id: 'apixaban',
    name: 'Apixaban',
    image: null,
    ...
    description: {
      hu: 'Az Apixaban egy szelektív, reverzibilis Faktor Xa-inhibitor (BMS/Pfizer Eliquis, FDA 2012). A koagulációs kaszkád protrombin-aktiválás-szintjén beavatkozik, ami trombin-képződést csökkenti. Az ARISTOTLE-trial (Granger 2011 NEJM PMID 21870978) szerint pitvarfibrillációban Apixaban szuperior a Warfarinhoz: 21% stroke + szisztémás embólia, 31% major vérzés, és 11% all-cause mortality csökkenés. Más DOAC-kal (Rivaroxaban, Dabigatran, Edoxaban) szemben az Apixabannak van a legalacsonyabb GI-vérzés-kockázata.',
      en: 'Apixaban is a selective, reversible Factor Xa inhibitor (BMS/Pfizer Eliquis, FDA 2012). Intervenes at coagulation cascade prothrombin activation level, reducing thrombin generation. ARISTOTLE trial (Granger 2011 NEJM PMID 21870978) showed apixaban superior to warfarin in AF: 21% stroke + systemic embolism, 31% major bleeding, and 11% all-cause mortality reduction. Among DOACs (rivaroxaban, dabigatran, edoxaban), apixaban has lowest GI bleeding risk.',
      pl: 'Apiksaban to selektywny, odwracalny inhibitor czynnika Xa (BMS/Pfizer Eliquis, FDA 2012). Interweniuje na poziomie aktywacji protrombiny w kaskadzie krzepnięcia, redukując generację trombiny. Badanie ARISTOTLE (Granger 2011 NEJM PMID 21870978) wykazało wyższość apiksabanu nad warfaryną w AF: 21% redukcja udaru + embolii, 31% poważnych krwawień, 11% śmiertelności ogólnej. Wśród DOAC apiksaban ma najniższe ryzyko krwawienia GI.',
    },
    mechanism: { hu: 'Reverzibilis Faktor Xa kompetitív inhibitor. Nem igényel antitrombin-III-at kofaktorként (vs LMWH).', en: 'Reversible competitive Factor Xa inhibitor. Does not require antithrombin III as cofactor (vs LMWH).', pl: 'Odwracalny konkurencyjny inhibitor czynnika Xa. Nie wymaga antytrombiny III jako kofaktora (vs LMWH).' },
    legalStatus: { hu: 'EU/HU: vényköteles (Eliquis). USA: FDA Rx.', en: 'EU/HU: prescription only (Eliquis). USA: FDA Rx.', pl: 'UE/PL: na receptę (Eliquis). USA: FDA Rx.' },
    onsetTime: '3-4 h (peak), 2-4 days (steady-state)',
    halfLife: '~12 h (twice-daily dosing)',
    atcCode: 'B01AF02',
    prescriptionStatus: { hu: 'Vényköteles (Rx)', en: 'Prescription only (Rx)', pl: 'Na receptę (Rx)' },
    indications: [
      { hu: 'Pitvarfibrilláció (AF) stroke + szisztémás embólia prevenció', en: 'Atrial fibrillation (AF) stroke + systemic embolism prevention', pl: 'Migotanie przedsionków (AF) prewencja udaru + embolii' },
      { hu: 'Mélyvénás trombózis (DVT) + pulmonalis embólia (PE) kezelés + prevenció', en: 'Deep vein thrombosis (DVT) + pulmonary embolism (PE) treatment + prevention', pl: 'Zakrzepica żył głębokich (DVT) + zatorowość płucna (PE) leczenie + prewencja' },
      { hu: 'Csípő/térd protézis-műtét utáni VTE-prevenció', en: 'Hip/knee replacement post-op VTE prevention', pl: 'Prewencja VTE po wymianie biodra/kolana' },
    ],
    contraindications: [
      { hu: 'Aktív klinikailag jelentős vérzés', en: 'Active clinically significant bleeding', pl: 'Aktywne klinicznie istotne krwawienie' },
      { hu: 'Mechanikus szívbillentyű (csak warfarin engedélyezett)', en: 'Mechanical heart valve (only warfarin approved)', pl: 'Mechaniczna zastawka serca (tylko warfaryna)' },
      { hu: 'Súlyos máj-betegség (Child-Pugh C)', en: 'Severe liver disease (Child-Pugh C)', pl: 'Ciężka choroba wątroby (Child-Pugh C)' },
    ],
    commonSideEffects: [
      { hu: 'Vérzés (legjelentősebb mellékhatás, 2-4%/év major)', en: 'Bleeding (most significant side effect, 2-4%/yr major)', pl: 'Krwawienie (najważniejsze działanie, 2-4%/rok poważne)' },
      { hu: 'Hányinger, fejfájás', en: 'Nausea, headache', pl: 'Nudności, ból głowy' },
      { hu: 'Súlyos, ritka: intracerebrális vérzés (sürgősségi, Andexanet alfa reverzál)', en: 'Severe, rare: intracerebral hemorrhage (emergency, andexanet alfa reversal)', pl: 'Ciężkie, rzadkie: krwawienie wewnątrzczaszkowe (nagłe, andeksanet alfa odwraca)' },
    ],
    cyp450: ['CYP3A4 substrate', 'P-gp substrate'],
    crossMolInteractions: [
      { hu: 'Erős kettős CYP3A4 + P-gp inhibitor (Ketoconazole, Ritonavir): dóziscsökkentés vagy kerülendő', en: 'Strong dual CYP3A4 + P-gp inhibitor (ketoconazole, ritonavir): dose reduction or avoid', pl: 'Silne podwójne inhibitory CYP3A4 + P-gp (ketokonazol, rytonawir): redukcja lub unikać' },
      { hu: 'Erős CYP3A4-induktor (Rifampicin, Phenytoin): hatás csökken, kerülendő', en: 'Strong CYP3A4 inducer (rifampin, phenytoin): efficacy drops, avoid', pl: 'Silne induktory CYP3A4 (ryfampicyna, fenytoina): efekt spada, unikać' },
      { hu: 'NSAID, aszpirin, antitrombotikum: additív vérzés-kockázat', en: 'NSAID, aspirin, antithrombotic: additive bleeding risk', pl: 'NSAID, aspiryna, antytrombotyczne: addytywne ryzyko krwawienia' },
    ],
    benefits: [
      { hu: 'Warfarin-szuperior AF-ben (ARISTOTLE)', en: 'Warfarin-superior in AF (ARISTOTLE)', pl: 'Lepsza niż warfaryna w AF (ARISTOTLE)' },
      { hu: 'Alacsonyabb GI-vérzés mint más DOAC-okon', en: 'Lower GI bleeding than other DOACs', pl: 'Niższe krwawienie GI niż inne DOAC' },
      { hu: 'NEM igényel INR-monitorozást', en: 'No INR monitoring needed', pl: 'Brak monitorowania INR' },
      { hu: 'Andexanet alfa reverzál szer vérzéskor', en: 'Andexanet alfa reversal agent available for bleeding', pl: 'Andeksanet alfa jako odwracający dostępny przy krwawieniu' },
    ],
    studies: [
      { title: 'Apixaban versus warfarin in patients with atrial fibrillation (ARISTOTLE)', authors: 'Granger CB, Alexander JH, McMurray JJ et al.', journal: 'N Engl J Med. 2011;365(11):981-92.', pmid: '21870978' },
      { title: 'Apixaban for treatment of acute venous thromboembolism (AMPLIFY)', authors: 'Agnelli G, Buller HR, Cohen A et al.', journal: 'N Engl J Med. 2013;369(9):799-808.', pmid: '23808982' },
    ],
    related: ['ramipril', 'bisoprolol'],
    doseCalc: {
      type: 'fixedDose',
      fixedDose: { low: 2.5, medium: 5, high: 10 },
      unit: 'mg 2x/nap',
      note: { hu: 'AF standard: 5 mg 2x/nap. Dóziscsökkentés 2,5 mg 2x/nap, ha 2/3 kritérium: életkor ≥ 80, testtömeg ≤ 60 kg, kreatinin ≥ 1,5 mg/dl. DVT/PE akut: 10 mg 2x/nap 7 napig, majd 5 mg 2x/nap. Étkezéstől függetlenül. NEM helyettesíthető más DOAC-kal egy az egyben.', en: 'AF standard: 5 mg BID. Reduce to 2.5 mg BID if 2 of 3: age ≥ 80, weight ≤ 60 kg, creatinine ≥ 1.5 mg/dl. Acute DVT/PE: 10 mg BID for 7 days, then 5 mg BID. Food-independent. NOT one-to-one substitutable with other DOACs.', pl: 'Standard AF: 5 mg 2x/dzień. Redukcja do 2,5 mg 2x/dzień przy 2 z 3: wiek ≥ 80, masa ≤ 60 kg, kreatynina ≥ 1,5 mg/dl. Ostre DVT/PE: 10 mg 2x/dzień przez 7 dni, potem 5 mg 2x/dzień. Niezależnie od jedzenia. NIE substytuowalny 1:1 z innymi DOAC.' },
    },
  },

  // ===== EXTRA. METHIMAZOLE (Endokrin, antithyroid) =====
  {
    id: 'methimazole',
    name: 'Methimazole',
    image: null,
    ...
    prescriptionStatus: { hu: 'Vényköteles (Rx)', en: 'Prescription only (Rx)', pl: 'Na receptę (Rx)' },
    indications: [
      { hu: 'Graves-betegség (autoimmun hipertireózis) első-vonal', en: 'Graves disease (autoimmune hyperthyroidism) first-line', pl: 'Choroba Gravesa (autoimmunologiczna nadczynność) pierwsza linia' },
      { hu: 'Toxikus multinoduláris struma, toxikus adenoma', en: 'Toxic multinodular goiter, toxic adenoma', pl: 'Toksyczne wole wieloguzkowe, gruczolak toksyczny' },
      { hu: 'Tireoid-műtét vagy radioiod-terápia előkészítése (eutireoiddá tétel)', en: 'Pre-thyroidectomy or pre-radioiodine preparation (rendering euthyroid)', pl: 'Przygotowanie do tyreoidektomii lub jodu radioaktywnego (eutyreoza)' },
    ],
    contraindications: [
      { hu: 'Korábbi súlyos hematológiai vagy hepatikus mellékhatás', en: 'Prior severe hematologic or hepatic adverse event', pl: 'Wywiad ciężkiego działania hematologicznego lub wątrobowego' },
      { hu: 'Terhesség első trimeszter (PTU preferált, Methimazole-aplázia-kockázat)', en: 'First trimester pregnancy (PTU preferred, methimazole aplasia risk)', pl: 'Pierwszy trymestr ciąży (preferowany PTU, ryzyko aplazji)' },
    ],
    commonSideEffects: [
      { hu: 'Bőrkiütés (3-5%, dóziseffekt)', en: 'Skin rash (3-5%, dose-dependent)', pl: 'Wysypka skórna (3-5%, zależna od dawki)' },
      { hu: 'GI: hányinger, hányás, ízzavar', en: 'GI: nausea, vomiting, taste alteration', pl: 'GI: nudności, wymioty, zaburzenia smaku' },
      { hu: 'Súlyos, ritka: agranulocitózis (0,2-0,5%, láz/torokgyulladás esetén AZONNAL CBC), hepatotoxicitás (ritkább mint PTU-nál), vasculitis (ANCA-pozitív)', en: 'Severe, rare: agranulocytosis (0.2-0.5%, on fever/sore throat IMMEDIATE CBC), hepatotoxicity (rarer than PTU), vasculitis (ANCA+)', pl: 'Ciężkie, rzadkie: agranulocytoza (0,2-0,5%, przy gorączce/bólu gardła NATYCHMIAST CBC), hepatotoksyczność (rzadsza niż PTU), zapalenie naczyń (ANCA+)' },
    ],
    cyp450: ['Hepatic metabolism (multiple pathways)', 'CYP-dependence minor'],
    crossMolInteractions: [
      { hu: 'Warfarin: hatás csökkenése (a hipertireózis okozta felgyorsult metabolizmus eltűnik)', en: 'Warfarin: effect reduction (loss of hyperthyroid-driven accelerated metabolism)', pl: 'Warfaryna: redukcja efektu (utrata przyspieszonego metabolizmu z nadczynności)' },
      { hu: 'Béta-blokkoló (Propranolol, Bisoprolol): hipertireózis-tüneti kontroll a Methimazole-hatás kifejlődéséig', en: 'Beta-blocker (propranolol, bisoprolol): symptomatic control of hyperthyroidism until methimazole takes effect', pl: 'Beta-bloker (propranolol, bisoprolol): kontrola objawowa nadczynności do efektu metimazolu' },
    ],
    benefits: [
      { hu: 'Graves-betegségben 50%-os remisszió 18-24 hónap után', en: '~50% remission in Graves after 18-24 months', pl: '~50% remisja w chorobie Gravesa po 18-24 miesiącach' },
      { hu: 'PTU-hoz képest hepatotoxicitás kisebb', en: 'Lower hepatotoxicity than PTU', pl: 'Niższa hepatotoksyczność niż PTU' },
      { hu: 'Napi egyszeri vagy kétszeri adagolás', en: 'Once or twice daily dosing', pl: 'Dawkowanie raz lub dwa razy dziennie' },
    ],
    studies: [
      { title: 'Hyperthyroidism: a review (Cooper 2005)', authors: 'Cooper DS.', journal: 'N Engl J Med. 2005;352(9):905-17.', pmid: '15745981' },
      { title: 'Methimazole vs propylthiouracil pregnancy outcomes', authors: 'Andersen SL, Olsen J, Wu CS et al.', journal: 'J Clin Endocrinol Metab. 2013;98(11):4373-81.', pmid: '24151287' },
    ],
    related: ['levothyroxin', 'liothyronine'],
    doseCalc: {
      type: 'titration',
      titration: [
        { phase: { hu: 'Enyhe hipertireózis (start)', en: 'Mild hyperthyroidism (start)', pl: 'Łagodna nadczynność (start)' }, dose: '5' },
        { phase: { hu: 'Mérsékelt eset', en: 'Moderate case', pl: 'Średni przypadek' }, dose: '15' },
        { phase: { hu: 'Súlyos eset (max)', en: 'Severe case (max)', pl: 'Ciężki przypadek (maks.)' }, dose: '30' },
      ],
      unit: 'mg/nap',
      note: { hu: 'Indító dózis 10-30 mg/nap súlyosság szerint, 1-2x/nap. 4-6 hét után TSH + free T4 kontroll, ezután fenntartó dózis 5-10 mg/nap. Láz vagy torokgyulladás esetén AZONNAL CBC + abbahagyás (agranulocitózis).', en: 'Start 10-30 mg/day by severity, 1-2x/day. After 4-6 weeks check TSH + free T4, then maintenance 5-10 mg/day. On fever or sore throat IMMEDIATE CBC + stop (agranulocytosis).', pl: 'Start 10-30 mg/dzień wg ciężkości, 1-2x/dzień. Po 4-6 tygodniach kontrola TSH + wolnego T4, potem podtrzymanie 5-10 mg/dzień. Przy gorączce/bólu gardła NATYCHMIAST CBC + odstawienie (agranulocytoza).' },
    },
  },

  // ===== EXTRA. HYDROCORTISONE (Endokrin, glükokortikoid, Addison-pótlás) =====
  {
    id: 'hydrocortisone',
    name: 'Hydrocortisone',
    image: null,
    ...
    description: {
      hu: 'A Hydrocortisone az endogén kortizol szintetikus változata, amelyet a Pfizer (Cortef, FDA 1955) fejlesztett ki. Az Addison-betegségben és szekunder mellékvese-elégtelenségben élethosszig tartó hormon-pótlás. A fiziológiás cirkadián minta (reggeli csúcs, este alacsony) lehetőleg utánzása (split-dosing 10 mg reggel + 5 mg délután). STRESSZ-DÓZIS: betegség, műtét, fizikai trauma esetén 2-3x emelni KÖTELEZŐ, mert Addison-betegen az endogén kortizol-fokozás-képesség hiányzik (acut adrenalis krízis halálos lehet). Az ATA 2016 (Bornstein 2016 JCEM PMID 26760044) guideline ad standardizált stressz-dózis ajánlásokat.',
      en: 'Hydrocortisone is the synthetic equivalent of endogenous cortisol, developed by Pfizer (Cortef, FDA 1955). In Addison disease and secondary adrenal insufficiency it is lifelong hormone replacement. Mimic physiological circadian pattern (morning peak, evening low) via split-dosing (10 mg morning + 5 mg afternoon). STRESS DOSE: illness, surgery, physical trauma require 2-3x increase MANDATORY because Addison patients lack endogenous cortisol surge (acute adrenal crisis can be fatal). ATA 2016 (Bornstein 2016 JCEM PMID 26760044) guideline gives standardized stress-dose recommendations.',
      pl: 'Hydrokortyzon to syntetyczny odpowiednik endogennego kortyzolu, opracowany przez Pfizer (Cortef, FDA 1955). W chorobie Addisona i wtórnej niewydolności nadnerczy stosowany dożywotnio. Naśladuje fizjologiczny rytm dobowy (poranny szczyt, wieczorny niski) przez split-dosing (10 mg rano + 5 mg po południu). DAWKA STRESOWA: choroba, operacja, uraz wymagają wzrostu 2-3x OBOWIĄZKOWO, ponieważ pacjenci Addisona nie mają endogennego wzrostu kortyzolu (ostry kryzys nadnerczowy może być śmiertelny). Wytyczne ATA 2016 (Bornstein 2016 JCEM PMID 26760044) dają standardyzowane zalecenia.',
    },
    mechanism: { hu: 'Glükokortikoid receptor (GR) agonista. Anti-gyulladás, immunmoduláció, glükoneogenezis-stimuláció, fehérje-katabolizmus, ozmotikus-egyensúly fenntartása (mineralokortikoid is enyhe).', en: 'Glucocorticoid receptor (GR) agonist. Anti-inflammation, immunomodulation, gluconeogenesis stimulation, protein catabolism, osmotic balance (mild mineralocorticoid too).', pl: 'Agonista receptora glukokortykoidowego (GR). Przeciwzapalny, immunomodulujący, stymulujący glukoneogenezę, katabolizm białek, równowaga osmotyczna.' },
    legalStatus: { hu: 'EU/HU: vényköteles (Hydrocortison, Cortef, Plenadren — modified-release brand). USA: FDA Rx.', en: 'EU/HU: prescription only (hydrocortisone, Cortef, Plenadren — modified-release brand). USA: FDA Rx.', pl: 'UE/PL: na receptę (hydrokortyzon, Cortef, Plenadren — marka modified-release). USA: FDA Rx.' },
    onsetTime: '30-60 min (oral), seconds-minutes (IV in adrenal crisis)',
    halfLife: '~1.5 h (plasma), biological 8-12 h',
    atcCode: 'H02AB09',
    prescriptionStatus: { hu: 'Vényköteles (Rx), endokrinológus által felügyelt', en: 'Prescription only (Rx), endocrinologist-supervised', pl: 'Na receptę (Rx), nadzorowane przez endokrynologa' },
    indications: [
      { hu: 'Primer mellékvese-elégtelenség (Addison-betegség, élethosszig)', en: 'Primary adrenal insufficiency (Addison disease, lifelong)', pl: 'Pierwotna niewydolność nadnerczy (choroba Addisona, dożywotnia)' },
      { hu: 'Szekunder mellékvese-elégtelenség (hipofízis-elégtelenség)', en: 'Secondary adrenal insufficiency (pituitary failure)', pl: 'Wtórna niewydolność nadnerczy (niewydolność przysadki)' },
      { hu: 'Veleszületett mellékvese-hiperplázia (CAH)', en: 'Congenital adrenal hyperplasia (CAH)', pl: 'Wrodzona przerost nadnerczy (CAH)' },
      { hu: 'Akut mellékvese-krízis (sürgősségi, IV)', en: 'Acute adrenal crisis (emergency, IV)', pl: 'Ostry kryzys nadnerczowy (nagły, IV)' },
    ],
    contraindications: [
      { hu: 'Aktív szisztémás gomba-infekció (relatív)', en: 'Active systemic fungal infection (relative)', pl: 'Aktywna układowa infekcja grzybicza (względne)' },
      { hu: 'Hypersenzitivitás', en: 'Hypersensitivity', pl: 'Nadwrażliwość' },
    ],
    commonSideEffects: [
      { hu: 'Krónikus szupra-fiziológiás dózison: Cushing-tünetek (centrális obesitás, hipertenzió, hyperglikémia, osteoporosis, izomatrófia)', en: 'On chronic supra-physiological doses: Cushing features (central obesity, hypertension, hyperglycemia, osteoporosis, muscle atrophy)', pl: 'Przy przewlekłej dawce suprafizjologicznej: cechy Cushinga (otyłość centralna, nadciśnienie, hiperglikemia, osteoporoza, atrofia mięśni)' },
      { hu: 'Fertőzés-susceptibilitás növekedése (immun-suppresszió)', en: 'Increased infection susceptibility (immune suppression)', pl: 'Zwiększona podatność na infekcje (supresja immunologiczna)' },
      { hu: 'Pszichiátriai: szorongás, álmatlanság, mánia magas dózison', en: 'Psychiatric: anxiety, insomnia, mania at high dose', pl: 'Psychiatryczne: niepokój, bezsenność, mania przy wysokiej dawce' },
    ],
    cyp450: ['CYP3A4 substrate', 'Sensitive to CYP3A4 inducers/inhibitors'],
    crossMolInteractions: [
      { hu: 'CYP3A4 induktor (Phenytoin, Rifampicin, Carbamazepine): dóziseszkaláció szükséges', en: 'CYP3A4 inducer (phenytoin, rifampin, carbamazepine): dose escalation needed', pl: 'Induktor CYP3A4 (fenytoina, ryfampicyna, karbamazepina): potrzeba eskalacji' },
      { hu: 'Erős CYP3A4-inhibitor: dóziscsökkentés', en: 'Strong CYP3A4 inhibitor: dose reduction', pl: 'Silny inhibitor CYP3A4: redukcja dawki' },
      { hu: 'Inzulin/orális antidiabetikum: hyperglikémia-fokozás, monitor', en: 'Insulin/oral antidiabetic: hyperglycemia enhancement, monitor', pl: 'Insulina/doustny przeciwcukrzycowy: nasilenie hiperglikemii, monitor' },
    ],
    benefits: [
      { hu: 'Élethosszig tartó hormon-pótlás Addison-betegen — életet ment', en: 'Lifelong hormone replacement in Addison — saves life', pl: 'Dożywotnie uzupełnienie hormonalne w Addisonie — ratuje życie' },
      { hu: 'Modified-release brand (Plenadren) cirkadián-mintát közelíti', en: 'Modified-release brand (Plenadren) approximates circadian pattern', pl: 'Marka modified-release (Plenadren) przybliża rytm dobowy' },
      { hu: 'Stressz-dóziséval akut krízis-megelőzés', en: 'Stress dose prevents acute crisis', pl: 'Dawka stresowa zapobiega ostremu kryzysowi' },
    ],
    studies: [
      { title: 'Diagnosis and treatment of primary adrenal insufficiency: an Endocrine Society Clinical Practice Guideline', authors: 'Bornstein SR, Allolio B, Arlt W et al.', journal: 'J Clin Endocrinol Metab. 2016;101(2):364-89.', pmid: '26760044' },
      { title: 'Modified-release hydrocortisone (Plenadren) in adrenal insufficiency', authors: 'Johannsson G, Nilsson AG, Bergthorsdottir R et al.', journal: 'J Clin Endocrinol Metab. 2012;97(2):473-81.', pmid: '22112814' },
    ],
    related: ['levothyroxin'],
    doseCalc: {
      type: 'fixedDose',
      fixedDose: { low: 15, medium: 20, high: 25 },
      unit: 'mg/nap (split: 2/3 reggel + 1/3 délután)',
      note: { hu: 'STANDARD pótlás: 15-25 mg/nap split-dózissal. STRESSZ-DÓZIS: enyhe betegség 2x, súlyos 3x. MŰTÉT: 50-100 mg IV intra-op + folytatás. AKUT KRÍZIS: 100 mg IV bolus + 200 mg/24 h infúzió. Soha ne hagyja abba hirtelen — krónikus szupresszió után 6-12 hónapos lassú leépítés.', en: 'STANDARD replacement: 15-25 mg/day split. STRESS DOSE: mild illness 2x, severe 3x. SURGERY: 50-100 mg IV intra-op + continue. ACUTE CRISIS: 100 mg IV bolus + 200 mg/24 h infusion. Never stop abruptly — slow taper over 6-12 months after chronic suppression.', pl: 'STANDARD: 15-25 mg/dzień split. DAWKA STRESOWA: łagodna choroba 2x, ciężka 3x. OPERACJA: 50-100 mg IV intra-op + kontynuacja. OSTRY KRYZYS: 100 mg IV bolus + 200 mg/24h wlew. Nigdy nie przerywaj nagle — powolne zmniejszanie 6-12 miesięcy po przewlekłej supresji.' },
    },
  },

  // ===== EXTRA. LIOTHYRONINE (Endokrin, T3) =====
  {
    id: 'liothyronine',
    ...
    description: {
      hu: 'A Liothyronine az aktív T3-hormon szintetikus formája (Cytomel, FDA 1956). NEM rutin-választás a hipotireózis kezelésében — Levothyroxin (T4) az endogén deiodaze-konverzió révén ad fiziológiás T3-szintet. Specifikus indikációk: (1) MIXEDÉMA-KÓMA sürgősségi kezelése (gyors hatású T3 IV), (2) szubjektív tüneti hipotireózis Levothyroxin-en normál TSH-val (T4-T3 konverzió-zavar gyanúja, ETA 2012 PMID 24782999 vita), (3) MDD-augmentáció (Cooper-Kazaz 2007 PMID 17888912 MDD-rezisztens), (4) DTC-szuppresszió post-thyroidectomia gyors hatás-kezdettel. A felezési ideje rövid (1 nap vs T4 7 nap), ezért 2-3x/nap adagolás szükséges, és nehezebb stabil-szintet elérni.',
      en: 'Liothyronine is the synthetic form of active T3 hormone (Cytomel, FDA 1956). NOT routine in hypothyroidism — levothyroxine (T4) provides physiologic T3 via endogenous deiodinase conversion. Specific indications: (1) MYXEDEMA COMA emergency treatment (fast-onset T3 IV), (2) subjective symptomatic hypothyroidism on levothyroxine with normal TSH (suspected T4-T3 conversion impairment, ETA 2012 PMID 24782999 debate), (3) MDD augmentation (Cooper-Kazaz 2007 PMID 17888912 treatment-resistant MDD), (4) DTC suppression post-thyroidectomy with fast onset. Short half-life (1 day vs T4 7 days), so 2-3x/day dosing required, harder to achieve stable levels.',
      pl: 'Liotyronina to syntetyczna forma aktywnego hormonu T3 (Cytomel, FDA 1956). NIE rutynowo w niedoczynności — lewotyroksyna (T4) zapewnia fizjologiczną T3 przez endogenne dejodynazy. Specyficzne wskazania: (1) ŚPIĄCZKA MIKSOWOBRZĘKOWA leczenie nagłe (szybko działająca T3 IV), (2) subiektywna objawowa niedoczynność na lewotyroksynie z normalnym TSH (podejrzenie zaburzenia konwersji T4-T3, ETA 2012 PMID 24782999), (3) augmentacja MDD (Cooper-Kazaz 2007 PMID 17888912 oporne MDD), (4) supresja DTC po tyreoidektomii z szybkim startem. Krótki okres półtrwania (1 dzień vs T4 7 dni), wymaga 2-3x/dzień, trudniej osiągnąć stabilne poziomy.',
    },
    mechanism: { hu: 'Direkt T3-pótlás, NEM igényli a T4 → T3 perifériás deiodáz-konverziót. Azonnal aktiválja a tiroid receptor.', en: 'Direct T3 replacement, NOT requiring T4 → T3 peripheral deiodinase conversion. Immediately activates thyroid receptor.', pl: 'Bezpośrednie uzupełnienie T3, NIE wymaga obwodowej konwersji T4 → T3. Natychmiast aktywuje receptor tarczycy.' },
    legalStatus: { hu: 'EU/HU: vényköteles (Cytomel, Thybon). USA: FDA Rx (Cytomel).', en: 'EU/HU: prescription only (Cytomel, Thybon). USA: FDA Rx (Cytomel).', pl: 'UE/PL: na receptę (Cytomel, Thybon). USA: FDA Rx (Cytomel).' },
    onsetTime: '2-4 h (oral), minutes (IV)',
    halfLife: '~1 day (much shorter than T4)',
    atcCode: 'H03AA02',
    prescriptionStatus: { hu: 'Vényköteles (Rx)', en: 'Prescription only (Rx)', pl: 'Na receptę (Rx)' },
    indications: [
      { hu: 'Mixedéma-kóma (sürgősségi)', en: 'Myxedema coma (emergency)', pl: 'Śpiączka miksowobrzękowa (nagła)' },
      { hu: 'Hipotireózis specifikus indikációkban (T4 + T3 kombinált, off-label)', en: 'Hypothyroidism specific cases (T4 + T3 combined, off-label)', pl: 'Niedoczynność specyficzne (T4 + T3 połączone, off-label)' },
      { hu: 'MDD-augmentáció (off-label, treatment-resistant)', en: 'MDD augmentation (off-label, treatment-resistant)', pl: 'Augmentacja MDD (off-label, oporne)' },
      { hu: 'DTC TSH-szuppresszió bridge (gyors hatás)', en: 'DTC TSH suppression bridge (fast onset)', pl: 'Most supresji TSH w DTC (szybki start)' },
    ],
    contraindications: [
      { hu: 'Akut MI, kezeletlen mellékvese-elégtelenség, tireotoxikózis', en: 'Acute MI, untreated adrenal insufficiency, thyrotoxicosis', pl: 'Ostre MI, nieleczona niewydolność nadnerczy, tyreotoksykoza' },
    ],
    commonSideEffects: [
      { hu: 'Túladagolás tüneti: tachycardia, tremor, izzadás, szorongás, hőintolerancia, súlyveszteség', en: 'Over-replacement symptoms: tachycardia, tremor, sweating, anxiety, heat intolerance, weight loss', pl: 'Objawy nadmiernego uzupełnienia: tachykardia, drżenie, pocenie, niepokój, nietolerancja ciepła, utrata wagi' },
      { hu: 'Pitvarfibrilláció kockázat (idős, krónikus túl-pótlás)', en: 'Atrial fibrillation risk (elderly, chronic over-replacement)', pl: 'Ryzyko migotania przedsionków (starsi, przewlekłe nadmierne uzupełnienie)' },
    ],
    cyp450: ['Not CYP-metabolized (deiodination + conjugation)'],
    crossMolInteractions: [
      { hu: 'Warfarin: hatás fokozódhat, INR monitor', en: 'Warfarin: effect may potentiate, INR monitor', pl: 'Warfaryna: efekt może się nasilić, monitor INR' },
      { hu: 'Cholestyramin, vas, kalcium: 4 órás távolság szükséges', en: 'Cholestyramine, iron, calcium: 4-hour spacing required', pl: 'Kolestyramina, żelazo, wapń: wymagany 4-godzinny odstęp' },
    ],
    benefits: [
      { hu: 'Gyors hatás-kezdet (mixedéma-kóma sürgősségben)', en: 'Fast onset (emergency in myxedema coma)', pl: 'Szybki start (w nagłej śpiączce miksowobrzękowej)' },
      { hu: 'MDD-augmentáció evidencia (off-label)', en: 'MDD augmentation evidence (off-label)', pl: 'Dowody augmentacji MDD (off-label)' },
    ],
    studies: [
      { title: '2014 ETA Guidelines on the use of L-T4 + L-T3', authors: 'Wiersinga WM, Duntas L, Fadeyev V et al.', journal: 'Eur Thyroid J. 2012;1(2):55-71.', pmid: '24782999' },
      { title: 'Liothyronine in major depressive disorder augmentation', authors: 'Cooper-Kazaz R, Apter JT, Cohen R et al.', journal: 'Arch Gen Psychiatry. 2007;64(6):679-88.', pmid: '17548750' },
    ],
    related: ['levothyroxin', 'methimazole'],
    doseCalc: {
      type: 'fixedDose',
      fixedDose: { low: 5, medium: 25, high: 75 },
      unit: 'µg/nap',
      note: { hu: 'Alacsony (5 µg/nap split): MDD-augmentáció kezdés, idős vagy CV-rizikójú beteg. Mérsékelt (25-50 µg/nap): T4+T3 kombináció hipotireózisban. Magas (75 µg/nap): DTC TSH-szuppresszió rövid távon. SOSE ÖNMAGÁBAN T4 helyett rutinszerűen.', en: 'Low (5 µg/day split): MDD augmentation start, elderly or CV-risk. Moderate (25-50 µg/day): T4+T3 combination hypothyroidism. High (75 µg/day): short-term DTC TSH suppression. NEVER replace T4 routinely.', pl: 'Niska (5 µg/dzień split): start augmentacji MDD, starsi lub ryzyko CV. Średnia (25-50 µg/dzień): kombinacja T4+T3 niedoczynność. Wysoka (75 µg/dzień): krótkoterminowa supresja TSH w DTC. NIGDY rutynowo zamiast T4.' },
    },
  },

  // ===== EXTRA. AZITHROMYCIN (Antiinfekt, makrolid) =====
  {
    id: 'azithromycin',
    name: 'Azithromycin',
    image: null,
    ...
    description: {
      ...
      pl: 'Azytromycyna to półsyntetyczny antybiotyk makrolidowy (Pfizer Zithromax, FDA 1991). Hamuje bakteryjną podjednostkę rybosomalną 50S (translokacja RNA), generalnie bakteriostatyczna, bakteriobójcza dla wysoko podatnych Gram-dodatnich (S. pneumoniae). Spektrum: typowe oddechowe (S. pneumoniae, H. influenzae) + atypowe (Mycoplasma, Chlamydia, Legionella) + STD (Chlamydia trachomatis, Neisseria gonorrhoeae). Unikalna PK: stężenie tkankowe 100x osocza, umożliwiając "Z-pack" 5-dniowy protokół. Ostrzeżenie FDA o wydłużeniu QT (Ray 2012 NEJM PMID 22591294 — podwyższona śmiertelność CV).',
    },
    mechanism: { hu: 'Bakteriális 50S riboszóma kötés → mRNA-transzlokáció gátlás → fehérje-szintézis blokk. Bakteriostatikus. Magas szöveti penetráció + lassú felszabadulás.', en: 'Bacterial 50S ribosome binding → mRNA translocation inhibition → protein synthesis block. Bacteriostatic. High tissue penetration + slow release.', pl: 'Wiązanie z 50S rybosomem bakteryjnym → hamowanie translokacji mRNA → blok syntezy białek. Bakteriostatyczna. Wysoka penetracja tkankowa + powolne uwalnianie.' },
    legalStatus: { hu: 'EU/HU: vényköteles (Sumamed, Azitrolid, Zithromax, generikus). USA: FDA Rx.', en: 'EU/HU: prescription only (Sumamed, Azitrolid, Zithromax, generics). USA: FDA Rx.', pl: 'UE/PL: na receptę (Sumamed, Azitrolid, Zithromax, generyki). USA: FDA Rx.' },
    ...
    indications: [
      { hu: 'Közösségi pneumónia (CAP, mild-moderate)', en: 'Community-acquired pneumonia (CAP, mild-moderate)', pl: 'Środowiskowo nabyte zapalenie płuc (CAP, łagodne-średnie)' },
      { hu: 'Atipikus pneumónia (Mycoplasma, Chlamydia, Legionella)', en: 'Atypical pneumonia (Mycoplasma, Chlamydia, Legionella)', pl: 'Atypowe zapalenie płuc (Mycoplasma, Chlamydia, Legionella)' },
      { hu: 'Akut sinusitis, otitis media, faringitis', en: 'Acute sinusitis, otitis media, pharyngitis', pl: 'Ostre zapalenie zatok, ucha, gardła' },
      { hu: 'STD: Chlamydia trachomatis (1 g egyszeri dózis), Neisseria gonorrhoeae (CDC kombináció)', en: 'STD: Chlamydia trachomatis (1 g single dose), Neisseria gonorrhoeae (CDC combination)', pl: 'STD: Chlamydia trachomatis (1 g jednorazowo), Neisseria gonorrhoeae (kombinacja CDC)' },
    ],
    contraindications: [
      { hu: 'Makrolid-hipersenzitivitás (Erythromycin, Clarithromycin keresztreaktivitás)', en: 'Macrolide hypersensitivity (erythromycin, clarithromycin cross-reactivity)', pl: 'Nadwrażliwość na makrolidy (krzyżowa reaktywność z erytromycyną, klarytromycyną)' },
      { hu: 'Veleszületett hosszú-QT szindróma', en: 'Congenital long-QT syndrome', pl: 'Wrodzony zespół długiego QT' },
    ],
    commonSideEffects: [
      { hu: 'GI: hasmenés, hányinger, hasi diszkomfort (5-10%)', en: 'GI: diarrhea, nausea, abdominal discomfort (5-10%)', pl: 'GI: biegunka, nudności, dyskomfort brzucha (5-10%)' },
      { hu: 'Súlyos, ritka: QT-prolongáció, torsades de pointes, CV-halálozás emelkedés (Ray 2012), C. diff colitis, hepatotoxicitás', en: 'Severe, rare: QT prolongation, torsades de pointes, CV mortality rise (Ray 2012), C. diff colitis, hepatotoxicity', pl: 'Ciężkie, rzadkie: wydłużenie QT, torsade de pointes, wzrost śmiertelności CV (Ray 2012), zapalenie jelita C. diff, hepatotoksyczność' },
    ],
    cyp450: ['Minimal CYP3A4 substrate (vs erythromycin, clarithromycin both strong CYP3A4 inhibitors)', 'Few drug interactions'],
    crossMolInteractions: [
      { hu: 'QT-prolongáló szerek (SSRI, antipszichotikum, antiaritmikum): additív QT-kockázat', en: 'QT-prolonging drugs (SSRI, antipsychotic, antiarrhythmic): additive QT risk', pl: 'Leki wydłużające QT (SSRI, antypsychotyk, antyarytmik): addytywne ryzyko QT' },
      { hu: 'Warfarin: INR-emelkedés lehetséges, monitor', en: 'Warfarin: INR may rise, monitor', pl: 'Warfaryna: INR może wzrosnąć, monitor' },
    ],
    benefits: [
      { hu: '5-napos rövid kúra (Z-pack) jó compliance', en: '5-day short course (Z-pack) good compliance', pl: '5-dniowy krótki kurs (Z-pack) dobry compliance' },
      { hu: 'Atipikus organizmusokra (Mycoplasma, Chlamydia) hatékony', en: 'Effective against atypicals (Mycoplasma, Chlamydia)', pl: 'Skuteczna na atypowe (Mycoplasma, Chlamydia)' },
      { hu: 'STD egyszeri-dózis kezelés (Chlamydia 1 g)', en: 'STD single-dose treatment (Chlamydia 1 g)', pl: 'Leczenie STD jednorazową dawką (Chlamydia 1 g)' },
    ],
    studies: [
      { title: 'Azithromycin and the risk of cardiovascular death', authors: 'Ray WA, Murray KT, Hall K et al.', journal: 'N Engl J Med. 2012;366(20):1881-90.', pmid: '22591294' },
      { title: 'Azithromycin for the secondary prevention of coronary heart disease events (ACES)', authors: 'Grayston JT, Kronmal RA, Jackson LA et al.', journal: 'N Engl J Med. 2005;352(16):1637-45.', pmid: '15843666' },
      { title: 'CDC sexually transmitted infections treatment guidelines', authors: 'Workowski KA, Bachmann LH, Chan PA et al.', journal: 'MMWR Recomm Rep. 2021;70(4):1-187.', pmid: '34292926' },
    ],
    related: ['amoxicillin', 'ciprofloxacin', 'doxycycline'],
    doseCalc: {
      type: 'fixedDose',
      fixedDose: { low: 250, medium: 500, high: 1000 },
      unit: 'mg',
      note: { hu: 'Z-pack standard: 500 mg nap 1, majd 250 mg/nap 2-5. (összesen 1,5 g). CAP: 500 mg/nap 3 napig. STD Chlamydia: 1 g egyszeri dózis. Étkezéstől függetlenül. QT-prolongáló szerekkel óvatosan.', en: 'Z-pack standard: 500 mg day 1, then 250 mg/day days 2-5 (total 1.5 g). CAP: 500 mg/day for 3 days. STD Chlamydia: 1 g single dose. Food-independent. Caution with QT-prolonging drugs.', pl: 'Standard Z-pack: 500 mg dzień 1, potem 250 mg/dzień dni 2-5 (łącznie 1,5 g). CAP: 500 mg/dzień przez 3 dni. STD Chlamydia: 1 g jednorazowo. Niezależnie od jedzenia. Ostrożność z lekami wydłużającymi QT.' },
    },
  },

  // ===== EXTRA. CIPROFLOXACIN (Antiinfekt, fluoroquinolone) =====
  {
    id: 'ciprofloxacin',
    name: 'Ciprofloxacin',
    image: null,
    ...
    description: {
      hu: 'A Ciprofloxacin a fluorokinolon-osztály prototípusa (Bayer Cipro, FDA 1987). DNS-giráz és topoizomeráz-IV gátlása révén baktericid. Erős Gram-negatív (E. coli, Pseudomonas, Klebsiella), mérsékelt Gram-pozitív aktivitás. Az FDA 2016/2018 BOXED WARNING jelentős: ínszakadás, perifériás neuropátia, mentális mellékhatás (zavartság, delirium), aorta-aneurizma. Az "antibiotic stewardship" miatt enyhe UTI-re NEM ajánlott első-vonalként — komplikációs UTI, prosztatitisz, akut sinusitis (nem-súlyos), GI-infekciók (Salmonella, Shigella) tipikus indikációk. A FDA + EMA 2019-es újraértékelés a fluorokinolonok használatát szigorúan limitálja.',
      en: 'Ciprofloxacin is the fluoroquinolone class prototype (Bayer Cipro, FDA 1987). Bactericidal via DNA gyrase and topoisomerase IV inhibition. Strong Gram-negative (E. coli, Pseudomonas, Klebsiella), moderate Gram-positive activity. FDA 2016/2018 BOXED WARNING is significant: tendon rupture, peripheral neuropathy, mental side effects (confusion, delirium), aortic aneurysm. Due to antibiotic stewardship, NOT first-line for mild UTI — typical indications: complicated UTI, prostatitis, non-severe acute sinusitis, GI infections (Salmonella, Shigella). FDA + EMA 2019 reassessment strictly limits fluoroquinolone use.',
      pl: 'Cyprofloksacyna to prototyp klasy fluorochinolonów (Bayer Cipro, FDA 1987). Bakteriobójcza przez hamowanie gyrazy DNA i topoizomerazy IV. Silna aktywność Gram-ujemna (E. coli, Pseudomonas, Klebsiella), umiarkowana Gram-dodatnia. OSTRZEŻENIE FDA 2016/2018 BOXED: zerwania ścięgien, neuropatia obwodowa, działania mentalne (dezorientacja, delirium), tętniak aorty. Ze względu na stewardship antybiotykowy NIE pierwsza linia dla łagodnego UTI — typowe wskazania: powikłany UTI, zapalenie prostaty, niesilne ostre zapalenie zatok, infekcje GI (Salmonella, Shigella). Ponowna ocena FDA + EMA 2019 ściśle ogranicza stosowanie fluorochinolonów.',
    },
    mechanism: { hu: 'DNS-giráz (topoizomeráz-II) és topoizomeráz-IV szelektív gátlás → DNS-replikáció és transzkripció blokk → baktericid.', en: 'Selective DNA gyrase (topoisomerase II) and topoisomerase IV inhibition → DNA replication and transcription block → bactericidal.', pl: 'Selektywne hamowanie gyrazy DNA (topoizomeraza II) i topoizomerazy IV → blok replikacji i transkrypcji DNA → bakteriobójcze.' },
    legalStatus: { hu: 'EU/HU: vényköteles (Ciprobay, Ciprinol, generikus). USA: FDA Rx (Cipro).', en: 'EU/HU: prescription only (Ciprobay, Ciprinol, generics). USA: FDA Rx (Cipro).', pl: 'UE/PL: na receptę (Ciprobay, Ciprinol, generyki). USA: FDA Rx (Cipro).' },
    onsetTime: '24-48 h (clinical response)',
    halfLife: '~4 h (twice-daily dosing)',
    atcCode: 'J01MA02',
    prescriptionStatus: { hu: 'Vényköteles (Rx), stewardship-protokoll', en: 'Prescription only (Rx), stewardship protocol', pl: 'Na receptę (Rx), protokół stewardship' },
    indications: [
      { hu: 'Komplikációs UTI, pielonefritisz, prosztatitisz', en: 'Complicated UTI, pyelonephritis, prostatitis', pl: 'Powikłany UTI, odmiedniczkowe zapalenie nerek, prostaty' },
      { hu: 'GI infekciók (Salmonella, Shigella, Traveler\'s diarrhea)', en: 'GI infections (Salmonella, Shigella, traveler\'s diarrhea)', pl: 'Infekcje GI (Salmonella, Shigella, biegunka podróżnych)' },
      { hu: 'Csont- és lágyrész-infekciók (Pseudomonas)', en: 'Bone and soft-tissue infections (Pseudomonas)', pl: 'Infekcje kości i tkanek miękkich (Pseudomonas)' },
      { hu: 'Anthrax post-expozíció (CDC protokoll)', en: 'Anthrax post-exposure (CDC protocol)', pl: 'Po-ekspozycyjne wąglik (protokół CDC)' },
    ],
    contraindications: [
      { hu: 'Fluorokinolon-hipersenzitivitás', en: 'Fluoroquinolone hypersensitivity', pl: 'Nadwrażliwość na fluorochinolony' },
      { hu: 'Gyermek/serdülő (csont-növekedési kockázat, kivéve specifikus indikációkban)', en: 'Children/adolescent (bone growth risk, except specific indications)', pl: 'Dzieci/młodzież (ryzyko wzrostu kości, oprócz specyficznych wskazań)' },
      { hu: 'Myasthenia gravis (relatív kontraindikáció)', en: 'Myasthenia gravis (relative contraindication)', pl: 'Miastenia gravis (względne)' },
    ],
    commonSideEffects: [
      { hu: 'GI: hányinger, hasmenés, hasi diszkomfort', en: 'GI: nausea, diarrhea, abdominal discomfort', pl: 'GI: nudności, biegunka, dyskomfort' },
      { hu: 'Fejfájás, szédülés, álmatlanság', en: 'Headache, dizziness, insomnia', pl: 'Ból głowy, zawroty głowy, bezsenność' },
      { hu: 'Súlyos: ÍNSZAKADÁS (Achilles, FDA boxed, főleg 60+ év + szteroid), PERIFÉRIÁS NEUROPÁTIA (irreverzibilis), MENTÁLIS TÜNETEK (zavartság, pszichózis), AORTA-ANEURIZMA, C. diff colitis, fototoxikus reakció', en: 'Severe: TENDON RUPTURE (Achilles, FDA boxed, especially 60+ + steroid), PERIPHERAL NEUROPATHY (irreversible), MENTAL EFFECTS (confusion, psychosis), AORTIC ANEURYSM, C. diff colitis, photosensitivity', pl: 'Ciężkie: ZERWANIE ŚCIĘGNA (Achillesa, FDA boxed, zwłaszcza 60+ + sterydy), NEUROPATIA OBWODOWA (nieodwracalna), DZIAŁANIA MENTALNE (dezorientacja, psychoza), TĘTNIAK AORTY, zapalenie C. diff, fotouczulenie' },
    ],
    cyp450: ['CYP1A2 INHIBITOR (significant)', 'Caffeine, theophylline, tizanidine interactions'],
    crossMolInteractions: [
      { hu: 'Tizanidin: ABSZOLÚT kontraindikált (CYP1A2-blokk extrém hipotenzió + szedáció)', en: 'Tizanidine: ABSOLUTE contraindication (CYP1A2 block extreme hypotension + sedation)', pl: 'Tyzanidyna: BEZWZGLĘDNE przeciwwskazanie (blok CYP1A2 ekstremalna hipotensja + sedacja)' },
      { hu: 'Theophyllin, koffein: plazma-szint emelkedhet, toxicitás', en: 'Theophylline, caffeine: plasma may rise, toxicity', pl: 'Teofilina, kofeina: poziom może wzrosnąć, toksyczność' },
      { hu: 'Warfarin: INR-emelkedés', en: 'Warfarin: INR rise', pl: 'Warfaryna: wzrost INR' },
      { hu: 'Antacid (Al, Mg, Ca), vas: KÉT órás távolság szükséges (chelát-képződés)', en: 'Antacid (Al, Mg, Ca), iron: 2-hour spacing required (chelate formation)', pl: 'Antacyd (Al, Mg, Ca), żelazo: wymagany 2-godzinny odstęp (chelatacja)' },
    ],
    benefits: [
      { hu: 'Erős Pseudomonas-aktivitás (komplex UTI, csont-infekció)', en: 'Strong Pseudomonas activity (complex UTI, bone infection)', pl: 'Silna aktywność Pseudomonas (powikłany UTI, infekcja kości)' },
      { hu: 'Oralis biodostępność ~70% (IV-vel ekvivalens)', en: 'Oral bioavailability ~70% (IV-equivalent)', pl: 'Biodostępność doustna ~70% (równoważna IV)' },
      { hu: 'Anthrax post-expozíció CDC standard', en: 'Anthrax post-exposure CDC standard', pl: 'Standard CDC po ekspozycji na wąglik' },
    ],
    studies: [
      { title: 'Fluoroquinolones and the risk of aortic aneurysm or aortic dissection', authors: 'Pasternak B, Inghammar M, Svanström H.', journal: 'BMJ. 2018;360:k678.', pmid: '29519881' },
      { title: 'FDA boxed warnings for fluoroquinolones: safety review', authors: 'Tanne JH.', journal: 'BMJ. 2018;363:k4934.', pmid: '30459112' },
      { title: 'Ciprofloxacin in complicated urinary tract infections', authors: 'Wagenlehner FM, Naber KG.', journal: 'Int J Antimicrob Agents. 2004;24 Suppl 1:S1-3.', pmid: '15364298' },
    ],
    related: ['amoxicillin', 'azithromycin', 'doxycycline'],
    doseCalc: {
      type: 'fixedDose',
      fixedDose: { low: 250, medium: 500, high: 750 },
      unit: 'mg 2x/nap',
      note: { hu: 'Enyhe UTI: 250 mg 2x/nap 3 nap. Komplex UTI/pielonefritisz: 500 mg 2x/nap 7-14 nap. Csont-infekció/súlyos eset: 750 mg 2x/nap 4-6 hét. Hidratáció (kristalluria), kerülni a szoláriumot (fototoxicitás). Ínszakadás-figyelmeztető tünet (boka/Achilles fájdalom) AZONNAL STOP.', en: 'Mild UTI: 250 mg BID 3 days. Complex UTI/pyelonephritis: 500 mg BID 7-14 days. Bone infection/severe: 750 mg BID 4-6 weeks. Hydration (crystalluria), avoid tanning beds (photosensitivity). Tendon warning signs (ankle/Achilles pain) IMMEDIATE STOP.', pl: 'Łagodny UTI: 250 mg 2x/dzień 3 dni. Powikłany UTI: 500 mg 2x/dzień 7-14 dni. Infekcja kości/ciężka: 750 mg 2x/dzień 4-6 tygodni. Nawodnienie, unikać solarium. Objawy ostrzegawcze ścięgna (kostka/Achilles) NATYCHMIAST STOP.' },
    },
  },

  // ===== EXTRA. DOXYCYCLINE (Antiinfekt, tetracycline) =====
  {
    id: 'doxycycline',
    name: 'Doxycycline',
    image: null,
    ...
    mechanism: { hu: '30S riboszomális alegység-blokk → aminoacyl-tRNS nem tud kötődni → fehérje-szintézis blokk. Bakteriosztatikus.', en: '30S ribosomal subunit block → aminoacyl-tRNA cannot bind → protein synthesis block. Bacteriostatic.', pl: 'Blok podjednostki 30S → aminoacylo-tRNA nie może się związać → blok syntezy białek. Bakteriostatyczna.' },
    legalStatus: { hu: 'EU/HU: vényköteles (Vibramycin, Doxakne, generikus). USA: FDA Rx.', en: 'EU/HU: prescription only (Vibramycin, Doxakne, generics). USA: FDA Rx.', pl: 'UE/PL: na receptę (Vibramycin, Doxakne, generyki). USA: FDA Rx.' },
    onsetTime: '24-48 h (clinical response)',
    halfLife: '18-22 h (once or twice daily)',
    atcCode: 'J01AA02',
    prescriptionStatus: { hu: 'Vényköteles (Rx)', en: 'Prescription only (Rx)', pl: 'Na receptę (Rx)' },
    indications: [
      { hu: 'Lyme-betegség korai stádium (21 napos protokoll)', en: 'Early-stage Lyme disease (21-day protocol)', pl: 'Wczesna Lyme (protokół 21-dniowy)' },
      { hu: 'Atipikus pneumónia (Mycoplasma, Chlamydia)', en: 'Atypical pneumonia (Mycoplasma, Chlamydia)', pl: 'Atypowe zapalenie płuc (Mycoplasma, Chlamydia)' },
      { hu: 'Klamidia STD, gonorrhoea (kombináció)', en: 'Chlamydia STD, gonorrhea (combination)', pl: 'Chlamydia STD, rzeżączka (kombinacja)' },
      { hu: 'Malária prevenció (utazás endémiás területre)', en: 'Malaria prevention (travel to endemic area)', pl: 'Profilaktyka malarii (podróż w obszar endemiczny)' },
      { hu: 'Acne vulgaris (krónikus alacsony-dózis)', en: 'Acne vulgaris (chronic low-dose)', pl: 'Trądzik (przewlekła niska dawka)' },
      { hu: 'Rosacea, perianális dermatitisz', en: 'Rosacea, perianal dermatitis', pl: 'Trądzik różowaty, dermatitis perianalna' },
    ],
    contraindications: [
      { hu: 'Tetraciklin-hipersenzitivitás', en: 'Tetracycline hypersensitivity', pl: 'Nadwrażliwość na tetracykliny' },
      { hu: 'Terhesség (fog- és csont-fejlődési károsodás), 8 év alatti gyermek', en: 'Pregnancy (tooth and bone development damage), child < 8 yr', pl: 'Ciąża (uszkodzenie zębów i kości), dziecko < 8 lat' },
    ],
    commonSideEffects: [
      { hu: 'Fototoxikus reakció (gyakori, napvédelem KÖTELEZŐ)', en: 'Photosensitivity (common, sunscreen MANDATORY)', pl: 'Fotouczulenie (częste, krem przeciwsłoneczny OBOWIĄZKOWY)' },
      { hu: 'GI: hányinger, hányás, eszofagusz-irritáció (állva, sok vízzel bevenni)', en: 'GI: nausea, vomiting, esophageal irritation (take standing with full water)', pl: 'GI: nudności, wymioty, podrażnienie przełyku (przyjmuj stojąc z dużą ilością wody)' },
      { hu: 'Süllyedt-só candidiasis (vaginális, oralis)', en: 'Oversimplified candidiasis (vaginal, oral)', pl: 'Kandydoza (pochwowa, doustna)' },
      { hu: 'Súlyos, ritka: pszeudotumor cerebri (intrakraniális hipertenzió), C. diff colitis, hepatotoxicitás', en: 'Severe, rare: pseudotumor cerebri (intracranial hypertension), C. diff colitis, hepatotoxicity', pl: 'Ciężkie, rzadkie: pseudotumor cerebri (nadciśnienie wewnątrzczaszkowe), zapalenie C. diff, hepatotoksyczność' },
    ],
    cyp450: ['No significant CYP metabolism', 'Minimal drug interactions'],
    crossMolInteractions: [
      { hu: 'Antacid (Al, Mg, Ca), vas, multivitamin: 2-3 órás távolság (chelát-képződés)', en: 'Antacid (Al, Mg, Ca), iron, multivitamin: 2-3 hour spacing (chelate formation)', pl: 'Antacyd (Al, Mg, Ca), żelazo, multiwitamina: 2-3 godzinny odstęp (chelatacja)' },
      { hu: 'Warfarin: INR-emelkedés', en: 'Warfarin: INR rise', pl: 'Warfaryna: wzrost INR' },
      { hu: 'Orális fogamzásgátló: nincs klinikailag szignifikáns interakció (CDC)', en: 'Oral contraceptive: no clinically significant interaction (CDC)', pl: 'Doustna antykoncepcja: brak istotnej klinicznie interakcji (CDC)' },
    ],
    benefits: [
      { hu: 'Lyme-betegség korai stádium gold-standard', en: 'Early Lyme disease gold standard', pl: 'Złoty standard wczesnej Lyme' },
      { hu: 'Malária prevenció utazóknak', en: 'Malaria prevention for travelers', pl: 'Profilaktyka malarii dla podróżujących' },
      ...
      { hu: 'Acne krónikus alacsony-dózisú terápia', en: 'Acne chronic low-dose therapy', pl: 'Trądzik terapia przewlekła niskimi dawkami' },
    ],
    studies: [
      { title: 'Treatment of Lyme disease: 2020 IDSA guideline', authors: 'Lantos PM, Rumbaugh J, Bockenstedt LK et al.', journal: 'Clin Infect Dis. 2021;72(1):e1-e48.', pmid: '33417672' },
      { title: 'Doxycycline for malaria prophylaxis', authors: 'Tan KR, Magill AJ, Parise ME et al.', journal: 'Am J Trop Med Hyg. 2011;84(4):517-31.', pmid: '21460003' },
      { title: 'Doxycycline in atypical community-acquired pneumonia', authors: 'Bartlett JG, Mundy LM.', journal: 'N Engl J Med. 1995;333(24):1618-24.', pmid: '7477199' },
    ],
    related: ['amoxicillin', 'azithromycin', 'ciprofloxacin'],
    doseCalc: {
      type: 'fixedDose',
      fixedDose: { low: 50, medium: 100, high: 200 },
      unit: 'mg/nap',
      note: { hu: 'Alacsony (50 mg/nap): acne krónikus. Standard (100 mg 1-2x/nap): legtöbb akut infekció. Magas (200 mg/nap): súlyos infekció vagy Lyme korai stádium. ÁLLVA, sok vízzel bevenni (eszofagusz-irritáció). Napvédelem KÖTELEZŐ. Antacid/vas 2-3 órás eltolva.', en: 'Low (50 mg/day): chronic acne. Standard (100 mg 1-2x/day): most acute infections. High (200 mg/day): severe infection or early Lyme. Take STANDING with full water (esophageal irritation). Sunscreen MANDATORY. Antacid/iron 2-3 hours apart.', pl: 'Niska (50 mg/dzień): przewlekły trądzik. Standard (100 mg 1-2x/dzień): większość ostrych infekcji. Wysoka (200 mg/dzień): ciężka lub wczesna Lyme. Przyjmuj STOJĄC z dużą ilością wody. Krem przeciwsłoneczny OBOWIĄZKOWY. Antacyd/żelazo 2-3 h odstęp.' },
    },
  },

  // ===== EXTRA. METRONIDAZOLE (Antiinfekt, nitroimidazole, anaerob + protozoa) =====
  {
    id: 'metronidazole',
    name: 'Metronidazole',
    image: null,
    ...
    description: {
      ...
      en: 'Metronidazole is a nitroimidazole antibiotic (Sanofi Flagyl, FDA 1963). Selectively active against anaerobic bacteria and protozoa: bacterial/protozoan reducing enzymes (pyruvate-ferredoxin oxidoreductase) convert it to reactive nitro radicals damaging DNA. Inactive against aerobics. Standard indications: C. difficile colitis (vancomycin alternative for mild-moderate), bacterial vaginitis, trichomoniasis, giardiasis, amoebiasis, H. pylori eradication triple therapy. Generally well tolerated, but DISULFIRAM-like reaction with alcohol — absolute alcohol prohibition during treatment and 48 h after.',
      pl: 'Metronidazol to antybiotyk nitroimidazolowy (Sanofi Flagyl, FDA 1963). Selektywnie aktywny przeciw bakteriom beztlenowym i pierwotniakom: bakteryjne/pierwotniakowe enzymy redukujące (pirogronian-ferredoksyna oksydoreduktaza) przekształcają go w reaktywne rodniki uszkadzające DNA. Nieaktywny przeciw tlenowcom. Standardowe wskazania: zapalenie jelita C. difficile (alternatywa wankomycyny dla łagodnych-średnich), vaginitis bakteryjny, trichomonoza, giardioza, amebioza, eradykacja H. pylori w terapii potrójnej. Generalnie dobrze tolerowany, ale reakcja PODOBNA DO DISULFIRAMU z alkoholem — bezwzględny zakaz alkoholu podczas leczenia i 48 h po.',
    },
    mechanism: { hu: 'Anaerob baktérium/protozoa felszív + redukció reaktív nitro-radikálokká → DNS-károsodás → sejthalál. Aerob organizmusokra inaktív (nincs redukáló enzim).', en: 'Anaerobic bacterial/protozoan uptake + reduction to reactive nitro radicals → DNA damage → cell death. Inactive vs aerobics (no reducing enzyme).', pl: 'Wchłanianie + redukcja w bakterii/pierwotniaku do reaktywnych rodników → uszkodzenie DNA → śmierć komórki. Nieaktywny przeciw tlenowcom.' },
    legalStatus: { hu: 'EU/HU: vényköteles (Klion, Flagyl, generikus). USA: FDA Rx.', en: 'EU/HU: prescription only (Klion, Flagyl, generics). USA: FDA Rx.', pl: 'UE/PL: na receptę (Klion, Flagyl, generyki). USA: FDA Rx.' },
    onsetTime: '24-48 h (clinical response)',
    halfLife: '~8 h (twice or thrice daily)',
    atcCode: 'J01XD01',
    prescriptionStatus: { hu: 'Vényköteles (Rx)', en: 'Prescription only (Rx)', pl: 'Na receptę (Rx)' },
    indications: [
      { hu: 'C. difficile colitis (enyhe-mérsékelt, vancomycin-alternatíva)', en: 'C. difficile colitis (mild-moderate, vancomycin alternative)', pl: 'Zapalenie jelita C. difficile (łagodne-średnie, alternatywa wankomycyny)' },
      { hu: 'Bakteriális vaginitisz (Gardnerella)', en: 'Bacterial vaginitis (Gardnerella)', pl: 'Vaginitis bakteryjny (Gardnerella)' },
      { hu: 'Trichomoniasis (STD, partner-kezelés is)', en: 'Trichomoniasis (STD, partner treatment also)', pl: 'Trichomonoza (STD, też leczenie partnera)' },
      { hu: 'Giardiasis, amoebiasis (utazó-diarrhea)', en: 'Giardiasis, amoebiasis (traveler\'s diarrhea)', pl: 'Giardioza, amebioza (biegunka podróżnych)' },
      { hu: 'H. pylori eradikáció (PPI + Amoxicillin + Clarithromycin/Metronidazole)', en: 'H. pylori eradication (PPI + amoxicillin + clarithromycin/metronidazole)', pl: 'Eradykacja H. pylori (PPI + amoksycylina + klarytromycyna/metronidazol)' },
    ],
    contraindications: [
      { hu: 'Első trimeszter terhesség (relatív, kockázat-haszon mérlegelés)', en: 'First trimester pregnancy (relative, risk-benefit)', pl: 'Pierwszy trymestr ciąży (względne, korzyść-ryzyko)' },
      { hu: 'Aktív alkohol-fogyasztás (disulfiram-reakció)', en: 'Active alcohol consumption (disulfiram reaction)', pl: 'Aktywne spożycie alkoholu (reakcja disulfiramowa)' },
    ],
    commonSideEffects: [
      { hu: 'GI: fémes íz, hányinger, hasi diszkomfort', en: 'GI: metallic taste, nausea, abdominal discomfort', pl: 'GI: metaliczny smak, nudności, dyskomfort' },
      { hu: 'Sötét-bordó vizelet (jóindulatú)', en: 'Dark-red urine (benign)', pl: 'Ciemnoczerwony mocz (łagodny)' },
      { hu: 'Súlyos, ritka: perifériás neuropátia (krónikus magas-dózisú terápián), aszeptikus meningitisz, leukopénia, encefalopátia', en: 'Severe, rare: peripheral neuropathy (chronic high-dose), aseptic meningitis, leukopenia, encephalopathy', pl: 'Ciężkie, rzadkie: neuropatia obwodowa (przewlekła wysoka dawka), aseptyczne zapalenie opon, leukopenia, encefalopatia' },
    ],
    cyp450: ['CYP2C9 INHIBITOR', 'CYP3A4 substrate (minor)'],
    crossMolInteractions: [
      { hu: 'ALKOHOL: ABSZOLÚT tilos a kúra alatt + 48 h utána (disulfiram-szerű reakció, hányás, flushing, palpitációk)', en: 'ALCOHOL: ABSOLUTE prohibition during treatment + 48 h after (disulfiram-like reaction, vomiting, flushing, palpitations)', pl: 'ALKOHOL: BEZWZGLĘDNY zakaz podczas leczenia + 48 h po (reakcja disulfiramowa, wymioty, flushing, kołatania)' },
      { hu: 'Warfarin: INR-emelkedés szignifikáns (CYP2C9-blokk), monitor', en: 'Warfarin: significant INR rise (CYP2C9 block), monitor', pl: 'Warfaryna: znaczący wzrost INR (blok CYP2C9), monitor' },
      { hu: 'Lithium: lithium-szint emelkedhet', en: 'Lithium: levels may rise', pl: 'Lit: poziom może wzrosnąć' },
    ],
    benefits: [
      { hu: 'Anaerob és protozoa-szelektivitás (egyedülálló)', en: 'Anaerobic and protozoa selectivity (unique)', pl: 'Selektywność beztlenowa i pierwotniakowa (unikalna)' },
      { hu: 'C. diff. enyhe-mérsékelt vancomycin-alternatíva', en: 'C. diff mild-moderate vancomycin alternative', pl: 'C. diff łagodna-średnia alternatywa wankomycyny' },
      { hu: 'H. pylori triple-terápia komponens', en: 'H. pylori triple therapy component', pl: 'Komponent terapii potrójnej H. pylori' },
    ],
    studies: [
      { title: 'Vancomycin versus metronidazole for Clostridium difficile colitis', authors: 'Johnson S, Louie TJ, Gerding DN et al.', journal: 'Clin Infect Dis. 2014;59(3):345-54.', pmid: '24799326' },
      { title: 'Metronidazole for bacterial vaginosis: meta-analysis', authors: 'Sherrard J, Donders G, White D et al.', journal: 'Int J STD AIDS. 2011;22(8):421-9.', pmid: '21795415' },
    ],
    related: ['amoxicillin', 'doxycycline', 'azithromycin'],
    doseCalc: {
      type: 'fixedDose',
      fixedDose: { low: 250, medium: 500, high: 750 },
      unit: 'mg 3x/nap',
      note: { hu: 'C. diff: 500 mg 3x/nap 10-14 nap. BV: 500 mg 2x/nap 7 nap. Trichomonas: 2 g egyszeri dózis VAGY 500 mg 2x/nap 7 nap (partner is). H. pylori: 500 mg 2x/nap 14 nap (triple). ALKOHOL TILOS kúra alatt + 48 h. Fémes íz jóindulatú.', en: 'C. diff: 500 mg TID 10-14 days. BV: 500 mg BID 7 days. Trichomonas: 2 g single OR 500 mg BID 7 days (partner too). H. pylori: 500 mg BID 14 days (triple). ALCOHOL FORBIDDEN during + 48 h. Metallic taste benign.', pl: 'C. diff: 500 mg 3x/dzień 10-14 dni. BV: 500 mg 2x/dzień 7 dni. Trichomonas: 2 g jednorazowo LUB 500 mg 2x/dzień 7 dni (też partner). H. pylori: 500 mg 2x/dzień 14 dni (potrójna). ALKOHOL ZAKAZANY podczas + 48 h. Metaliczny smak łagodny.' },
    },
  },
