...
export default {
  ...
  "keyInfo": [
    {
      "label": "Mechanizm",
      "value": "GABA + fale α + modulacja glutaminianu"
    },
    {
      "label": "Początek działania",
      "value": "30-45 min doustnie"
    },
    {
      "label": "Status prawny",
  ...
  "mechanism": "Zwiększa syntezę GABA, glicyny i dopaminy; częściowy antagonista receptora NMDA; podnosi zawartość fal α w EEG → stan „spokojnej koncentracji”. Z kofeiną kompensuje zwężenie naczyń i lęk.",
  "legalStatus": "Aminokwas spożywczy, OTC suplement diety w całej UE i USA. Status FDA GRAS. Wolno dostępna na Węgrzech.",
