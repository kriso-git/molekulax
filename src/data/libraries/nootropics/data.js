...
export const NOOTROPICS = [
 ...
 mechanism: {
 hu: 'Hippocampus szubgranuláris zónájában neuronális progenitor sejt proliferáció + differenciáció. TLX/NR2E1 nukleáris receptor moduláció, BDNF/GDNF/SCF/VEGF expression-emelés, p21 + PTEN gének represziója. Monoamine-receptoroktól és TrKB-tól független mechanizmus.',
 en: 'Proliferation and differentiation of neuronal progenitor cells in the hippocampal subgranular zone. TLX/NR2E1 nuclear receptor modulation, upregulation of BDNF/GDNF/SCF/VEGF expression, repression of p21 + PTEN genes. Independent of monoamine receptors and TrKB.',
 pl: 'Proliferacja i różnicowanie komórek progenitorowych neuronów w strefie subgranularnej hipokampu. Modulacja receptora jądrowego TLX/NR2E1, podniesienie ekspresji BDNF/GDNF/SCF/VEGF, represja genów p21 + PTEN. Niezależnie od receptorów monoaminowych i TrKB.',
 },
 legalStatus: {
 ...
 { hu: 'Strukturális hatás: a kúra abbahagyása után a kognitív emelkedés gyakran fennmarad (plasztikus, nem akut)', en: 'Structural effect: cognitive lift often persists after stopping the course (plastic, not acute)', pl: 'Efekt strukturalny: podniesienie poznawcze często utrzymuje się po zakończeniu kursu (plastyczne, nie ostre)' },
 ],
 quickStart: [
 ...
 { hu: 'Phase 2 MDD vizsgálat primer endpoint-on nem volt szignifikáns (csak szekunder és patient-reported); hatékonyság még nem klinikailag bizonyított', en: 'Phase 2 MDD trial did not hit primary endpoint (only secondary and patient-reported); efficacy not yet clinically established', pl: 'Badanie fazy 2 MDD nie osiągnęło punktu pierwotnego (tylko wtórne i raportowane przez pacjentów); skuteczność jeszcze nie potwierdzona klinicznie' },
 { hu: 'Harangformájú dózis-válasz: 40 mg/nap volt a klinikai vizsgálatok dózisa, magasabb dózis NEM jelent erősebb hatást', en: 'Bell-shaped dose-response: 40 mg/day was the clinical trial dose, higher dose does NOT mean stronger effect', pl: 'Krzywa odpowiedzi w kształcie dzwonu: 40 mg/dzień było dawką w badaniach klinicznych, wyższa dawka NIE oznacza silniejszego efektu' },
 ],
 avoid: [
 ...
 { title: 'NSI-189, a novel multi-domain compound — animal hippocampal neurogenesis and behavioral effects', authors: 'Liu Y et al.', journal: 'Sci Rep. 2014;4:6477.', pmid: '24927526' },
 { title: 'The neurogenic compound NSI-189 phosphate: pro-cognitive and antidepressant effects (review)', authors: 'Papakostas GI et al.', journal: 'Expert Opin Investig Drugs. 2017;26(5):505-518.', pmid: '28460574' },
 ],
 faq: [
 ...
 { q: { hu: 'Több = jobb? Magasabb dózis erősebb hatás?', en: 'More = better? Does higher dose mean stronger effect?', pl: 'Więcej = lepiej? Czy wyższa dawka oznacza silniejszy efekt?' }, a: { hu: 'NEM. Az NSI-189 harangformájú dózis-válasz görbével rendelkezik. 40 mg/nap volt a Phase 1B/2 klinikai dózis, ami a peak hatékonyságot mutatta. Magasabb dózisok (80+ mg) NEM hoznak erősebb neurogenezis-hatást, és növelik a mellékhatás-kockázatot (irritáció, álmatlanság).', en: 'NO. NSI-189 has a bell-shaped dose-response curve. 40 mg/day was the Phase 1B/2 clinical dose at peak efficacy. Higher doses (80+ mg) do NOT produce stronger neurogenic effects and increase side-effect risk (irritability, insomnia).', pl: 'NIE. NSI-189 ma krzywą odpowiedzi w kształcie dzwonu. 40 mg/dzień było dawką w badaniach fazy 1B/2 przy szczycie skuteczności. Wyższe dawki (80+ mg) NIE dają silniejszego efektu neurogennego i zwiększają ryzyko skutków ubocznych (drażliwość, bezsenność).' } },
 ],
 ...
 mechanism: {
 hu: 'Met-Glu-His-Phe-Pro-Gly-Pro szintetikus heptapeptid, ACTH(4-10) analóg. Dopaminerg + szerotonerg + BDNF-mimicking. Réz(II)-ion megkötés képes (chelation) → fémindukált sejt-toxicitás csökkentése. Intranazálisan adva vér-agy-gáton átjut.',
 en: 'Met-Glu-His-Phe-Pro-Gly-Pro synthetic heptapeptide, ACTH(4-10) analog. Dopaminergic + serotonergic + BDNF-mimicking. Capable of copper(II) chelation → reduces metal-induced cellular toxicity. Crosses blood-brain barrier when given intranasally.',
 pl: 'Syntetyczny heptapeptyd Met-Glu-His-Phe-Pro-Gly-Pro, analog ACTH(4-10). Dopaminergiczny + serotonergiczny + naśladujący BDNF. Zdolny do chelatowania miedzi(II) → zmniejsza toksyczność komórkową indukowaną metalami. Przekracza barierę krew-mózg po podaniu donosowym.',
 },
 legalStatus: {
 ...
 { hu: 'Immunmoduláció + anti-inflammációs hatás állat-modellekben', en: 'Immunomodulation + anti-inflammatory effect in animal models', pl: 'Immunomodulacja + działanie przeciwzapalne w modelach zwierzęcych' },
 ],
 quickStart: [
 { hu: 'Intranazális 0.1%-os spray, 2-3 csepp nostrilonként (200-600 mcg)', en: 'Intranasal 0.1% spray, 2-3 drops per nostril (200-600 mcg)', pl: 'Spray donosowy 0,1%, 2-3 krople na nozdrze (200-600 mcg)' },
 ...
 { hu: 'Hajhullás/-ritkulás-jelentések közösségi forrásból (BDNF szőrtüsző-ciklus hatás)', en: 'Hair shedding/thinning reports in community sources (BDNF effect on hair follicle cycle)', pl: 'Doniesienia o wypadaniu/przerzedzaniu włosów (wpływ BDNF na cykl mieszków włosowych)' },
 { hu: 'Bipoláris spektrum + akut mánia kockázata stimulánsabb profil miatt', en: 'Bipolar spectrum + acute mania risk due to more stimulating profile', pl: 'Spektrum dwubiegunowości + ryzyko ostrej manii z powodu bardziej stymulującego profilu' },
 ],
 avoid: [
 ...
 { title: 'Effectiveness of Semax in acute period of hemispheric ischemic stroke (12-18 mg dose)', authors: 'Gusev EI, Skvortsova VI et al.', journal: 'Zh Nevrol Psikhiatr Im S S Korsakova. 2001;101(8):16-21.', pmid: '11517472' },
 { title: 'Efficacy of semax in different stages of ischemic stroke', authors: 'Skvortsova VI et al.', journal: 'Zh Nevrol Psikhiatr Im S S Korsakova. 2018;118(3):54-60.', pmid: '29798983' },
 { title: 'Semax effects on memory and attention in healthy men under extreme conditions', authors: 'Kaplan AYa et al.', journal: 'Aviakosm Ekolog Med. 1996;30(3):29-35.', pmid: '9173745' },
 ],
 faq: [
 ...
 { q: { hu: 'N-Acetyl Semax mi a különbség?', en: 'What is N-Acetyl Semax?', pl: 'Czym jest N-Acetyl Semax?' }, a: { hu: 'Az N-Acetyl Semax egy módosított Semax-variáns, ahol az N-terminus acetil-csoporttal védett. Eredmény: hosszabb felezési idő (a peptid lassabban bomlik az aminopeptidázok által), tehát alacsonyabb dózis szükséges azonos hatáshoz. Per-dose erősebb és tartósabb, de a klinikai vizsgálatok többségét a sima Semax-szal végezték.', en: 'N-Acetyl Semax is a modified Semax variant where the N-terminus is protected with an acetyl group. Result: longer half-life (the peptide degrades more slowly via aminopeptidases), so a lower dose achieves the same effect. Stronger and longer-lasting per dose, but most clinical trials used standard Semax.', pl: 'N-Acetyl Semax to zmodyfikowany wariant Semaxu z grupą acetylową chroniącą N-koniec. Wynik: dłuższy okres półtrwania (peptyd wolniej degraduje przez aminopeptydazy), więc niższa dawka daje ten sam efekt. Silniejszy i dłużej działający na dawkę, ale większość badań klinicznych używała standardowego Semaxu.' } },
 ],
 ...
 mechanism: {
 hu: 'Thr-Lys-Pro-Arg-Pro-Gly-Pro heptapeptid, Tuftsin TKPR analóg prolin-stabilizálással. GABA-erg tónus + BDNF + szerotonerg + enkefalinerg moduláció. Szubunit-szelektív GABA-hatás (alpha-2/3, NEM alpha-1) → szedáció nélkül. Modulál 34 gyulladás-rel. gént (immunmodulátor profil), benzodiazepinhez hasonló mechanizmus függőség nélkül.',
 en: 'Thr-Lys-Pro-Arg-Pro-Gly-Pro heptapeptide, Tuftsin TKPR analog with proline stabilization. GABAergic tone + BDNF + serotonergic + enkephalinergic modulation. Subunit-selective GABA action (alpha-2/3, NOT alpha-1) → non-sedating. Modulates 34 inflammation-related genes (immunomodulator profile), benzodiazepine-like mechanism without dependence.',
 pl: 'Heptapeptyd Thr-Lys-Pro-Arg-Pro-Gly-Pro, analog Tuftsiny TKPR z prolinową stabilizacją. Napięcie GABA-ergiczne + BDNF + serotonergiczne + enkefalinergiczne. Selektywne podjednostkowo GABA (alfa-2/3, NIE alfa-1) → bez sedacji. Moduluje 34 geny związane z zapaleniem (profil immunomodulatora), mechanizm podobny do benzodiazepin bez uzależnienia.',
 },
 legalStatus: {
 ...
 { hu: 'Diazepam-szintű GAD-hatékonyság függőség, szedáció, memória-károsodás nélkül', en: 'Diazepam-equivalent GAD efficacy without dependence, sedation, or memory impairment', pl: 'Skuteczność w GAD porównywalna z Diazepamem, bez uzależnienia, sedacji ani upośledzenia pamięci' },
 ],
 quickStart: [
 { hu: 'Intranazális 0.15%-os spray, 2-3 csepp nostrilonként (150-900 mcg/dózis)', en: 'Intranasal 0.15% spray, 2-3 drops per nostril (150-900 mcg/dose)', pl: 'Spray donosowy 0,15%, 2-3 krople na nozdrze (150-900 mcg/dawka)' },
 ...
 { title: 'Anxiolytic efficacy of Selank in patients with generalized anxiety disorder', authors: 'Zozulia AA et al.', journal: 'Eksp Klin Farmakol. 2008;71(2):24-29.', pmid: '18454096' },
 { title: 'Selank quality-of-life improvement in GAD vs Phenazepam', authors: 'Medvedev VE et al.', journal: 'Zh Nevrol Psikhiatr Im S S Korsakova. 2014;114(7):17-22.', pmid: '25176261' },
 ],
 faq: [
 ...
 { q: { hu: 'Mi a Tuftsin és miért fontos a természetes eredet?', en: 'What is Tuftsin and why does the natural origin matter?', pl: 'Czym jest Tuftsina i dlaczego naturalne pochodzenie ma znaczenie?' }, a: { hu: 'A Tuftsin (Thr-Lys-Pro-Arg) egy természetes immunmodulátor tetrapeptid, amely az IgG-immunoglobulin Fc-régiójának enzimatikus hasításakor szabadul fel. Fagocita-stimuláló és anti-bakteriális hatású. A Selank ennek prolin-stabilizált, BBB-átjáró analógja → megőrzi az immunmoduláló természetet, de hozzáad CNS-aktivitást.', en: 'Tuftsin (Thr-Lys-Pro-Arg) is a natural immunomodulator tetrapeptide released by enzymatic cleavage of the IgG immunoglobulin Fc region. It stimulates phagocytes and has antibacterial action. Selank is its proline-stabilized, BBB-crossing analog → preserves the immunomodulatory nature while adding CNS activity.', pl: 'Tuftsyna (Thr-Lys-Pro-Arg) to naturalny immunomodulujący tetrapeptyd uwalniany przez enzymatyczne cięcie regionu Fc immunoglobuliny IgG. Stymuluje fagocyty i działa przeciwbakteryjnie. Selank to jego stabilizowany prolinami, przekraczający BBB analog → zachowuje naturę immunomodulującą, dodając aktywność OUN.' } },
 ],
 ...
 mechanism: {
 hu: 'Béta-karbolin alkaloid származék, 9-pozícióban metilezve. Reverzibilis szelektív MAO-B gátlás + BDNF/GDNF expression-növelés (in vitro). Tirozin-hidroxiláz upreguláció (dopamin-szintézis). Dopaminerg neuron-differenciáció + dendrit-növekedés (dentate gyrus). Anti-inflammációs (csökkenti a citokin-expressziót dopaminerg neuronokban). Dopaminerg neuron-protekció állat-modellekben (Parkinson-kutatás).',
 en: 'Beta-carboline alkaloid derivative, methylated at position 9. Reversible selective MAO-B inhibition + BDNF/GDNF expression elevation (in vitro). Tyrosine hydroxylase upregulation (dopamine synthesis). Dopaminergic neuron differentiation + dendritic outgrowth (dentate gyrus). Anti-inflammatory (reduces cytokine expression in dopaminergic neurons). Dopaminergic neuron protection in animal models (Parkinson research).',
 pl: 'Pochodna alkaloidu beta-karbolinowego, metylowana w pozycji 9. Odwracalne selektywne hamowanie MAO-B + podniesienie ekspresji BDNF/GDNF (in vitro). Podniesienie hydroksylazy tyrozynowej (synteza dopaminy). Różnicowanie neuronów dopaminergicznych + wzrost dendrytów (zakręt zębaty). Przeciwzapalne (zmniejsza ekspresję cytokin w neuronach dopaminergicznych). Ochrona neuronów dopaminergicznych w modelach zwierzęcych (badania Parkinsona).',
 },
 legalStatus: {
 ...
 interactionsWith: ['MAOI', 'SSRI', 'tyramine-rich foods', 'stimulants', 'l-tyrosine', 'uv-sunlight'],
 wadaStatus: null,
 benefits: [
 ...
 { hu: 'Stimuláns-rezenzitizáció ("dopamin detox"): hosszú stim-használat után dopaminerg neuron-helyreállítás', en: 'Stimulant resensitization ("dopamine detox"): dopaminergic neuron restoration after long-term stim use', pl: 'Resensytyzacja stymulantów ("detoks dopaminowy"): przywracanie neuronów dopaminergicznych po długim stosowaniu stymulantów' },
 ],
 quickStart: [
 ...
 { hu: 'Sublingual (nyelv alá, 10-15 perc) erősebb hatás mint orális', en: 'Sublingual (under tongue, 10-15 min) gives stronger effect than oral', pl: 'Podjęzykowo (pod językiem, 10-15 min) daje silniejszy efekt niż doustnie' },
 ...
 { hu: 'NAPFÉNY: fotoszenzitivitás-kockázat — kerüld a direkt UV-t kúra alatt', en: 'SUNLIGHT: photosensitivity risk — avoid direct UV during course', pl: 'ŚWIATŁO SŁONECZNE: ryzyko fotouczulenia — unikać bezpośredniego UV podczas kursu' },
 ...
 { hu: 'Fotoszenzitivitás (UV-érzékenység, napégés gyorsabban) — béta-karbolin váz tipikus interakciója UV-vel', en: 'Photosensitivity (UV sensitivity, easier sunburn) — typical β-carboline backbone × UV interaction', pl: 'Fotouczulenie (wrażliwość na UV, szybsze poparzenie słoneczne) — typowa interakcja β-karboliny × UV' },
 { hu: 'Hosszabb használat után emocionális "lapulás" (érzelmek tompulása) reportált', en: 'Emotional "flattening" reported after extended use', pl: 'Po dłuższym stosowaniu raportowane emocjonalne "spłaszczenie"' },
 ],
 avoid: [
 ...
 { hu: 'Stimulánsokkal additív (dopaminerg túlserkentés) — NE használj stimulánsokat 9-Me-BC kúra alatt; Bromantane lágy alternatíva', en: 'Additive with stimulants (dopaminergic over-stimulation) — do NOT use stimulants during 9-Me-BC course; Bromantane is a softer alternative', pl: 'Addytywny ze stymulantami (nadmierna stymulacja dopaminergiczna) — NIE stosować stymulantów podczas kursu 9-Me-BC; Bromantan to łagodniejsza alternatywa' },
 { hu: 'L-Tyrosine szinergista (raw substrate a megnövelt TH-aktivitáshoz)', en: 'L-Tyrosine synergistic (raw substrate for upregulated TH activity)', pl: 'L-Tyrozyna synergistyczna (surowy substrat dla podwyższonej aktywności TH)' },
 ],
 studies: [
 ...
 { title: '9-Methyl-β-carboline-induced cognitive enhancement, hippocampal dopamine, dendritic proliferation', authors: 'Polanski W, Reichmann H et al.', journal: 'J Neurochem. 2012;121(6):907-917.', pmid: '22380576' },
 { title: '9-Me-BC upregulates dopaminergic neuron differentiation in primary mesencephalic culture', authors: 'Hamann J et al.', journal: 'J Neural Transm. 2008;115(6):909-921.', pmid: '17913302' },
 { title: 'Beta-carbolines as endogenous phototoxic photosensitizers in skin', authors: 'Herraiz T et al.', journal: 'Photochem Photobiol. 2013;89(5):1116-1126.', pmid: '23842892' },
 ],
 faq: [
 ...
 { q: { hu: 'Miért fotoszenzitív (napégés-kockázat)?', en: 'Why photosensitive (sunburn risk)?', pl: 'Dlaczego światłoczułe (ryzyko poparzenia słonecznego)?' }, a: { hu: 'A béta-karbolin váz a bőrbe jutva UV-fényre reakciókat katalizál — endogén fotoszenzitizátor szerepet vesz fel (Herraiz 2013). Eredmény: napégés normál UV-expozíciónál is, lebarnulási kockázat hosszabb kúrákon. Védelem: széles spektrumú SPF 50+ + direkt napsütés-kerülés a kúra teljes ideje alatt + 5-7 nap utána.', en: 'The β-carboline backbone, once in the skin, catalyzes UV-light reactions — it acts as an endogenous photosensitizer (Herraiz 2013). Result: sunburn at normal UV exposure, pigmentation risk during longer courses. Protection: broad-spectrum SPF 50+ + avoid direct sun during the entire course + for 5-7 days after.', pl: 'Szkielet β-karbolinowy w skórze katalizuje reakcje pod światłem UV — działa jako endogenny fotosensybilizator (Herraiz 2013). Wynik: poparzenie słoneczne przy normalnym UV, ryzyko przebarwień przy dłuższych kursach. Ochrona: SPF 50+ szerokiego spektrum + unikać bezpośredniego słońca podczas całego kursu + 5-7 dni po nim.' } },
 { q: { hu: 'Stim-rezenzitizációs protokoll?', en: 'Stim resensitization protocol?', pl: 'Protokół resensytyzacji stymulantów?' }, a: { hu: 'Tipikus 4 hetes kúra Vyvanse/Adderall/Concerta hosszú-távú használata után: 9-Me-BC 1-5 mg/nap sublingualisan + L-Tyrosine 500-1000 mg + Bromantane 50 mg (opcionális, lágy stim-pótlék) + ABSZOLÚT NINCS stimuláns 9-Me-BC alatt. NALT és Uridine szinergistaként ajánlott. Eredmény: a hatás 9-10 nap után érzékelhető, a stimuláns "tisztábbnak" érződik a kúra után.', en: 'Typical 4-week course after long-term Vyvanse/Adderall/Concerta use: 9-Me-BC 1-5 mg/day sublingual + L-Tyrosine 500-1000 mg + Bromantane 50 mg (optional, soft stim-substitute) + ABSOLUTELY NO stimulant during 9-Me-BC. NALT and Uridine recommended as synergists. Effect: noticeable after 9-10 days, stimulant feels "cleaner" after the course.', pl: 'Typowy 4-tygodniowy kurs po długotrwałym stosowaniu Vyvanse/Adderall/Concerty: 9-Me-BC 1-5 mg/dzień podjęzykowo + L-Tyrozyna 500-1000 mg + Bromantan 50 mg (opcjonalnie) + ABSOLUTNIE BEZ stymulantów podczas 9-Me-BC. NALT i Urydyna jako synergistyki. Efekt: zauważalny po 9-10 dniach, stymulant "czystszy" po kursie.' } },
 ],
 ...
 description: {
 hu: 'Az Aniracetam a Piracetam zsíroldható pirrolidon-származéka, amely AMPA-receptor pozitív allosztérikus modulátorként (PAM) lassítja a deszenzitizációt és anxiolitikus mellékprofilt mutat. Olaszországban Ampamet és Memodrin néven vényköteles. Plazma felezési ideje rövid (~1-2.5 óra), de a metabolitjai (különösen a 2-pirrolidinon-acetamid és az N-anizoil-GABA) tovább hatnak — utóbbi GABA-erg interakció révén magyarázza a "részleges prodrug" jelleget (PMID 11834304, 11702095). Anti-szorongásos + pro-szociális reputáció szinte minden anekdotában.',
 ...
 description: {
 hu: 'Az Oxiracetam egy 4-hidroxi-piracetam származék, amelyet az Aniracetam relaxáló profiljával szemben általában stimuláns jellegűnek (mild) írnak le. Hatása AMPA-PAM és HACU (magas-affinitású kolin-felvétel) facilitáció kombinációja, indirekt mTOR-pathway interakcióval szinapszis-szintű strukturális megerősítést is sugall (PMID 6853072 PMC). Memória-konszolidáció, figyelem és reakcióidő javulása dokumentált krónikus szedéskor, jó tolerabilitással (PMID 2518332, 7749739). Demens rágcsáló-modellekben neuron-apoptózis-szabályozással kognitív deficiteket fordít vissza. Olaszországban Neuractiv és Neuromet néven volt forgalomban.',
 en: 'Oxiracetam is a 4-hydroxy derivative of Piracetam, generally described as mildly stimulant-like in contrast to Aniracetam`s relaxing profile. Its action combines AMPA-PAM with HACU (high-affinity choline uptake) facilitation, with indirect mTOR-pathway interaction also suggesting synaptic-level structural strengthening (PMID PMC6853072). Memory consolidation, attention, and reaction time improvements documented with chronic dosing and good tolerability (PMID 2518332, 7749739). In demented rodent models, reverses cognitive deficits via neuronal apoptosis regulation. It was marketed in Italy as Neuractiv and Neuromet.',
 pl: 'Oksyracetam to 4-hydroksy-pochodna piracetamu, ogólnie opisywana jako łagodnie stymulująca w przeciwieństwie do relaksującego profilu aniracetamu. Jego działanie łączy AMPA-PAM z ułatwianiem HACU (wysokopowinowactwego wychwytu choliny), z pośrednią interakcją szlaku mTOR sugerującą wzmocnienie strukturalne na poziomie synaps (PMID PMC6853072). Poprawa konsolidacji pamięci, uwagi i czasu reakcji udokumentowana przy przewlekłym dawkowaniu i dobrej tolerancji (PMID 2518332, 7749739). W modelach gryzoni z demencją odwraca deficyty poznawcze przez regulację apoptozy neuronów. Był sprzedawany we Włoszech jako Neuractiv i Neuromet.',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'A Coluracetam (BCI-540, korábbi neve MKC-231) a BrainCells Inc. fejlesztése volt, amely szelektíven aktiválja a magas-affinitású kolin-felvevő rendszert (HACU). Egyedülálló: a kognitív hatás 8 napig dokumentáltan fennmaradhat egyetlen adag után állat-modellekben (PMID 18461272). AF64A-károsított cholinerg neuronokban a hippocampális ACh-felszabadulás helyreáll (PMID 7710736). PCP-indukált ChAT-csökkenés visszafordítása medial septumban (PMID 17467960) → skizofréniás tünetek potenciális terápiája. Phase 2A MDD/anxiety klinikai vizsgálat (NCT00621270) BCI-540 néven; statisztikai szignifikancia nem ért el. Anekdotikus felhasználói leírások színérzékelés- és kontrasztfokozást ("HD vision") emlegetnek, ami az ACh sensory gating-szerepével magyarázható.',
 en: 'Coluracetam (BCI-540, formerly MKC-231) was developed by BrainCells Inc. to selectively activate the high-affinity choline uptake (HACU) system. Unique: cognitive effect can persist for 8 days after a single dose in animal models (PMID 18461272). In AF64A-damaged cholinergic neurons, hippocampal ACh release is restored (PMID 7710736). Reverses PCP-induced ChAT reduction in the medial septum (PMID 17467960) → potential therapy for schizophrenic symptoms. Phase 2A MDD/anxiety clinical trial (NCT00621270) under the BCI-540 name; did not reach statistical significance. Anecdotal user reports describe enhanced color perception and contrast ("HD vision"), explainable by ACh`s role in sensory gating.',
 pl: 'Koluracetam (BCI-540, dawniej MKC-231) został opracowany przez BrainCells Inc. w celu selektywnej aktywacji wysokopowinowactwego systemu wychwytu choliny (HACU). Wyjątkowo: efekt poznawczy może utrzymywać się 8 dni po jednorazowej dawce w modelach zwierzęcych (PMID 18461272). W neuronach cholinergicznych uszkodzonych AF64A przywraca uwalnianie ACh w hipokampie (PMID 7710736). Odwraca redukcję ChAT indukowaną PCP w przegrodzie środkowej (PMID 17467960) → potencjalna terapia objawów schizofrenicznych. Badanie fazy 2A MDD/lęk (NCT00621270) pod nazwą BCI-540; nie osiągnęło istotności statystycznej. Anegdotyczne raporty opisują wzmożone postrzeganie kolorów i kontrastu ("HD vision"), co tłumaczy rola ACh w sensorycznym gatingu.',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'A Fasoracetam (NS-105 / LAM-105 / NFC-1) eredeti japán Nippon Shinyaku fejlesztés, amely a metabotrop glutamát-receptorok (mGluR I/II/III) up-regulációján keresztül hat. Aevi Medical (volt Medgenics) Phase 2/3 vizsgálatba vitte ADHD-ban (mGluR-mutáció-pozitív adolescensek) — kezdetben pozitív, 2019-es bővített ADHD-vizsgálatban mixed eredmények (PMID 31167583). Egyedülálló: GABA-B receptor expression-növelő (PMID 10494996) — anekdotikusan Phenibut-megvonás támogatására használják. Cholinerg HACU-fokozás (Coluracetam-szerű, de gyengébb). cAMP→BDNF szignalizációs cascade memóriaképzéshez. UK-ban a Psychoactive Substances Act tiltja (2016 óta).',
 en: 'Fasoracetam (NS-105 / LAM-105 / NFC-1) is originally a Nippon Shinyaku (Japan) development that acts via up-regulation of metabotropic glutamate receptors (mGluR I/II/III). Aevi Medical (formerly Medgenics) advanced it to Phase 2/3 in ADHD (mGluR-mutation-positive adolescents) — initially positive, then mixed results in the 2019 expanded ADHD trial (PMID 31167583). Unique: upregulates GABA-B receptor expression (PMID 10494996) — anecdotally used to support Phenibut withdrawal. Cholinergic HACU enhancement (Coluracetam-like but weaker). cAMP→BDNF signaling cascade for memory formation. Banned in the UK under the Psychoactive Substances Act (since 2016).',
 pl: 'Fasoracetam (NS-105 / LAM-105 / NFC-1) to pierwotnie japoński (Nippon Shinyaku) lek działający poprzez regulację w górę metabotropowych receptorów glutaminianu (mGluR I/II/III). Aevi Medical (dawniej Medgenics) doprowadził go do fazy 2/3 w ADHD (nastolatkowie z mutacją mGluR) — początkowo pozytywne, mieszane wyniki w rozszerzonym badaniu ADHD 2019 (PMID 31167583). Wyjątkowo: zwiększa ekspresję receptora GABA-B (PMID 10494996) — anegdotycznie stosowany do wsparcia odstawienia Phenibutu. Cholinergiczne wzmocnienie HACU (podobne do Koluracetamu, ale słabsze). Kaskada cAMP→BDNF dla tworzenia pamięci. Zakazany w Wielkiej Brytanii na mocy Psychoactive Substances Act (od 2016).',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'A Nefiracetam (DM-9384) Daiichi Pharmaceutical-fejlesztés, amely a Piracetam-vázra épülő dimetil-fenil-acetil származék. Több ponton hat: nicotinic + muscarinic ACh receptor pozitív moduláció (PMID 10869513), NMDA receptor glycine-site moduláció (PMID 17095583), L- és N-típusú feszültség-függő Ca²⁺-csatornák tartós nyitása (PMID 10850736), PKA/PKC szignalizációs cascade amplifikáció (PMID 9443926). A Ca²⁺-csatorna-moduláció az elsődleges anti-amnesztikus mechanizmus. Anti-excitotoxikus profil (glutamát-indukált neuron-károsodás elleni védelem). Japánban Phase 3 vizsgálatok (post-stroke apátia, Alzheimer); az NIH USA Phase 2 Alzheimer-vizsgálatát hímnemű hepatotoxicitás-szignál miatt leállították.',
 en: 'Nefiracetam (DM-9384) is a Daiichi Pharmaceutical development built on the Piracetam scaffold with a dimethyl-phenyl-acetyl substituent. It acts at several sites: nicotinic + muscarinic ACh receptor positive modulation (PMID 10869513), NMDA receptor glycine-site modulation (PMID 17095583), sustained opening of L- and N-type voltage-gated Ca²⁺ channels (PMID 10850736), and PKA/PKC signaling cascade amplification (PMID 9443926). Ca²⁺-channel modulation is the primary anti-amnestic mechanism. Anti-excitotoxic profile (protects neurons from glutamate-induced damage). Phase 3 trials (post-stroke apathy, Alzheimer`s) ran in Japan; the NIH USA Phase 2 Alzheimer`s trial was halted over a male-hepatotoxicity signal.',
 pl: 'Nefiracetam (DM-9384) to lek firmy Daiichi Pharmaceutical, oparty na szkielecie piracetamu z podstawnikiem dimetylo-fenylo-acetylowym. Działa w kilku miejscach: pozytywna modulacja receptorów nikotynowych + muskarynowych ACh (PMID 10869513), modulacja miejsca glicynowego receptora NMDA (PMID 17095583), przedłużone otwieranie kanałów Ca²⁺ typu L i N (PMID 10850736), amplifikacja kaskady PKA/PKC (PMID 9443926). Modulacja kanałów Ca²⁺ to główny mechanizm przeciwamnezyjny. Profil przeciwekscitotoksyczny (chroni neurony przed uszkodzeniem indukowanym glutaminianem). Badania fazy 3 (apatia po udarze, Alzheimer) prowadzono w Japonii; faza 2 NIH USA Alzheimer została wstrzymana z powodu sygnału hepatotoksyczności u mężczyzn.',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'Az Armodafinil a Modafinil tisztított R-(−)-enantiomerje (PMID 18076219), Cephalon (most Teva) fejlesztés, FDA-jóváhagyott narcolepsia, OSA és műszak-munka alvászavar (SWSD) indikációkban Nuvigil márkanéven. Felezési ideje ~12-15 óra (PMID 19663523) laposabb vér-plazma görbével, ezért egy adag tipikusan 12-14 órás eugeroikus hatást ad. Klinikai vizsgálatokban ADHD-szerű tünetekben is hatékonynak bizonyult (Eureka Select trial-adat). Narkolepsziára biztonságos és hatékony (PMID 16684437). Mechanizmus: DAT-gátlás + orexin/hisztamin út indirekt aktiválás, Glu-tónus emelés, GABA-aktivitás modulálás. Modafinilhez képest a "crash" érzés enyhébb, a fókusz lineárisabb és tartósabb.',
 en: 'Armodafinil is the purified R-(−)-enantiomer of Modafinil (PMID 18076219), developed by Cephalon (now Teva) and FDA-approved for narcolepsy, OSA and shift-work sleep disorder (SWSD) under the brand name Nuvigil. Its half-life is ~12-15 h (PMID 19663523) with a flatter plasma curve, a single dose typically gives 12-14 h of eugeroic action. Clinical trials also show efficacy for ADHD-like symptoms. Safe and effective for narcolepsy (PMID 16684437). Mechanism: DAT inhibition + indirect orexin/histamine pathway activation, glutamate-tone elevation, GABA-activity modulation. The "crash" sensation is milder than Modafinil`s, focus is more linear and sustained.',
 pl: 'Armodafinil to oczyszczony R-(−)-enancjomer modafinilu (PMID 18076219), opracowany przez Cephalon (obecnie Teva) i zatwierdzony przez FDA w narkolepsji, OBS i zaburzeniach snu związanych z pracą zmianową (SWSD) pod nazwą Nuvigil. Okres półtrwania wynosi ~12-15 h (PMID 19663523) z bardziej płaską krzywą osoczową, pojedyncza dawka zazwyczaj daje 12-14 h działania eugerokicznego. Badania kliniczne wykazują również skuteczność w objawach ADHD. Bezpieczny i skuteczny w narkolepsji (PMID 16684437). Mechanizm: hamowanie DAT + pośrednia aktywacja szlaku oreksyny/histaminy, podniesienie napięcia glutaminergicznego, modulacja aktywności GABA. Uczucie "crashu" jest łagodniejsze niż w przypadku modafinilu, koncentracja bardziej liniowa i trwała.',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'A Fladrafinil (CRL-40,941) az Adrafinil bisz-fluor-helyettesített származéka, eredeti francia Lafon-fejlesztés (PMID 27928893). Eugeroikus aktivitása az Adrafinilhez hasonló, **3-4× nagyobb potencitással** és kb. **12-16 órás hatástartammal**. Mechanizmus: máj-konverzió Modafinil-szerű aktív metabolittá → DAT-gátlás + orexin/hisztamin moduláció. Állat-modellekben kifejezett agresszió-csökkentést is leírtak (US Patent 4489095). A fluor-szubsztitúció lassítja a máj-metabolizmust → hosszabb hatás, de fokozott hepatotoxicitás-kockázat krónikus szedéskor (LFT-monitorozás). UK-ban a Psychoactive Substances Act tiltja (2016 óta). Humán klinikai vizsgálat nincs, sehol nem jóváhagyott.',
 en: 'Fladrafinil (CRL-40,941) is a bis-fluorinated derivative of Adrafinil, originally developed by Lafon (France) (PMID 27928893). Its eugeroic activity is similar to Adrafinil`s but **3-4× more potent** with a **12-16 h duration**. Mechanism: hepatic conversion to a Modafinil-like active metabolite → DAT inhibition + orexin/histamine modulation. Animal models also describe a pronounced aggression reduction (US Patent 4489095). The fluorine substitution slows hepatic metabolism → longer effect but elevated hepatotoxicity risk with chronic dosing (LFT monitoring). Banned in the UK under the Psychoactive Substances Act (since 2016). No human clinical trials; not approved anywhere.',
 pl: 'Fladrafinil (CRL-40,941) to bis-fluorowana pochodna adrafinilu, pierwotnie opracowana przez Lafon (Francja) (PMID 27928893). Jego aktywność eugerokichna jest podobna do adrafinilu, ale **3-4× silniejsza** z **czasem trwania 12-16 h**. Mechanizm: konwersja wątrobowa do aktywnego metabolitu podobnego do modafinilu → hamowanie DAT + modulacja oreksyny/histaminy. Modele zwierzęce opisują wyraźne zmniejszenie agresji (Patent US 4489095). Podstawienie fluoru spowalnia metabolizm wątrobowy → dłuższy efekt, ale podwyższone ryzyko hepatotoksyczności przy przewlekłym dawkowaniu (monitorowanie LFT). Zakazany w Wielkiej Brytanii na mocy Psychoactive Substances Act (od 2016). Brak badań klinicznych u ludzi; nigdzie nie zatwierdzony.',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'Az Alpha-GPC (L-α-glicerilfoszforilkolin) természetes foszfolipid-metabolit, amelyet a szervezet acetilkolinná és foszfatidilkolinná épít be. Vér-agy gáton áthatol, biológiailag hasznosulása ~95%. Akut hatású kolin-forrás — gyorsan emeli a CNS-acetilkolin-szintet, ezért a "feelhető" cholinerg formák közé tartozik (vs. CDP-Choline, ami inkább hosszú távú támogatás). **Pre-workout mind-muscle erősítés** dokumentált hatása (PMID PMC4595381) — sok preworkout-formula tartalmazza. Foszfolipid-szintézis támogatás sejt-membrán szinten (PMID 8190709). Magas dózisnál cholinerg túltelítettség (fejfájás, brain fog, anxietás) → Magnézium L-Threonate enyhítheti. Olaszországban Delecit néven vényköteles gyógyszer (vaszkuláris demencia), másutt étrend-kiegészítő.',
 en: 'Alpha-GPC (L-α-glycerylphosphorylcholine) is a natural phospholipid metabolite that the body incorporates into acetylcholine and phosphatidylcholine. It crosses the blood-brain barrier with ~95% bioavailability. An acute-acting choline source — quickly raises CNS acetylcholine, hence among the "feelable" choline forms (vs. CDP-Choline which supports long-term baseline). **Pre-workout mind-muscle benefit** documented (PMID PMC4595381) — included in many pre-workout formulas. Supports phospholipid synthesis at the membrane level (PMID 8190709). At high doses, cholinergic overload (headache, brain fog, anxiety) → Magnesium L-Threonate can mitigate. Prescription medicine in Italy (Delecit, for vascular dementia) and a supplement elsewhere.',
 pl: 'Alfa-GPC (L-α-glicerylofosforylocholina) to naturalny metabolit fosfolipidowy, który organizm wbudowuje w acetylocholinę i fosfatydylocholinę. Przenika barierę krew-mózg z biodostępnością ~95%. Ostro działające źródło choliny — szybko podnosi poziom acetylocholiny w OUN, więc należy do "odczuwalnych" form choliny (vs. CDP-Cholina, która wspiera długoterminowy poziom). **Korzyść pre-workout dla połączenia umysł-mięsień** udokumentowana (PMID PMC4595381) — zawarta w wielu formułach pre-workout. Wspiera syntezę fosfolipidów na poziomie błony (PMID 8190709). Przy wysokich dawkach przeciążenie cholinergiczne (ból głowy, brain fog, lęk) → Magnez L-Treonian może łagodzić. Lek na receptę we Włoszech (Delecit, w otępieniu naczyniowym), suplement gdzie indziej.',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'A CDP-Cholin (Citicolin, INN) természetes nukleotid-foszfolipid intermedier, amely a Kennedy-úton vesz részt a foszfatidilkolin-szintézisben. Belekben citidinre + kolinra hidrolizál (PMID 10974208); a citidin uridinné alakul, így az agyban két nootropikusan releváns molekulát is biztosít — a kolin acetilkolin-szintézis prekurzora (PMID 21703569), az uridin pedig UTP-szintézist és **szinaptogenezist** támogat. **Orális bioelérhetőség ~90%, vízoldékony** (PMID 7477743). Fokozza a foszfatidilkolin-szintézist (PMID 11796739) → erősebb neuronális membránok. Dopamin-szignalizációt és potenciálisan dopamin-receptor sűrűséget is moduláló — motivációs hatás hosszú távon. Racetamokhoz/stimulánsokhoz társítva megelőzheti a cholin-depletion-szerű "burnout"-érzést. Olaszországban Somazina, EU-szerte vényköteles agyi ischaemia indikációkban; USA-ban OTC.',
 ...
 pl: 'CDP-Cholina (Cytykolina, INN) to naturalny pośrednik nukleotydowo-fosfolipidowy uczestniczący w syntezie fosfatydylocholiny szlakiem Kennedy`ego. W jelitach hydrolizuje do cytydyny + choliny (PMID 10974208); cytydyna jest przekształcana w urydynę, dostarczając do mózgu dwóch nootropowo istotnych cząsteczek — cholinę jako prekursor syntezy acetylocholiny (PMID 21703569), urydynę wspierającą syntezę UTP i **synaptogenezę**. **Biodostępność doustna ~90%, rozpuszczalny w wodzie** (PMID 7477743). Zwiększa produkcję fosfatydylocholiny (PMID 11796739) → silniejsze błony neuronalne. Moduluje sygnalizację dopaminową i potencjalnie gęstość receptorów dopaminowych — długoterminowa korzyść motywacyjna. W połączeniu z racetamami/stymulantami może zapobiegać uczuciu "wypalenia" z deplecji choliny. Na receptę we Włoszech (Somazina) i w innych krajach UE w niedokrwieniu mózgowym; OTC w USA.',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'A Centrophenoxin (meclofenoxát, Lucidril) francia eredetű gyógyszer (Anjou), amely DMAE-t (dimetilaminoetanol) p-klór-fenoxi-ecetsavhoz észterezve juttat a központi idegrendszerbe. Klasszikus „anti-aging" nootropikum: idős egér T-maze tanulási teljesítményt javít 3 hónap alatt, és csökkenti a kérgi + hippocampális lipofuszcin-pigment akkumulációt (PMID 342588). Retinális pigment-hámban is hatékony a lipofuszcin csökkentésére (PMID 6410295). In vitro membrán-fluidizáló (mind szinaptikus mind máj-mikroszomális; PMID 3023777). Anti-oxidatív enzimek (kataláz, SOD, glutation-reduktáz) emelkedése idős patkány-agyban (PMID 16137852). **FDA-nem-jóváhagyott USA-ban**, mégis 7-ből 7 vizsgált étrend-kiegészítő tartalmazta (79-251 mg/serving) — fogyasztói védelmi aggály (PMID 35959800). EU egyes országaiban (HU, PL, CZ) vényköteles (Lucidril).',
 ...
 pl: 'Centrofenoksyna (meklofenoksat, Lucidril) to lek pochodzenia francuskiego (Anjou), dostarczający DMAE (dimetyloaminoetanol) do OUN jako ester kwasu p-chlorofenoksyoctowego. Klasyczny nootropik „anti-aging": poprawia uczenie w teście T-labiryntu u starych myszy w ciągu 3 miesięcy i zmniejsza akumulację lipofuscyny w korze + hipokampie (PMID 342588). Skuteczny również w zmniejszaniu lipofuscyny w nabłonku barwnikowym siatkówki (PMID 6410295). In vitro fluidyzator błony (zarówno synaptycznej, jak i mikrosomalnej wątroby; PMID 3023777). Wzrost enzymów przeciwutleniających (katalaza, SOD, reduktaza glutationu) w mózgu starych szczurów (PMID 16137852). **Niezatwierdzona przez FDA w USA**, jednak 7 z 7 badanych suplementów diety ją zawierało (79-251 mg/porcja) — kwestia ochrony konsumenta (PMID 35959800). Na receptę w niektórych krajach UE (HU, PL, CZ) jako Lucidril.',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'A Huperzin-A egy alkaloid, amelyet a Huperzia serrata mohából izoláltak. Erős, reverzibilis és szelektív acetilkolinészteráz (AChE) inhibitor — **szelektívebb mint a Donepezil** —, az enzim gátlásával prolongálja az acetilkolin-jelet a szinaptikus résben. Alzheimer-kórban klinikailag bizonyítottan javít kognitív funkciót (meta-analízis PMID 33851462, rodent meta PMID 36499562). Wnt-szignalizáció, amyloid-β akkumuláció és szinaptikus pályák moduláción keresztül neuroprotekciót biztosít (PMID 34770940). Anekdotikusan **élénk álmodás / lucid dream** indukció (a közösségi reportokban a leggyakoribb mellékhatás). **Hosszú felezési idő (~10-14h) miatt cycling kötelező** — 2-4 hét on / 2-4 hét off, különben tartós AChE-szupresszió kolinerg túlserkentéshez vezet. Kínában gyógyszerként Alzheimer-kórban használják; Nyugaton étrend-kiegészítőként árusítják.',
 en: 'Huperzine-A is an alkaloid isolated from the moss Huperzia serrata. It is a potent, reversible and selective acetylcholinesterase (AChE) inhibitor — **more selective than Donepezil** — gating prolongs acetylcholine signaling in the synaptic cleft. Clinically improves cognitive function in Alzheimer`s disease (meta-analysis PMID 33851462; rodent meta PMID 36499562). Provides neuroprotection via Wnt signaling, amyloid-β accumulation, and synaptic pathway modulation (PMID 34770940). Anecdotally induces **vivid / lucid dreaming** (the most common community-reported side effect). **Long half-life (~10-14h) makes cycling mandatory** — 2-4 weeks on / 2-4 weeks off, otherwise sustained AChE suppression causes cholinergic overload. Used as a drug in China for Alzheimer`s disease; sold as a dietary supplement in the West.',
 pl: 'Huperzyna-A to alkaloid wyizolowany z mchu Huperzia serrata. Jest silnym, odwracalnym i selektywnym inhibitorem acetylocholinesterazy (AChE) — **bardziej selektywnym niż Donepezil** — przedłuża sygnał acetylocholiny w szczelinie synaptycznej. Klinicznie poprawia funkcje poznawcze w Alzheimerze (metaanaliza PMID 33851462; metaanaliza gryzoni PMID 36499562). Zapewnia neuroprotekcję przez sygnalizację Wnt, akumulację amyloidu-β i modulację szlaków synaptycznych (PMID 34770940). Anegdotycznie indukuje **żywe / lucydne sny** (najczęstszy zgłaszany efekt uboczny). **Długi okres półtrwania (~10-14h) sprawia, że cykliczność jest obowiązkowa** — 2-4 tygodnie on / 2-4 tygodnie off, w przeciwnym razie utrzymujące się hamowanie AChE prowadzi do przeciążenia cholinergicznego. Stosowana jako lek w Chinach w chorobie Alzheimera; sprzedawana jako suplement diety na Zachodzie.',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'A Selegilin (L-deprenil) magyar Knoll József professzor fejlesztése (1960-as évek), szelektív és irreverzibilis MAO-B inhibitor. FDA-jóváhagyott Parkinson-kórban (orális, Eldepryl/Zelapar) és major depresszióban (transzdermális Emsam tapasz). Alacsony dózisban (<10 mg/nap) a szelektivitás megmarad, magasabb dózisokon MAO-A-t is gátol → tiraminreakció kockázata nő. **Az Emsam transzdermális tapasz előnye**: megkerüli a gut-MAO-t, így a 6 mg/24h-s dózis biztonságos tiramin-restrict diéta nélkül (FDA-jóváhagyás MDD-re ezen az alapon). Az aktív metabolitok (l-amfetamin + l-metamfetamin) farmakológiailag jelen vannak, de alacsony dózisban a kognitív tisztaság megmarad. **Antiapoptotikus + NGF-szerű neuroprotektív hatás** a nigrostriatális dopaminerg neuronokon — Knoll eredeti hipotézise. DATATOP klinikai vizsgálat Parkinson-progresszió-lassítást mutatott.',
 ...
 pl: 'Selegilina (L-deprenyl) to opracowanie węgierskiego prof. Józsefa Knolla (lata 60.), selektywny i nieodwracalny inhibitor MAO-B. Zatwierdzony przez FDA w chorobie Parkinsona (doustnie, Eldepryl/Zelapar) i dużej depresji (plaster transdermalny Emsam). Przy niskich dawkach (<10 mg/dobę) selektywność jest zachowana; wyższe dawki hamują również MAO-A → wzrasta ryzyko reakcji tyraminowej. **Zaleta plastra transdermalnego Emsam**: omija MAO jelitową, więc dawka 6 mg/24h jest bezpieczna bez diety ograniczającej tyraminę (zatwierdzenie FDA dla MDD na tej podstawie). Aktywne metabolity (l-amfetamina + l-metamfetamina) są obecne farmakologicznie, ale przy niskich dawkach jasność poznawcza jest zachowana. **Działanie antyapoptotyczne + neuroprotekcyjne podobne do NGF** na neuronach dopaminergicznych nigrostriatalnych — pierwotna hipoteza Knolla. Badanie kliniczne DATATOP wykazało spowolnienie progresji Parkinsona.',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'A PRL-8-53 (methyl-3-(2-(benzyl(methyl)amino)ethyl)benzoate) 1972-es szabadalom (Dr. Nikolaus Hansl, Creighton University). Egyetlen 1978-as kettősvak placebókontrollált humán vizsgálatban (n=47, Hansl & Mehler, PMID 418433) statisztikailag szignifikáns verbális memóriajavulást, hosszú- és rövid-távú recall fokozást, valamint motoros vezérlés mérsékelt javulását írtak le; idősebb és kezdetben gyengén teljesítő alanyoknál erősebb hatással. Anekdotikusan nyelvtanulásra és vokabulár-megtartásra is használt. Mechanizmus: cholinerg jel-fokozás + dopamin-potencírozás + enyhe szerotonin-gátlás (szabadalom-leírás). **Magas dózisokon görcsös konvulzív hatás, szorongás, álmatlanság jelenthető**. Azóta nincs követő vizsgálat → adatbázis vékony.',
 ...
 pl: 'PRL-8-53 (metylo-3-(2-(benzylo(metylo)amino)etylo)benzoesan) opatentowano w 1972 r. (dr Nikolaus Hansl, Creighton University). Pojedyncze badanie z 1978 r. z podwójnie ślepą próbą i placebo (n=47, Hansl & Mehler, PMID 418433) opisało statystycznie istotną poprawę pamięci werbalnej, wzmocnienie odzyskiwania długo- i krótkoterminowego oraz umiarkowane korzyści w kontroli motorycznej; efekty silniejsze u starszych i początkowo słabo wypadających osób. Anegdotycznie stosowany również do nauki języków i zachowania słownictwa. Mechanizm: wzmocnienie sygnału cholinergicznego + potencjacja dopaminy + łagodne hamowanie serotoniny (z oryginalnego patentu). **Wysokie dawki mogą wywoływać efekty drgawkowe, lęk, bezsenność**. Od tego czasu brak badań kontynuacyjnych → cienka baza danych.',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'A Phenibut (β-fenil-γ-amino-vajsav) szovjet űrkutatási fejlesztés (1960-as évek), olyan anxiolitikum, amely a GABA-tól eltérően áthatol a vér-agy gáton. Hatásmechanizmus: GABA-B receptor agonista (Baclofenhez hasonlóan; PMC6494145), α2δ-1 feszültség-függő Ca²⁺-csatorna moduláció (Pregabalinhez hasonlóan), striatum dopamin-emelés (állat-modellekben), és **PEA-antagonizmus** (feniletilamin-csökkentés további anxiolitikus szállal). Az **(R)-enantiomer** a fő aktív isomer. Oroszországban gyógyszerként (Anvifen, Noofen) használt; UK-ban 2024 óta **Class C kontrollált**; Európa és USA többi részén nem jóváhagyott. ⚠️ **Erős tolerancia 2-3 napi szedés után + súlyos fizikai függőség** — a megvonás benzodiazepin-megvonásra emlékeztet (delirium, görcsök, rebound szorongás), klinikailag kezelést igénylő szindróma. Max heti 2× alkalmi használat ajánlott.',
 en: 'Phenibut (β-phenyl-γ-aminobutyric acid) is a Soviet space-program development (1960s), an anxiolytic that, unlike GABA itself, crosses the blood-brain barrier. Mechanism: GABA-B receptor agonist (similar to Baclofen; PMC6494145), α2δ-1 voltage-gated Ca²⁺ channel modulation (similar to Pregabalin), striatal dopamine elevation (animal models), and **PEA antagonism** (phenethylamine reduction adds an anxiolytic arm). The **(R)-enantiomer** is the principal active isomer. Used as a medicine in Russia (Anvifen, Noofen); a **UK Class C controlled substance since 2024**; not approved elsewhere in Europe or the USA. ⚠️ **Strong tolerance after 2-3 days of daily dosing + severe physical dependence** — withdrawal resembles benzodiazepine withdrawal (delirium, seizures, rebound anxiety), a clinically treatment-requiring syndrome. Max 2× weekly occasional use recommended.',
 pl: 'Fenibut (β-fenylo-kwas γ-aminomasłowy) to opracowanie radzieckiego programu kosmicznego (lata 60.), lek anksjolityczny, który w przeciwieństwie do samego GABA przenika barierę krew-mózg. Mechanizm: agonista receptora GABA-B (podobnie do baklofenu; PMC6494145), modulacja podjednostki α2δ-1 kanałów Ca²⁺ zależnych od napięcia (podobnie do pregabaliny), podniesienie dopaminy w prążkowiu (modele zwierzęce) i **antagonizm PEA** (redukcja feniloetyloaminy daje dodatkową gałąź anksjolityczną). **(R)-enancjomer** to główny izomer aktywny. Stosowany jako lek w Rosji (Anvifen, Noofen); **substancja kontrolowana UK Class C od 2024**; niezatwierdzony w pozostałej części Europy ani USA. ⚠️ **Silna tolerancja po 2-3 dniach codziennego dawkowania + ciężkie fizyczne uzależnienie** — odstawienie przypomina odstawienie benzodiazepin (delirium, drgawki, odbicie lęku), zespół wymagający leczenia klinicznego. Zalecane maks. 2× tygodniowo okazjonalne stosowanie.',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'A Tianeptin (Coaxil, Stablon) francia eredetű (Servier, 1989) atípusos antidepresszáns. Eredeti SSRE-elméletét (szerotonin-felvétel-fokozó) felülvizsgálta a 2014-es Gassaway et al. munka (PMID 25049078), amely **μ-opioid receptor (MOR) parciális agonista** profilt írt le terápiás dózisokon (EC50 ~194 nM) + alacsonyabb δ-opioid affinitást. Klinikailag releváns dózisokon (12.5-37.5 mg/nap) antidepresszáns hatás dominál minimális euforia mellett, de magas dózisokon (>50 mg) klasszikus opioid-szerű mellékhatások, **opioid-toleranciát és függőséget okoz**. **Glutamáterg moduláció**: stressz-indukált hippocampális glutamát-túltermelés gátlása + BDNF up-reguláció → strukturális antidepresszáns hatás. USA-ban OTC tilos (több államban kontrollált anyag — "gas station heroin" abúzus járvány), EU-ban szigorúan vényköteles (Magyarországon is).',
 ...
 pl: 'Tianeptyna (Coaxil, Stablon) to francuski (Servier, 1989) nietypowy lek przeciwdepresyjny. Pierwotna teoria SSRE (wzmacniacz wychwytu serotoniny) została zrewidowana w pracy Gassaway et al. z 2014 (PMID 25049078), która opisała **profil częściowego agonisty receptora μ-opioidowego (MOR)** przy dawkach terapeutycznych (EC50 ~194 nM) + niższe powinowactwo δ-opioidowe. Przy klinicznie istotnych dawkach (12,5-37,5 mg/dobę) dominuje efekt przeciwdepresyjny z minimalną euforią, ale przy wysokich dawkach (>50 mg) pojawiają się klasyczne opioidopodobne skutki uboczne, **powodując tolerancję i uzależnienie opioidowe**. **Modulacja glutaminergiczna**: hamuje indukowaną stresem nadprodukcję glutaminianu w hipokampie + regulację w górę BDNF → strukturalny efekt przeciwdepresyjny. Zakazana w sprzedaży OTC w USA (substancja kontrolowana w kilku stanach — epidemia nadużyć "gas station heroin"), ściśle na receptę w UE (włącznie z Węgrami).',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'A Fluorofenibut a Phenibut fenil-gyűrűjének para-fluoro szubsztitúciójával előállított nem-hivatalos analóg. A megnövelt lipofilitás miatt gyorsabban hatol a vér-agy gáton és **kb. 3-5×-szel nagyobb in vivo potencitást** mutat (megfelelően 200-400 mg helyett ~50-100 mg aktív dózis), viszont ezzel arányosan **magasabb tolerancia- és függőség-kockázat**. Klinikai vizsgálat egyáltalán nincs, csak a Phenibut farmakológiájából extrapolálható biztonsági profil. ⚠️ A megvonási szindróma a Phenibut-megvonásnál is súlyosabb lehet → ER-szintű kezelést igénylő esetek dokumentáltak. USA-ban Alabama és Michigan **Schedule II-kontrollált**; UK-ban a Psychoactive Substances Act tiltja. EU egyéb tagállamokban szürke jogi zóna, „research chemical" minősítéssel árusítják.',
 en: 'Fluorophenibut is an unofficial analog produced by para-fluoro substitution on the phenyl ring of Phenibut. Increased lipophilicity yields faster blood-brain-barrier penetration and **roughly 3-5× higher in vivo potency** (correspondingly ~50-100 mg active dose instead of 200-400 mg), but proportionally **higher tolerance and dependence risk**. No clinical trials exist, only a safety profile extrapolated from Phenibut`s pharmacology. ⚠️ The withdrawal syndrome can be more severe than Phenibut withdrawal → ER-level treatment cases documented. **Schedule II controlled in Alabama and Michigan (USA)**; banned in the UK under the Psychoactive Substances Act. Legal grey zone in other EU member states, sold as a "research chemical".',
 pl: 'Fluorofenibut to nieoficjalny analog uzyskany przez podstawienie para-fluoro w pierścieniu fenylowym fenibutu. Zwiększona lipofilność daje szybsze przenikanie bariery krew-mózg i **około 3-5× wyższą potencję in vivo** (odpowiednio ~50-100 mg dawki aktywnej zamiast 200-400 mg), ale proporcjonalnie **wyższe ryzyko tolerancji i uzależnienia**. Brak badań klinicznych, jedynie profil bezpieczeństwa ekstrapolowany z farmakologii fenibutu. ⚠️ Zespół odstawienia może być cięższy niż przy fenibucie → udokumentowane przypadki wymagające leczenia na poziomie ER. **Substancja kontrolowana Schedule II w Alabamie i Michigan (USA)**; zakazany w Wielkiej Brytanii na mocy Psychoactive Substances Act. Prawna szara strefa w innych państwach UE, sprzedawany jako „chemikalium badawcze".',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'A Picamilon (Pikatropin) szovjet fejlesztés (1969, All-Union Vitamin Research Institute), amelyben a nikotinsav (B3-vitamin) GABA-val van amid-kötéssel összekapcsolva. A nikotinsav-rész **cerebrális vazodilatációt** okoz, segíti az agyi vérátáramlást, miközben a vér-agy gát átlépése után a konjugátum hidrolizál → **GABA + nikotinsav** szabadul fel. A GABA-A és GABA-B mérsékelt aktivációja anxiolitikus és enyhe szedatív hatást ad, függőség-kockázat lényegesen alacsonyabb mint Phenibutnál (rövidebb felezési idő ~0.5 óra, gyors clearance). Klinikailag Oroszországban migrén, vaszkuláris kognitív zavar, és asztheniás szindróma indikációkban használt. **USA-ban az FDA 2015-ben kivonta** azzal az indoklással, hogy nem felel meg a dietary supplement definíciónak (szintetikus drog).',
 ...
 pl: 'Pikamilon (Pikatropin) to opracowanie radzieckie (1969, All-Union Vitamin Research Institute), w którym kwas nikotynowy (witamina B3) jest połączony z GABA wiązaniem amidowym. Reszta kwasu nikotynowego **powoduje rozszerzenie naczyń mózgowych**, wspierając przepływ krwi w mózgu; po przekroczeniu BBB koniugat hydrolizuje → uwalniane są **GABA + kwas nikotynowy**. Umiarkowana aktywacja GABA-A i GABA-B daje efekt anksjolityczny i łagodny sedacyjny ze znacznie niższym ryzykiem uzależnienia niż przy fenibucie (krótszy okres półtrwania ~0,5 h, szybki klirens). Klinicznie stosowany w Rosji w migrenie, naczyniowych zaburzeniach poznawczych i zespole astenicznym. **FDA usunęła go z amerykańskiego rynku suplementów w 2015** uzasadniając, że nie spełnia definicji suplementu diety (jest lekiem syntetycznym).',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'A Bacopa monnieri (Brahmi) az ayurvédikus gyógyászat klasszikus „medhya rasayana" (intellektus-tonizáló) gyógynövénye. Hatóanyagai a bakozid A és B (és származékai) triterpén-szaponinok. Több kettősvak placebókontrollált humán vizsgálatban (RCT, 12 hét, 300-600 mg standardizált 50% bakozid-kivonat) **memória-konszolidáció és reakcióidő-javulást** írtak le, de az effektusméret szerény (Calabrese 2008 BMC RCT, Stough 2001). **Standardizált kivonat (45-55% bakozidok)** kötelező a hatékonysághoz — alulstandardizált termék inert. Akut hatás minimális, **8-12 hetes krónikus szedés** szükséges a plató-hatáshoz. Gyakori mellékhatás: gastrointestinális diszkomfort üres gyomorra szedéskor → étkezéssel együtt javasolt. Anekdotikusan rövid-távú visszhangzás vagy "lassúság"-érzés is reportált — egyfajta szerotonerg lassítás hatása.',
 ...
 pl: 'Bacopa monnieri (Brahmi) to klasyczne zioło „medhya rasayana" (tonizujące intelekt) medycyny ajurwedyjskiej. Substancjami czynnymi są bakozyd A i B (oraz pochodne), saponiny triterpenowe. Wiele badań klinicznych z podwójnie ślepą próbą i placebo (RCT, 12 tygodni, 300-600 mg standaryzowanego 50% ekstraktu bakozydowego) opisuje **konsolidację pamięci i poprawę czasu reakcji**, choć rozmiar efektu jest umiarkowany (Calabrese 2008 BMC RCT, Stough 2001). **Standaryzowany ekstrakt (45-55% bakozydów)** jest obowiązkowy dla skuteczności — produkt niedostandaryzowany jest obojętny. Efekt ostry minimalny, **8-12 tygodni przewlekłego dawkowania** potrzebne do osiągnięcia plateau. Częsty efekt uboczny: dyskomfort żołądkowo-jelitowy przy stosowaniu na pusty żołądek → przyjmować z posiłkiem. Anegdotycznie raportowane krótkotrwałe „odbijanie się" lub „spowolnienie" — rodzaj efektu spowolnienia serotonergicznego.',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'Az Ashwagandha (Withania somnifera) az ayurvédikus rasayana-medicina egyik leg-szélesebb körben kutatott adaptogénje. Hatóanyagai a withanolid-glikozidok (különösen a withaferin-A és a withanolid-A). RCT-bizonyítékok: Chandrasekhar 2012 (PMID 23439798) **28%-os kortizol-csökkenést** mutatott KSM-66 (600 mg) napi szedéssel 60 nap alatt; Lopresti 2019 (PMID 31337677) Sensoril 240 mg-mal hasonló stressz-skála javulást; Salve 2019 (PMID 32034431) alvás-minőség és álmatlanság javulás. Sportolóknál tesztoszteron- és VO2max-javító hatás dokumentált. Mellékhatások általában enyhék (GI), de **TSH/T4 emelkedés** miatt hypothyroidisra → szakember-konzultáció kell. Dánia 2020 óta tiltja az ashwagandha-tartalmú étrend-kiegészítőket (hormonális endokrin aggály alapján).',
 en: 'Ashwagandha (Withania somnifera) is one of the most extensively researched adaptogens of Ayurvedic rasayana medicine. Its actives are withanolide glycosides (notably withaferin-A and withanolide-A). RCT evidence: Chandrasekhar 2012 (PMID 23439798) showed a **28% cortisol reduction** with KSM-66 (600 mg) daily over 60 days; Lopresti 2019 (PMID 31337677) found similar stress-scale improvement with Sensoril 240 mg; Salve 2019 (PMID 32034431) documented sleep quality and insomnia improvement. In athletes, testosterone and VO2max enhancement is documented. Side effects are usually mild (GI), but **TSH/T4 elevation** in hypothyroidism → specialist consultation required. Denmark has banned ashwagandha-containing dietary supplements since 2020 (on hormonal-endocrine concerns).',
 pl: 'Ashwagandha (Withania somnifera) to jeden z najszerzej zbadanych adaptogenów ajurwedyjskiej medycyny rasayana. Substancjami czynnymi są glikozydy witanolidowe (szczególnie witaferyna-A i witanolid-A). Dowody z RCT: Chandrasekhar 2012 (PMID 23439798) wykazał **28% redukcję kortyzolu** przy KSM-66 (600 mg) dziennie przez 60 dni; Lopresti 2019 (PMID 31337677) znalazł podobną poprawę skali stresu z Sensoril 240 mg; Salve 2019 (PMID 32034431) udokumentował poprawę jakości snu i bezsenności. U sportowców udokumentowane wzmocnienie testosteronu i VO2max. Skutki uboczne zwykle łagodne (GI), ale **wzrost TSH/T4** w niedoczynności tarczycy → wymagana konsultacja specjalistyczna. Dania zakazała suplementów diety zawierających ashwagandhę od 2020 (z powodu obaw hormonalno-endokrynnych).',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 pl: 'Rhodiola rosea (arktyczny korzeń, „złoty korzeń") to zioło przeciwzmęczeniowe stosowane od stuleci przez ludność arktycznych wyżyn. Jej aktywnymi składnikami są salidrozyd (glikozyd tyrozolowy) i grupa rozawinowa — zalecany **standaryzowany ekstrakt o stosunku 3% rozawiny / 1% salidrozydu** (rosyjska tradycja Rosenroot). Dowody z RCT: Olsson 2009 (PMID 19367259) **poprawa w łagodnej-umiarkowanej depresji bez sertraliny**, Edwards 2012 (PMID 22228617) **zespół zmęczenia związany ze stresem**, Hung 2011 (PMID 21366835) zmniejszenie zmęczenia fizycznego. Efekt ostry odczuwalny po pojedynczej dawce 200-400 mg (vs. Bacopa wymagająca 8-12 tygodni kursu). Idealna w połączeniu z niską dawką kofeiny przeciw zmęczeniu psychicznemu.',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'A Lion`s Mane (Hericium erinaceus, magyarul süngomba) ehető gyógygomba, amelynek termőtest-kivonata hericenonokat (H1-H10), micélium-kivonata pedig erinacinokat (A-I) tartalmaz. **Mindkét frakcióra szükség van**: a hericenonok BBB-átjárók de NGF-indukcióhoz az erinacinok kellenek (a micélium-frakció). Mori 2009 japán RCT (PMID 18844328) — **MCI (mild cognitive impairment) javulás 4 hónapos 1g/nap szedéssel**, hatás megszűnik leállítás után. Nagano 2010 (PMID 20834180) — peri-menopauzális nőknél enyhe depresszió + anxietás-csökkenés. Krónikus stress-induced anxietás-modellben rágcsálóknál anti-anxietás. Saját gomba táplálkozási formában (főzve) is hatékony, de extract-koncentráció szükséges nootropikus dózisokhoz. **Gyakori GI mellékhatás üres gyomorra** + ritka, de dokumentált bőr-allergia.',
 ...
 pl: 'Soplówka jeżowata (Hericium erinaceus) to jadalny grzyb leczniczy, którego ekstrakt z owocnika zawiera herycenony (H1-H10), a ekstrakt z grzybni, erynacyny (A-I). **Obie frakcje są potrzebne**: herycenony przenikają BBB, ale indukcja NGF wymaga erynacyn (frakcji grzybni). RCT Mori 2009 (PMID 18844328) — **poprawa MCI (łagodne zaburzenie poznawcze) przy 1 g/dzień przez 4 miesiące**, z efektem zanikającym po odstawieniu. Nagano 2010 (PMID 20834180) — redukcja łagodnej depresji + lęku u kobiet peri-menopauzalnych. U gryzoni z indukowanym przewlekłym stresem lękiem, działanie przeciwlękowe. Sam grzyb jako żywność (gotowany) jest również skuteczny, ale do dawkowania nootropowego wymagane są stężenia ekstraktu. **Częsty efekt uboczny GI na pusty żołądek** + rzadka, ale udokumentowana alergia skórna.',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'Az L-Theanin (N-etil-L-glutamin, γ-glutamil-etilamid) szabad aminosav, amely a Camellia sinensis (zöld tea) levelek fő nem-fehérje-aminosav komponense. Vér-agy gáton áthatol (Tmax ~50 perc), és EEG α-hullám-aktivitást fokoz nyugodt-ébrenléti állapotban (Nobre 2008, PMID 18296328). **Koffeinnel kombinálva (klasszikus L-theanin:koffein 2:1 vagy 200 mg:100 mg protokoll)** szinergisztikusan javítja a figyelmet (Foxe 2012, PMID 22849538) és csökkenti a koffein-okozta vazokonstrikciót + szorongást. Egyetlen 200-400 mg dózis stresszreakciót enyhítheti egészséges felnőtteknél. **NEM termel szedációt** vagy függőséget — egyik legbiztonságosabb anxiolitikus nootropikum. Gyermekkori ADHD-szindrómában is vizsgált (Lyon 2011 — javította a fiúknál az alvás-minőséget). FDA GRAS.',
 en: 'L-Theanine (N-ethyl-L-glutamine, γ-glutamyl-ethylamide) is a free amino acid, the main non-protein amino acid component of Camellia sinensis (green tea) leaves. It crosses the blood-brain barrier (Tmax ~50 min) and enhances EEG α-wave activity in the relaxed-awake state (Nobre 2008, PMID 18296328). **Combined with caffeine (the classical L-theanine:caffeine 2:1 or 200 mg:100 mg protocol)** it synergistically improves attention (Foxe 2012, PMID 22849538) and reduces caffeine-induced vasoconstriction + anxiety. A single 200-400 mg dose can ease the stress response in healthy adults. **Does NOT produce sedation** or dependence — one of the safest anxiolytic nootropics. Also studied in pediatric ADHD syndrome (Lyon 2011 — improved sleep quality in boys). FDA GRAS.',
 pl: 'L-Teanina (N-etylo-L-glutamina, γ-glutamylo-etyloamid) to wolny aminokwas, główny niebiałkowy aminokwas liści Camellia sinensis (zielonej herbaty). Przenika barierę krew-mózg (Tmax ~50 min) i zwiększa aktywność fal α w EEG w stanie zrelaksowanej czuwania (Nobre 2008, PMID 18296328). **Połączona z kofeiną (klasyczny protokół L-teanina:kofeina 2:1 lub 200 mg:100 mg)** synergistycznie poprawia uwagę (Foxe 2012, PMID 22849538) i zmniejsza wywołane kofeiną zwężenie naczyń + lęk. Pojedyncza dawka 200-400 mg może łagodzić reakcję stresową u zdrowych dorosłych. **NIE wywołuje sedacji** ani uzależnienia — jeden z najbezpieczniejszych nootropików przeciwlękowych. Badana także w pediatrycznym ADHD (Lyon 2011 — poprawiła jakość snu u chłopców). FDA GRAS.',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 pl: 'Tongkat Ali (Eurycoma longifolia, „longjack") to południowoazjatyckie korzeniowe zioło. Jego substancje czynne to kwasynoidy (zwłaszcza eurykomanon) i frakcja glikoproteinowa (ekstrakt Physta®). Dowody z RCT: Tambi 2012 (PMID 22458760) — **46,8% wzrost testosteronu w surowicy u mężczyzn hipogonadalnych w ciągu 1 miesiąca**; Talbott 2013 (PMID 23705007) — redukcja kortyzolu + podniesienie testosteronu w przewlekłym stresie. U mężczyzn eugonadalnych zdrowych efekt jest mniejszy (~15-20%) — działanie ma „efekt sufitowy" związany z poziomem wyjściowym. **Najlepsze wskazanie: kombinacja przewlekłego stresu + obniżonego libido + zaburzeń snu**. NIE na liście zakazanej WADA. U sportowców standardowy ekstrakt Physta® 200 mg/dzień w cyklu 5 dni w tygodniu jest powszechny.',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'A Cerebrolysin (EVER Pharma, Ausztria) sertés-agykéregből kivont, peptid- és szabad aminosav-frakciókra hidrolizált biológiai gyógyszer (FPF1070 enzimatikus eljárás). 25% peptidek (<10 kDa), 75% szabad aminosavak. Klinikai bizonyítékok: **CASTA trial (Heiss 2012, PMID 22744651)** — akut ischaemiás stroke, intent-to-treat NIH SS javulás; **CARS-1 trial (Muresanu 2016, PMID 26669311)** — stroke-rehabilitation, statisztikailag szignifikáns funkcionális regeneráció. Mechanizmus: NGF, BDNF, GDNF, CNTF-szerű peptid-aktivitás → neurogenezis a szubventrikuláris zónában, anti-excitotoxikus + anti-apoptotikus hatás. Beadás: 10-30 ml i.v. infúzió 10-20 napon át (akut stroke), majd 4-6 hetente ismételhető. Magyarországon és számos EU-tagállamban (AT, PL, RU, CN) vényköteles. USA-ban nem FDA-jóváhagyott (nem klasszikus biológiai gyógyszerként sorolható).',
 en: 'Cerebrolysin (EVER Pharma, Austria) is a biological medicine hydrolyzed from porcine brain cortex into peptide and free amino acid fractions (the FPF1070 enzymatic process). 25% peptides (<10 kDa), 75% free amino acids. Clinical evidence: **CASTA trial (Heiss 2012, PMID 22744651)** — acute ischemic stroke, intent-to-treat NIH SS improvement; **CARS-1 trial (Muresanu 2016, PMID 26669311)** — stroke rehabilitation, statistically significant functional recovery. Mechanism: NGF, BDNF, GDNF, CNTF-like peptide activity → neurogenesis in the subventricular zone, anti-excitotoxic + anti-apoptotic effects. Administration: 10-30 ml i.v. infusion over 10-20 days (acute stroke), repeatable every 4-6 weeks. Prescription-only in Hungary and several EU member states (AT, PL, RU, CN). Not FDA-approved in the USA (cannot be classified under standard biological-drug categories).',
 pl: 'Cerebrolysin (EVER Pharma, Austria) to biologiczny lek hydrolizowany z kory mózgu świni do frakcji peptydowych i wolnych aminokwasów (proces enzymatyczny FPF1070). 25% peptydów (<10 kDa), 75% wolnych aminokwasów. Dowody kliniczne: **badanie CASTA (Heiss 2012, PMID 22744651)** — ostry udar niedokrwienny, poprawa NIH SS w intent-to-treat; **badanie CARS-1 (Muresanu 2016, PMID 26669311)** — rehabilitacja udarowa, statystycznie istotna poprawa funkcjonalna. Mechanizm: aktywność peptydowa podobna do NGF, BDNF, GDNF, CNTF → neurogeneza w strefie podkomorowej, działanie przeciw ekscitotoksyczne + przeciwapoptotyczne. Podawanie: wlew i.v. 10-30 ml przez 10-20 dni (ostry udar), powtarzany co 4-6 tygodni. Na receptę na Węgrzech i w kilku państwach UE (AT, PL, RU, CN). Niezatwierdzony przez FDA w USA (nie może być sklasyfikowany w standardowych kategoriach leku biologicznego).',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'A Cortexin (Geropharm, Oroszország) szarvasmarha- és sertés-agykéregből izolált, alacsony molekulatömegű (<10 kDa) polipeptid-frakció (~20 különböző peptid-komponens). Oroszországban 1999 óta vényköteles i.m. injekció, klinikai indikációi: ischaemiás stroke + post-stroke rehabilitáció, krónikus cerebrális ischaemia, gyermekgyógyászati cerebrális palsy + fejlődési késés, traumás agysérülés, krónikus encephalopátia. **Cerebrolysintől eltérően kisebb peptid-méret (<10 kDa vs Cerebrolysin <10 kDa is, de Cortexinben uniform-fragmentumok)** → gyorsabb BBB-átjutás, de rövidebb tartam. Tipikus protokoll: 10 mg i.m. naponta 10 napon át. Klinikai bizonyítékai főleg orosz nyelvű publikációkból (Skvortsova, Gusev csoportok); nyugati peer-review irodalomban szegényen reprezentált, ezért Nyugat-Európában és USA-ban nem regisztrált.',
 ...
 pl: 'Korteksyna (Geropharm, Rosja) to niskocząsteczkowa (<10 kDa) frakcja polipeptydowa wyizolowana z kory mózgu wołowej i świńskiej (~20 odrębnych komponentów peptydowych). W Rosji od 1999 r. lek na receptę w postaci wstrzyknięcia i.m., wskazania kliniczne: udar niedokrwienny + rehabilitacja poudarowa, przewlekłe niedokrwienie mózgu, pediatryczne porażenie mózgowe + opóźnienie rozwoju, urazowe uszkodzenie mózgu, przewlekła encefalopatia. **W porównaniu z cerebrolizyną mniejszy rozmiar peptydów (<10 kDa vs cerebrolizyna <10 kDa, ale korteksyna używa jednorodnych fragmentów)** → szybsze przejście BBB, ale krótszy czas działania. Typowy protokół: 10 mg i.m. codziennie przez 10 dni. Dowody kliniczne pochodzą głównie z publikacji w języku rosyjskim (grupy Skvortsova, Gusev); słabo reprezentowane w zachodniej literaturze peer-review, dlatego nie zarejestrowana w Europie Zachodniej ani USA.',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
 ...
 description: {
 hu: 'A Magnézium-L-treonát (Magtein®) az MIT-en Liu Guosong és Susumu Tonegawa csoportja által fejlesztett szabadalmaztatott magnézium-kelát, amelyben a treonsav-konjugáció miatt a magnézium-ion a többi formánál (oxid, citrát, glicinát) **hatékonyabban hatol be a központi idegrendszerbe**. Slutsky 2010 (Neuron, PMC) — patkány-vizsgálat **agyi Mg²⁺-emelés + szinaptikus sűrűség- és LTP-növekedés** a prefrontális kéregben + hippocampusban. Liu 2016 humán RCT (Magtein) — **idősebb felnőtteknél kognitív életkor-csökkenés ~9 év a placebóhoz képest** kis mintán (n=44, 12 hét). Tipikus dózis: 2 g / nap (~144 mg elemi magnézium). **Stimulánsok és racetamok adjuvánsa**: NMDA-tónus stabilizálás csökkenti az overstimulációs anxietást és álmatlanságot — Alpha-GPC + Phenylpiracetam stack-ekben gyakran szerepel. Magtein®: FDA GRAS. Generic mag-L-threonate-ek lehet, hogy nem felelnek meg a szabadalmaztatott biológiai hasznosulásnak.',
 en: 'Magnesium L-Threonate (Magtein®) is a proprietary magnesium chelate developed at MIT by Liu Guosong and Susumu Tonegawa, in which the threonic-acid conjugation lets magnesium ions **penetrate the CNS more efficiently than other forms** (oxide, citrate, glycinate). Slutsky 2010 (Neuron, PMC) — rat study showed **elevated brain Mg²⁺ + synaptic density and LTP increases** in prefrontal cortex + hippocampus. Liu 2016 human RCT (Magtein) — **~9-year reduction in cognitive age vs placebo in older adults** on a small sample (n=44, 12 weeks). Typical dose: 2 g / day (~144 mg elemental magnesium). **Adjuvant to stimulants and racetams**: NMDA-tone stabilization reduces overstimulation-anxiety and insomnia — frequently included in Alpha-GPC + Phenylpiracetam stacks. Magtein®: FDA GRAS. Generic Mg-L-threonate may not match the patented bioavailability.',
 pl: 'L-Treonian magnezu (Magtein®) to opatentowany chelat magnezu opracowany na MIT przez Liu Guosonga i Susumu Tonegawę, w którym koniugacja z kwasem treonowym pozwala jonom magnezu **skuteczniej przenikać do OUN niż innym formom** (tlenek, cytrynian, glicynian). Slutsky 2010 (Neuron, PMC) — badanie na szczurach pokazało **podwyższony Mg²⁺ w mózgu + wzrost gęstości synaptycznej i LTP** w korze przedczołowej + hipokampie. Liu 2016 RCT u ludzi (Magtein) — **redukcja wieku poznawczego o ~9 lat vs placebo u starszych dorosłych** na małej próbie (n=44, 12 tygodni). Typowa dawka: 2 g / dzień (~144 mg elementarnego magnezu). **Adiuwant dla stymulantów i racetamów**: stabilizacja napięcia NMDA zmniejsza lęk z nadmiernej stymulacji i bezsenność — często włączany do stacków Alpha-GPC + Phenylpiracetam. Magtein®: FDA GRAS. Generyczny Mg-L-treonian może nie odpowiadać opatentowanej biodostępności.',
 },
 keyInfo: [
 { label: { hu: 'Hatásmechanizmus', en: 'Mechanism', pl: 'Mechanizm' },
