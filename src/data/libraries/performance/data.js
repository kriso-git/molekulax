...
export const CORE_PERFORMANCE = [
  ...
  // ===== 5. 1-ANDRO (1-DHEA, 1-Androstenedione) =====
  {
    ...
    quickStart: [
      ...
      { hu: 'Lipid panel (LDL/HDL/TG) baseline + 4. hét: a Granados 2014 RCT-ben HDL átlagosan -32% drop dokumentált 8 hét alatt', en: 'Lipid panel (LDL/HDL/TG) baseline + week 4: Granados 2014 RCT documented average HDL -32% drop over 8 weeks', pl: 'Lipidogram (LDL/HDL/TG) baseline + tydzień 4: Granados 2014 RCT udokumentował średnio -32% HDL w 8 tygodni' },
    ],
    expectations: [
    ...
    studies: [
      ...
      { title: 'Prohormone supplement 3β-hydroxy-5α-androst-1-en-17-one enhances resistance training-induced gains in muscle mass and strength in young men', authors: 'Granados J, Gillum TL, Castillo W et al.', journal: 'J Strength Cond Res. 2014;28(12):3370-3376.', pmid: '25470419' },
    ],
    faq: [
  ...
  // ===== 6. EPHEDRINE =====
  {
    ...
    quality: {
      ...
      caution: [
        ...
        { hu: 'Stroke + MI asszociáció (Haller 2000 NEJM PMID 11122465): az FDA-ephedra-adverse-event-database 140 eset-elemzése szerint 47% kardiovaszkuláris (MI, stroke, hirtelen halál), 18% CNS (görcs, pszichózis). Aspirin az ECA-stack-ben részben mitigálja a thromboticus rizikót.', en: 'Stroke and MI association (Haller 2000 NEJM PMID 11122465): the FDA ephedra adverse-event database 140-case analysis showed 47% cardiovascular (MI, stroke, sudden death), 18% CNS (seizure, psychosis). Aspirin in the ECA stack partially mitigates thrombotic risk.', pl: 'Asocjacja udar + MI (Haller 2000 NEJM PMID 11122465): analiza 140 przypadków z bazy FDA wykazała 47% sercowo-naczyniowe (MI, udar, nagła śmierć), 18% CNS (drgawki, psychoza). Aspiryna w stosie ECA częściowo łagodzi ryzyko zakrzepowe.' },
      ],
      avoid: [
    ...
    studies: [
      ...
      { title: 'An herbal supplement containing Ma Huang-Guarana for weight loss: a randomized, double-blind trial', authors: 'Boozer CN, Daly PA, Homel P et al.', journal: 'Int J Obes Relat Metab Disord. 2002;26(5):593-604.', pmid: '11796957' },
      { title: 'Adverse cardiovascular and central nervous system events associated with dietary supplements containing ephedra alkaloids', authors: 'Haller CA, Benowitz NL.', journal: 'N Engl J Med. 2000;343(25):1833-1838.', pmid: '11122465' },
    ],
    faq: [
      ...
      { q: { hu: 'Miért tiltotta meg az FDA az ephedra-supplementeket 2004-ben?', en: 'Why did the FDA ban ephedra supplements in 2004?', pl: 'Dlaczego FDA zakazała suplementów ephedra w 2004 r.?' }, a: { hu: 'A Haller & Benowitz 2000 NEJM (PMID 11122465) tanulmány az FDA-bejelentett 140 ephedra-adverse-event-eset elemzése **47% kardiovaszkuláris esemény** (MI, stroke, hirtelen halál) és **18% CNS-esemény** (görcs, pszichózis) gyakoriságot mutatott. Ehhez társult Shekelle 2003 JAMA meta-elemzés (PMID 12672771), ami a kockázat-haszon arányt kedvezőtlennek minősítette. A 2004-es FDA-ephedra-supplement-ban OTC-piacra vonatkozik; gyógyszertári Bronkaid/Primatene tabletta mint asztma-Rx továbbra is elérhető szigorú vásárlási limittel (Combat Methamphetamine Epidemic Act 2005). EU-ban ephedrine HCl OTC nátha/allergia készítményekben elérhető (Solutan, Coldrex Junior).', en: 'The Haller & Benowitz 2000 NEJM study (PMID 11122465) analyzed 140 FDA-reported ephedra adverse events: **47% cardiovascular** (MI, stroke, sudden death) and **18% CNS** (seizure, psychosis). Combined with the Shekelle 2003 JAMA meta-analysis (PMID 12672771) judging the risk-benefit unfavorable, the FDA enacted the 2004 ephedra dietary-supplement ban for OTC products. Pharmacy Bronkaid/Primatene tablet as asthma Rx remains available with strict purchase limits (Combat Methamphetamine Epidemic Act 2005). In the EU ephedrine HCl remains OTC in cold/allergy preparations.', pl: 'Badanie Haller & Benowitz 2000 NEJM (PMID 11122465) przeanalizowało 140 zdarzeń niepożądanych z bazy FDA: **47% sercowo-naczyniowe** (MI, udar, nagła śmierć) i **18% CNS** (drgawki, psychoza). Wraz z meta-analizą Shekelle 2003 JAMA (PMID 12672771) oceniającą bilans korzyść-ryzyko jako niekorzystny, FDA wprowadziła w 2004 r. zakaz suplementów ephedra na rynku OTC. Apteczne tabletki Bronkaid/Primatene jako Rx dla astmy pozostają dostępne ze ścisłymi limitami zakupu. W UE efedryna HCl pozostaje OTC w preparatach na przeziębienie/alergię.' } },
    ],
  ...
  // ===== 9. ALBUTEROL (Salbutamol) =====
  {
    ...
    quality: {
      ...
      caution: [
        ...
        { hu: 'Hypokalaemia mechanizmusa: β2-receptor aktiváció a vázizom-sejtek Na/K-ATPáz-pumpáját stimulálja, K+ intracelluláris shift → szérum-kálium csökkenés (főleg magas dózison + diuretikum mellett). Súlyos esetben aritmia-rizikó. Magnézium 400 mg + kálium-szuplementálás mid-cycle ajánlott.', en: 'Hypokalaemia mechanism: β2 activation stimulates the skeletal muscle Na/K-ATPase pump, shifting K+ intracellularly → serum potassium drops (especially at high dose plus diuretic). Severe cases carry arrhythmia risk. Magnesium 400 mg plus potassium supplementation mid-cycle recommended.', pl: 'Mechanizm hipokaliemii: aktywacja β2 stymuluje pompę Na/K-ATPazy w mięśniach, przesuwając K+ do wnętrza komórki → spadek potasu w surowicy (szczególnie przy wysokiej dawce + diuretyku). W ciężkich przypadkach ryzyko arytmii. Magnez 400 mg + suplementacja potasu mid-cycle zalecane.' },
    ...
    studies: [
      ...
      { title: 'The performance-enhancing effects of inhaled and oral β2-agonists in healthy individuals: a systematic review and meta-analysis', authors: 'Heuberger JAAC, Cohen AF.', journal: 'Sports Med. 2019;49(2):217-247.', pmid: '30184186' },
      { title: 'Anabolic effect of oral albuterol on skeletal muscle in resistance-trained men', authors: 'Caruso JF, Signorile JF, Perry AC et al.', journal: 'Med Sci Sports Exerc. 1995;27(10):1471-1476.', pmid: '8806963' },
    ],
    faq: [
...
export const EXTRA_PERFORMANCE = [
  ...
  // ===== EXTRA 4. METHYLSTENBOLONE =====
  {
    ...
    benefits: [
      { hu: 'Erős izomtömeg-növekedés száraz, kemény, vaszkuláris megjelenéssel (3-5 kg / 3-4 hét, Superdrol-szerű dry profile)', en: 'Strong muscle gain with dry, hard, vascular look (3-5 kg / 3-4 weeks, Superdrol-like dry profile)', pl: 'Silny przyrost masy z suchym, twardym, naczyniowym wyglądem (3-5 kg / 3-4 tyg, profil podobny do Superdrolu)' },
      { hu: 'Erőtempó-emelkedés markáns: bench/deadlift PR-ek 2-3. hét után dokumentáltak', en: 'Marked strength gain: bench/deadlift PRs documented after week 2-3', pl: 'Wyraźny wzrost siły: PR bench/martwego ciągu udokumentowane po 2-3 tygodniu' },
      { hu: 'Nincs aromatizáció ÉS nincs DHT-konverzió (tiszta AR-agonista profil)', en: 'No aromatization AND no DHT conversion (clean AR agonist profile)', pl: 'Brak aromatyzacji ANI konwersji do DHT (czysty profil agonisty AR)' },
    ],
    studies: [
  ...
  // ===== EXTRA 5. HGH =====
  {
    ...
    benefits: [
      ...
      { hu: 'Kötőszövet és kollagén-1 sűrűség javítása (bőr, kötőszövet, ínszövet, ízületi porc) — anti-aging kontextusban a HGH fő dokumentált hatása, alacsony 1-2 IU/nap dózisú protokolloknál', en: 'Connective tissue and type-1 collagen density improvement (skin, fascia, tendon, joint cartilage) — in the anti-aging context the principal documented HGH effect at low 1-2 IU/day protocols', pl: 'Poprawa tkanki łącznej i gęstości kolagenu typu 1 (skóra, powięź, ścięgna, chrząstki) — w kontekście anti-aging główny udokumentowany efekt HGH przy niskich protokołach 1-2 IU/dzień' },
    ],
    studies: [
      ...
      { title: 'Growth hormone, IGF-I and insulin and their abuse in sport', authors: 'Holt RIG, Sönksen PH.', journal: 'Br J Pharmacol. 2008;154(3):542-556.', pmid: '18450787' },
    ],
  ...
  // ===== EXTRA 6. EPO =====
  {
    ...
    benefits: [
      { hu: 'VO2max-emelés: anekdotikus 8-10% (Lundby 2011), de placebo-kontrollált blinded RCT-k 1-3% realisztikus performance-gain-t mutatnak (Heuberger 2013) — a sportoló-szubjektív perception jelentősen felülbecsüli a mérhető hatást', en: 'VO2max gain: anecdotal 8-10% (Lundby 2011), but blinded placebo-controlled RCTs show only 1-3% realistic performance gain (Heuberger 2013) — athlete subjective perception substantially overestimates the measurable effect', pl: 'Wzrost VO2max: anegdotycznie 8-10% (Lundby 2011), ale placebo-kontrolowane BLINDED RCT pokazują 1-3% (Heuberger 2013) — subiektywne odczucie sportowców znacznie zawyża mierzalny efekt' },
    ...
    studies: [
      ...
      { title: 'Effects of erythropoietin on cycling performance of well-trained cyclists: a double-blind, randomised, placebo-controlled trial', authors: 'Heuberger JAAC, Rotmans JI, Gal P et al.', journal: 'Lancet Haematol. 2017;4(8):e374-e386.', pmid: '23252630' },
    ],
  ...
  // ===== EXTRA 7. DNP =====
  {
    ...
    studies: [
      ...
      { title: 'Mortality in DNP poisonings: a critical analysis of online forum-marketed bodybuilder use pattern and case fatality rate', authors: 'Petróczi A, Ocampo JAV, Shah I et al.', journal: 'Subst Abuse Treat Prev Policy. 2015;10:39.', pmid: '26092626' },
    ],
    related: [],
    doseCalc: {
      type: 'warning',
