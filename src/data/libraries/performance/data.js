...
export const CORE_PERFORMANCE = [
  ...
  // ===== 4. SUPERDROL (Methasterone) =====
  {
    ...
    quality: {
      ...
      caution: [
        ...
        { hu: 'Akut vesekárosodás (AKI): Nasr 2009 case report (PMID 19288206) Methasterone-indukált cholesztatikus jaundice + AKI-t dokumentált (kreatinin emelkedés, cystatin-C, oliguria). Hepato-renal szindróma kockázat — kreatinin-monitoring mid-cycle KÖTELEZŐ.', en: 'Acute kidney injury (AKI): Nasr 2009 case report (PMID 19288206) documented Methasterone-induced cholestatic jaundice PLUS AKI (creatinine rise, cystatin-C, oliguria). Hepato-renal syndrome risk — creatinine monitoring mid-cycle is MANDATORY.', pl: 'Ostre uszkodzenie nerek (AKI): case report Nasr 2009 (PMID 19288206) udokumentował indukowaną Methasterone cholestatyczną żółtaczkę PLUS AKI (wzrost kreatyniny, cystatyny-C, oliguria). Ryzyko zespołu wątrobowo-nerkowego — monitoring kreatyniny mid-cycle OBOWIĄZKOWY.' },
      ],
      avoid: [
  ...
  // ===== 8. CLENBUTEROL =====
  {
    ...
    benefits: [
      ...
      { hu: 'Szelektív type-2 izomrost-hipertrófia (anti-katabolikus): állatkísérletes fast-glycolytic rost-szelektivitás, izom-megtartás kalóriadeficitben aerob teljesítmény minimális rontásával', en: 'Selective type-2 muscle fiber hypertrophy (anti-catabolic): animal-confirmed fast-glycolytic fiber selectivity, muscle sparing during caloric deficit with minimal aerobic performance loss', pl: 'Selektywna hipertrofia włókien typu 2 (antykataboliczna): selektywność fast-glycolytic potwierdzona u zwierząt, ochrona masy w deficycie z minimalną stratą wydajności aerobowej' },
    ],
    quickStart: [
    ...
    studies: [
      ...
      { title: 'Beta2-agonists: pharmacology and therapeutic role in respiratory disease', authors: 'Cazzola M, Page CP, Calzetta L, Matera MG.', journal: 'Pharmacol Rev. 2010;62(3):450-504.', pmid: '20535649' },
      { title: 'β2-adrenergic receptor agonists as neuroprotective agents in Parkinson disease: a review', authors: 'Mittal S, Bjørnevik K, Im DS et al.', journal: 'Mov Disord. 2024.', pmid: '38953404' },
    ],
    faq: [
...
export const EXTRA_PERFORMANCE = [
  // ===== EXTRA 1. WINSTROL (Stanozolol) =====
  {
    ...
    mechanism: {
      hu: 'AR-agonista DHT-szerű karakterrel. Direkt hepatikus SHBG-mRNA-szintézist GÁTOL → szabad tesztoszteron-frakció emelkedés (andro-amplifikáció). Nem aromatizál (DHT-származék), nem konvertál DHT-vé.',
      en: 'AR agonist with DHT-like character. Directly INHIBITS hepatic SHBG-mRNA synthesis → free testosterone fraction rise (andro-amplification). Does not aromatize (DHT derivative), does not convert to DHT.',
      pl: 'Agonista AR podobny do DHT. Bezpośrednio HAMUJE wątrobową syntezę mRNA SHBG → wzrost frakcji wolnego testosteronu. Nie aromatyzuje, nie konwertuje do DHT.',
    },
    legalStatus: {
    ...
    benefits: [
      ...
      { hu: 'Vörösvérsejt + aerob kapacitás emelés: erythropoietikus hatás dokumentált (Pope 2014 review), endurance-performance enhancement sub-elite atlétáknál', en: 'Red blood cell + aerobic capacity boost: erythropoietic effect documented (Pope 2014 review), endurance-performance enhancement in sub-elite athletes', pl: 'Wzrost erytrocytów + wydajności aerobowej: efekt erytropoetyczny udokumentowany (przegląd Pope 2014), poprawa wytrzymałości u sportowców sub-elite' },
    ],
    studies: [
  ...
  // ===== EXTRA 2. NANDROLONE (Deca) =====
  {
    ...
    benefits: [
      ...
      { hu: 'Kollagén-szintézis és kötőszövet-támogatás: nandrolone direkten emeli a 1-es típusú prokollagén-szintézist (Geusens 1995 review PMID 7770048), krónikus alacsony dózis (100-150 mg/hét) ízületi fájdalom enyhítésére dokumentáltan használt', en: 'Collagen synthesis and connective tissue support: nandrolone directly elevates type-1 procollagen synthesis (Geusens 1995 review PMID 7770048), chronic low dose (100-150 mg/week) documented for joint pain relief', pl: 'Synteza kolagenu i wsparcie tkanki łącznej: nandrolon bezpośrednio podnosi syntezę prokolagenu typu 1 (przegląd Geusens 1995 PMID 7770048), przewlekła niska dawka (100-150 mg/tydzień) udokumentowana dla ulgi w bólu stawów' },
    ],
    studies: [
  ...
  // ===== EXTRA 3. DIANABOL =====
  {
    ...
    benefits: [
      ...
      { hu: 'Mood elevation (dopaminerg + ösztrogén-mediált): "kickstart"-fázis gyakori felhasználói visszajelzés, eufórikus drive + edzés-motiváció emelkedés', en: 'Mood elevation (dopaminergic + estrogen-mediated): common user feedback in "kickstart" phase, euphoric drive plus training motivation rise', pl: 'Podniesienie nastroju (dopaminergiczne + estrogenowe): częste doniesienia w fazie "kickstart", euforia + wzrost motywacji treningowej' },
    ],
    studies: [
