...
export default {
  ...
  "keyInfo": [
    {"label": "Mechanizm", "value": "Niesteroidowy SERM, kompetycyjny antagonista ER-α w przysadce + piersi"},
    {"label": "Dawkowanie (PCT)", "value": "20-40 mg/dzień, 4-6 tygodni"},
    {"label": "Okres półtrwania", "value": "~5-7 dni (parent) / ~14 dni (4-OH-tamoksyfen, aktywny metabolit)"},
    {"label": "Początek działania", "value": "Wzrost LH 24-72 h, odbudowa Test 2-3 tygodnie"},
    {"label": "Status prawny", "value": "FDA + EMA Rx, zarejestrowany w HU + PL, WADA S4 (zabroniony w zawodach)"}
  ],
  ...
  "expectations": [
    {"label": "Tydzień 1", "body": "Wzrost LH/FSH mierzalny (pobranie krwi +5 dni), zmiana objawowa minimalna. U niektórych użytkowników łagodne odczucie grypopodobne lub ból głowy z powodu wahań E2."},
    {"label": "Tygodnie 2-3", "body": "Endogenna produkcja testosteronu zaczyna wracać — odzysk libido, wzrost energii zauważalny. Test lustra: jeśli pod koniec cyklu pojawiły się objawy ginekomastii, teraz słabną."},
    {"label": "Tygodnie 4-6", "body": "Odbudowa Test kompletna (baseline ±10%), oś HPTA funkcjonalna. Panel lipidowy się poprawia (wzrost HDL). Koniec PCT: ostatnia dawka, +2 tygodnie konserwatywnej przerwy przed planowaniem nowego cyklu."},
    {"label": "Post-PCT", "body": "Badania potwierdzające +6 tygodni: Total/Free Test, LH, FSH, E2, SHBG. Jeśli LH/FSH < 50% wieko-specyficznego baseline → konsultacja specjalistyczna (endokrynolog)."}
  ],
  "quality": {
    "pure": [
