...
export default {
  ...
  "keyInfo": [
    {"label": "Mechanizm", "value": "Sterydowy SARM (rusztowanie 5α-androstanu) + inhibitor szlaku miostatyny (upregulation follistatyny)"},
    {"label": "Precedens kliniczny", "value": "Faza 0 in vitro only (Kanno 2011/2013, Yatsu 2018). Brak Fazy I/II/III u ludzi."},
    {"label": "Aktywność anaboliczna", "value": "AR binding ~50% testosteronu (in vitro) + blok miostatyny podwójny efekt"},
    {"label": "Okres półtrwania", "value": "~6-10 h (doustnie, szacowany)"},
    {"label": "Status prawny", "value": "Nigdy nie był Rx. UGL 'research chemical'. Zakazany WADA S1.2."}
  ],
  ...
  "expectations": [
    {"label": "Pierwsze 1-2 tygodnie", "body": "Anegdotyczny wzrost siły. Brak precedensu klinicznego."},
    {"label": "Tydzień 4-6", "body": "Anegdotyczny wzrost lean mass 2-4 kg + subiektywne raporty UGL 'czuję-się-powyżej-natural-cap'. Markery wątrobowe mogą wzrosnąć (ALT 1,5-3x)."},
    {"label": "Koniec tygodnia 6-8", "body": "Maksymalny efekt (3-5 kg lean mass), pełna supresja HPTA, planowanie PCT. Monitor wątrobowy krytyczny."}
  ],
  "quality": {
    "pure": [
