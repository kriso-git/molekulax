...
export default {
  ...
  "keyInfo": [
    {"label": "Mechanizm", "value": "Niesterydowy selektywny modulator AR (arylopropionamid). Silny agonista AR w mięśniu, umiarkowany w prostacie."},
    {"label": "Aktywność anaboliczna (Dalton 2011)", "value": "1,3 kg wzrost lean body mass @ 3 mg/dzień, 16 tygodni, pacjenci z kacheksją nowotworową."},
    {"label": "Okres półtrwania", "value": "~24 h (doustnie)"},
    {"label": "Onset", "value": "2-4 tygodnie"},
    {"label": "Status prawny", "value": "Nigdy nie zatwierdzony przez FDA (Faza III POWER failed 2016). UGL 'research chemical'. Zakazany WADA S1.2."}
  ],
  ...
  "expectations": [
    {"label": "Pierwsze 2 tygodnie", "body": "Anegdotyczny wzrost siły umiarkowany, zmiana lean mass JESZCZE niemierzalna."},
    {"label": "Tygodnie 4-8", "body": "Wzrost lean mass 1-3 kg (anegdoty UGL przy 12,5-25 mg/dzień), supresja HPTA się rozpoczyna (LH/FSH ~30-50%)."},
    {"label": "Koniec tygodnia 8", "body": "Maksymalny efekt (2-4 kg lean mass UGL), planowanie PCT. Monitor wątrobowy."}
  ],
  "quality": {
    "pure": [
  ...
  "studies": [
    {"title": "The selective androgen receptor modulator GTx-024 (enobosarm) improves lean body mass and physical function in healthy elderly men and postmenopausal women: results of a double-blind, placebo-controlled phase II trial", "authors": "Dalton JT, Barnette KG, Bohl CE, et al.", "journal": "J Cachexia Sarcopenia Muscle. 2011;2(3):153-161.", "pmid": "21833506"},
    {"title": "Study design and rationale for the phase 3 clinical development program of enobosarm, a selective androgen receptor modulator, for the prevention and treatment of muscle wasting in cancer patients (POWER trials)", "authors": "Crawford J, Prado CM, Johnston MA, et al.", "journal": "Curr Oncol Rep. 2016;18(6):37.", "pmid": "26944362"},
