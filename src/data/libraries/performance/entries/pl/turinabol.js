...
export default {
  ...
  "keyInfo": [
    {
      "label": "Mechanizm",
      "value": "Agonista AR, 17α-metyl-4-chloro-Δ1-T, NIE aromatyzuje"
    },
    {
    ...
    },
    {
      ...
      "value": "16 godzin (doustnie)"
    },
    {
      "label": "Początek",
      "value": "2-3 h (doustnie)"
    },
    {
      "label": "Status prawny",
      "value": "Jenapharm Rx (DE) wycofany 1994; UGL dziś. Schedule III."
    }
  ],
  ...
  "expectations": [
    {
      ...
      "body": "Efekt ostry minimalny. Wzrost siły wyczuwalny po 3-5 dniach, przyrost masy beztłuszczowej jeszcze nie."
    },
    {
      "label": "Tydzień 4-6",
      "body": "Maksymalny przyrost masy 3-5 kg, wzrost siły 10-15% 1RM. HDL spadek umiarkowany (15-25%)."
    },
    {
      "label": "Post-cykl",
      "body": "Zachowanie masy relatywnie dobre (utrata wody minimalna). Recovery wątrobowy 4-6 tygodni. Okno detekcji 12-18 miesięcy w laboratoriach WADA."
    }
  ],
  "quality": {
    "pure": [
