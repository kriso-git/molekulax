...
export default {
  ...
  "keyInfo": [
    {"label": "Mechanizm", "value": "Czysty trans-izomer klomifenu, antagonista ER-α w przysadce, BEZ efektu nastrojowego zuklomifenu"},
    {"label": "Dawkowanie (PCT lub hipogonadyzm)", "value": "12,5-25 mg/dzień, rano"},
    {"label": "Okres półtrwania", "value": "~5 dni (czystszy niż mieszany t1/2 Clomidu)"},
    {"label": "Początek działania", "value": "Wzrost LH 24-72 h, odbudowa Test 2-4 tygodnie"},
    {"label": "Status prawny", "value": "NIE zatwierdzony przez FDA (CRL 2016), US-compounding + UE research-pharm + UGL"}
  ],
  ...
  "expectations": [
    {"label": "Tygodnie 1-2", "body": "Wzrost LH/FSH mierzalny, wczesna odbudowa Test. Profil nastroju czysty — BRAK 'emocjonalnej' fluktuacji w stylu Clomidu."},
    {"label": "Tygodnie 3-4", "body": "Odbudowa Test potwierdzalna (Phase III T <300 → T >450 ng/dL średnio). Libido wraca, energia poprawia się."},
    {"label": "Tygodnie 5-6", "body": "Koniec PCT lub stabilizacja dawki chronicznej (alternatywa TRT). Panel lipidowy poprawia się (wzrost HDL)."},
    {"label": "Post-protokół", "body": "Odbudowa spermatogenezy potwierdzalna analizą nasienia w 2-3 miesiące. Jeśli LH/FSH < 50% baseline → konsultacja specjalistyczna."}
  ],
  "quality": {
    "pure": [
