...
export default {
  ...
  "keyInfo": [
    {"label": "Mechanizm", "value": "Peryferyjny niesteroidowy antagonista AR (NIE inhibitor 5AR!) — blokada wiązania AR mieszka włosowego skóry głowy"},
    {"label": "Dawkowanie (tylko-badawcze)", "value": "5% roztwór w etanolu/glikolu propylenowym, 0,5-1 mL raz dziennie aplikacja na skórę głowy"},
    {"label": "Okres półtrwania", "value": "Topikalna minimalna absorpcja systemowa (twierdzenie), efekt ~24 h"},
    {"label": "Początek działania", "value": "Blokada AR skóry głowy natychmiastowa, stabilizacja włosów 3-6 miesięcy (dane in vivo skąpe)"},
    {"label": "Status prawny", "value": "BRAK zatwierdzenia FDA/EMA, BRAK Rx HU/PL, tylko vendor chemii badawczej, WADA banned (powiązany ze środkiem anabolicznym S1)"}
  ],
  ...
  "expectations": [
    {"label": "Tydzień 1", "body": "Aplikacja na skórę głowy tolerowana (możliwe łagodne podrażnienie skóry głowy od vehikulum etanol/PG). Efekt systemowy minimalny (twierdzenie)."},
    {"label": "Miesiące 3-6", "body": "Stabilizacja włosów obserwowalna (dane in vivo skąpe — raporty na poziomie społeczności + ekstrapolacja trialu Phase I)."},
    {"label": "Długoterminowo (6+ miesięcy)", "body": "Evidence zakończenia Phase II: możliwy efekt feminizujący systemowy (ginekomastia, dysfunkcja seksualna), szczególnie przy wyższej dawce (5%+ roztwór) lub aplikacji na duży obszar skóry głowy. **BRAK** długoterminowego evidence bezpieczeństwa."},
    {"label": "Po zaprzestaniu", "body": "Blokada AR skóry głowy ustępuje w 1-2 tygodnie (dane in vivo skąpe). Przyspieszenie wypadania włosów wraca szybko."}
  ],
  "quality": {
    "pure": [
