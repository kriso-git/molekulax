...
export default {
  ...
  "keyInfo": [
    {"label": "Mechanizm", "value": "Odwracalny niesteroidowy inhibitor CYP19-aromatazy, ~97% supresji E2 w surowicy przy 1 mg/dzień"},
    {"label": "Dawkowanie (AAS)", "value": "0,25-1 mg EOD-2x/tydzień miareczkowane badaniami (E2 trough 20-30 pg/mL LC-MS/MS)"},
    {"label": "Okres półtrwania", "value": "~50 godzin (pojedyncza dawka dzienna, stan stacjonarny dzień 7)"},
    {"label": "Początek działania", "value": "Redukcja E2 mierzalna 24-48 h, pełny efekt 5-7 dni"},
  ...
  "expectations": [
    {"label": "Dzień 1-3", "body": "Redukcja E2 mierzalna w badaniach (~30-50% spadku od baseline). Ulga w retencji wody odczuwalna, napięcie objawów gino ustępuje."},
    {"label": "Tydzień 1-2", "body": "Stan stacjonarny poziomu w osoczu, pełna supresja E2 (~97% cel). Retencja wody zminimalizowana, definicja poprawia się. Lipidogram monitorowalny (oczekiwany łagodny spadek HDL)."},
    {"label": "Długotrwałe stosowanie (3+ miesięcy)", "body": "Monitoruj BMD (gęstość mineralna kości) — chroniczny deficyt E2 niesie ryzyko osteopenii. Lipidogram monitor, omega-3 + krill oil ochrona kardio."},
    {"label": "Po zaprzestaniu", "body": "E2 wraca do baseline w 24-48 h (odwracalne wiązanie). BRAK efektu odbicia. Faza PCT może się rozpocząć po klirensie estru."}
  ],
  "quality": {
    "pure": [
