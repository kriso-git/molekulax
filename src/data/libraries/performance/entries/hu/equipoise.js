...
export default {
  ...
  "keyInfo": [
    {"label": "Hatásmechanizmus", "value": "AR-agonista, Δ1-testosterone, AROMATIZÁL fél-Test arányban"},
    {"label": "Anabolikus:Androgén", "value": "100:50"},
    {"label": "Felezési idő", "value": "14 nap (Undecylenate ester)"},
    {"label": "Hatáskezdet", "value": "48-72 óra (IM)"},
    {"label": "Jogi státusz", "value": "Veterinary-only Rx (discontinued 2008), ma UGL; Schedule III"}
  ],
  ...
  "expectations": [
    {"label": "Első 2 hét", "body": "Akut hatás minimális, étvágy-stimuláns effekt 5-7 nap után érzékelhető. Lean mass-gyarapodás még nem."},
    {"label": "5-8. hét", "body": "Steady-state, lean mass-gyarapodás 2-3 kg, erő-növekedés 8-12% 1RM. Hemoglobin emelkedés ~10-15%."},
    {"label": "12. hét vége", "body": "Maximum effekt, 3-5 kg száraz lean mass. Lipid panel HDL csökkenés mérsékelt. Detection-window 5-6 hónap kezdődik."}
  ],
  "quality": {
    "pure": [
