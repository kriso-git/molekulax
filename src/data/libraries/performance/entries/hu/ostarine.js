...
export default {
  ...
  "keyInfo": [
    {"label": "Hatásmechanizmus", "value": "Non-szteroidal szelektív AR-modulátor (aril-propionamid). Erős AR-agonista izomban, mérsékelt prosztata."},
    {"label": "Anabolikus aktivitás (Dalton 2011)", "value": "1,3 kg lean body mass gain @ 3 mg/nap, 16 hét, cancer-cachexia-páciensek."},
    {"label": "Felezési idő", "value": "~24 h (orális)"},
    {"label": "Hatáskezdet", "value": "2-4 hét"},
    {"label": "Jogi státusz", "value": "Sosem volt FDA-jóváhagyott (Phase III POWER failed 2016). UGL 'research chemical'. WADA tiltott S1.2."}
  ],
  ...
  "expectations": [
    {"label": "Első 2 hét", "body": "Anekdotikus erő-növekedés mérsékelt, lean mass-változás MÉG nem mérhető."},
    {"label": "4-8. hét", "body": "Lean mass gain 1-3 kg (UGL-anekdoták 12,5-25 mg/nap), HPTA-szuppresszió kezdődik (LH/FSH ~30-50%)."},
    {"label": "8 hét vége", "body": "Maximum effekt (2-4 kg lean mass UGL), PCT-tervezés. Hepatikus monitor."}
  ],
  "quality": {
    "pure": [
