...
export default {
  ...
  "keyInfo": [
    {
      ...
      "value": "AR-agonista, 17α-metil-4-kloro-Δ1-T, NEM aromatizál"
    },
    {
    ...
    {
      "label": "Hatáskezdet",
      "value": "2-3 óra (orális)"
    },
    {
      "label": "Jogi státusz",
      "value": "Jenapharm Rx-szer (DE) megszüntetve 1994; UGL ma. Schedule III."
    }
  ],
  ...
  "expectations": [
    {
      "label": "Első hét",
      "body": "Akut hatás minimális. Erő-növekedés 3-5 nap után érzékelhető, lean mass-gyarapodás még nem."
    },
    {
      "label": "4-6. hét",
      "body": "Maximum lean mass-gyarapodás 3-5 kg, erő-növekedés 10-15% 1RM. Lipid panel HDL csökkenés mérsékelt (15-25%)."
    },
    {
      "label": "Post-ciklus",
      "body": "Lean mass-megőrzés relatíve jó (víz-vesztés minimális). Hepatikus recovery 4-6 hét. Detection window 12-18 hónap WADA-laborokban."
    }
  ],
  "quality": {
    "pure": [
