...
export default {
  ...
  "keyInfo": [
    {"label": "Hatásmechanizmus", "value": "Hypothalamic GPR54 (KISS1R) agonista → GnRH-pulse → LH/FSH → testicular Test"},
    {"label": "Adagolás", "value": "50-200 mcg SC every 90 min (pulse-pump) vagy 1-2 mg SC bolus daily (community-protokoll, limited efficacy)"},
    {"label": "Felezési idő", "value": "~28 perc (very short — pulsatility-pattern essentialis)"},
    {"label": "Hatáskezdet", "value": "LH/FSH-spike 1-2 óra SC után"},
    {"label": "Jogi státusz", "value": "NINCS FDA/EMA pharmaceutical-jóváhagyás; Imperial College London Phase II ongoing 2026, WADA S2 Peptide Hormones banned"}
  ],
  ...
  "expectations": [
    {"label": "1-2 óra SC után", "body": "LH-spike mérhető (~3-5x baseline emelkedés, Jayasena 2017 data). FSH-spike enyhébb (~2-3x). Test-emelkedés szérum-szinten ~6-12 óra delay-vel."},
    {"label": "24-48 óra", "body": "LH-szint visszaesik (rövid felezés). Test-emelkedés tartós ~2-3 napon át. Második dose-zal pulsatility-simulating effect kiterjedhet."},
    {"label": "Chronic-protokoll (pulse-pump, 1-2 hét)", "body": "HPG-tengely restart full physiological pattern. Endogén Test-recovery >50% baseline elérhető pituitár-szintű suppress-statusban."},
    {"label": "Bolus-DIY-protokoll", "body": "Limited efficacy — single LH-spike-onkénti dose, NEM chronic-axis-restart. SERM-PCT-replacement role NEM evidence-based jelenleg."}
  ],
  "quality": {
    "pure": [
