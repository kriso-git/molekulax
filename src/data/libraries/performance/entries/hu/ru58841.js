...
export default {
  ...
  "keyInfo": [
    ...
    },
    {
      ...
      "value": "5% oldat ethanol/propylene-glycol-ben, 0.5-1 mL napi 1x scalp-application"
    },
    {
      "label": "Felezési idő",
      "value": "Topikális minimális systemic abszorpció (claim), effect ~24 óra"
    },
    {
      "label": "Hatáskezdet",
      "value": "Scalp AR-blokád azonnal, hair-stabilization 3-6 hónap (in vivo data sparse)"
    },
    {
      "label": "Jogi státusz",
  ...
  "expectations": [
    {
      "label": "1. hét",
      "body": "Scalp-application tolerated (mild scalp-irritation lehet ethanol/PG-vehiculumtól). Systemic-effect minimális (claim)."
    },
    {
      "label": "3-6. hónap",
    ...
    },
    {
      ...
      "body": "Phase II terminálási evidence: systemic feminizing-effect possible (gynecomastia, sexual-dysfunction), különösen magasabb dose-on (5%+ oldat) vagy nagy scalp-area-application. **NINCS** long-term safety evidence."
    },
    {
      "label": "Leállítás után",
      "body": "Scalp AR-blokád 1-2 hét alatt elmúlik (in vivo data sparse). Hair-loss-acceleráció visszatér gyorsan."
    }
  ],
  "quality": {
    "pure": [
