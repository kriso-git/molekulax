...
export default {
  ...
  "shortDesc": "Methasterone (2α,17α-dimetil-DHT-származék). Erős orális prohormon, rapid izomtömeg-növelés magas hepatotoxicitási kockázattal.",
  ...
  "mechanism": "Az AR-receptoron közvetlen agonista. A 2α-metil + 17α-metil KETTŐS metabolikus blokk: a 2α-metil-csoport gátolja az aromatázt (NEM konvertál ösztrogénné), a 17α-metil-csoport a hepatikus first-pass clearance-t gátolja (orális biológiai hozzáférhetőség), de így prolongált cholesztatikus stresszt okoz a májon.",
  ...
  "detectionWindow": "4-6 hét vizelet (metilezett metabolitok: 17α-metil-5α-androsztán-3α-ol-17β-on, detektálható WADA-akkreditált laborban).",
  "benefits": [
    ...
    "Nincs aromatizáció, így nincs ösztrogén-mellékhatás (vízretenció, gyno)",
  ...
  "quickStart": [
    ...
    "Ha mégis használnák: max 4 hét ciklus, NIKADA tovább, hepatotoxicitás kumulatív",
    "Máj-támogató (TUDCA 500-750 mg/nap, NAC 1200 mg/nap) kötelező a teljes ciklus alatt",
  ...
  "expectations": [
    ...
    {
      "label": "4. hét vége",
      "body": "Maximum izomtömeg-növekedés, de a hepatotoxicitás gyakran ekkor manifesztálódik (ALT/AST 3-5x emelkedés, ritkán cholesztatikus jaundice). KÖTELEZŐ ciklus-megszakítás."
    }
  ],
  "quality": {
    "pure": [
    ...
    "caution": [
      ...
      "Letargia, alvászavar, libidó-ingadozás",
      "Akut vesekárosodás (AKI): Nasr 2009 case report (PMID 19288206) Methasterone-indukált cholesztatikus jaundice + AKI-t dokumentált (kreatinin emelkedés, cystatin-C, oliguria). Hepato-renal szindróma kockázat — kreatinin-monitoring mid-cycle KÖTELEZŐ."
    ],
    "avoid": [
      ...
      "Prosztata- vagy emlőkarcinóma (androgén-érzékeny tumor) abszolút kontraindikáció",
      "Tervezett apaság (súlyos HPTA-szuppresszió, hosszú recovery)",
  ...
  "faq": [
    ...
    },
    {
      ...
      "a": "NEM. A 17α-metil-csoport kumulatív hepatotoxicitása miatt a Superdrol cruise tilos. Maximum 4 hét ciklus, utána minimum 12 hét OFF (a máj-recovery-hez)."
    },
    {
  ...
  "bloodwork": {
    "preCycle": {
      ...
      "purpose": "Hepatikus baseline kritikus. Bármilyen meglévő máj-zavar (zsírmáj, ALT/AST baseline emelt) abszolút kontraindikáció."
    },
    "midCycle": {
      "label": "Ciklus közben",
      "timing": "2. hét végén (a 4 hetes ciklus felénél)",
      ...
      "purpose": "Vész-detektálás. ALT/AST >3x felső normál vagy bilirubin emelkedés AZONNALI ciklus-megszakítás indikáció. HDL <25 mg/dL kardiovaszkuláris riasztó."
    },
    "postCycle": {
