...
export default {
  ...
  "keyInfo": [
    {"label": "Hatásmechanizmus", "value": "Tiszta transz-izomer clomiphene, ER-α antagonist pituiter, NINCS zuclomiphene-mood-effect"},
    {"label": "Adagolás (PCT vagy hipogonadizmus)", "value": "12.5-25 mg/nap, reggeli"},
    {"label": "Felezési idő", "value": "~5 nap (tisztább mint Clomid mixed t1/2)"},
    {"label": "Hatáskezdet", "value": "LH-emelkedés 24-72 óra, Test-recovery 2-4 hét"},
    {"label": "Jogi státusz", "value": "NEM FDA-jóváhagyott (CRL 2016), US-compounding + EU-research-pharm + UGL"}
  ],
  ...
  "expectations": [
    {"label": "1-2. hét", "body": "LH/FSH-emelkedés mérhető, korai Test-recovery. Hangulati profil tiszta — NINCS Clomid-style 'érzelmes' fluktuáció."},
    {"label": "3-4. hét", "body": "Test-recovery megerősíthető (Phase III-on T < 300 → T > 450 ng/dL átlagosan). Libido visszatér, energia javul."},
    {"label": "5-6. hét", "body": "PCT vége vagy chronic-dose stabilizáció (TRT-alternatíva). Lipid-panel javul (HDL-emelkedés)."},
    {"label": "Post-protocol", "body": "Spermatogenesis-recovery 2-3 hónap alatt confirm-able sperm-analysis-szel. Ha LH/FSH < 50% baseline → szakorvos."}
  ],
  "quality": {
    "pure": [
  ...
  "faq": [
    {"q": "Miért nem FDA-jóváhagyott Enclomiphene?", "a": "Repros Therapeutics 2014-ben submisszionálta a Phase III ZA-301 + ZA-302 adatokat (T <300 → T >450 ng/dL primer végpont elérve mind a 12.5 és 25 mg/nap dose-on). FDA Complete Response Letter (CRL) 2016 — további efikacia + biztonsági adatokat kért (hosszú távú kardio-, lipid-, fertility-data). Repros pénzügyi gondok miatt soha nem nyújtotta be újra; 2018 csőd. A molekula továbbra is hatékony, de regulatory orphan."},
    {"q": "Enclomiphene vs Clomid — érdemes-e fizetni 10x annyit?", "a": "Klinikailag tisztább profil — kevesebb hangulati labilitás, kevesebb vision-side. DE: $200/havi compounding ár vs $5/box Clomid. Indok jó: (1) Clomid-intolerancia hangulati zavar miatt; (2) hosszú távú TRT-alternatíva fertility-preservation cél esetén; (3) AAS-PCT clean-profil emphasis. Standard short-PCT-re Clomid költséghatékonyabb."},
    {"q": "Beszerzhetőség 2026-ban?", "a": "US: compounding pharmacy Rx-alapon (BodyLogicMD, OptimaleMD, Defy Medical, Marek Health, Empower Pharmacy). EU: research-pharmacy + UGL liquid (research-chemical labeling). HU/PL pharmacy NEM elérhető. UGL-rizikó magas — gyakran clomiphene-mixed-isomer hibridizálva 'enclomiphene'-ként árulják; HPLC-tesztelt forrás kötelező."},
    {"q": "Long-term TRT-alternatíva — biztonságos?", "a": "Wiehle 2018 Phase III adatból max 3 hónap requires; long-term (>1 év) clinical safety adat hiányos. Hypothetical előny vs TRT: spermatogenesis-preservation, természetes intra-testicular testosterone-produkció megőrzése. Hátrány: long-term ER-modulation hatás csontra, kardióra, prosztatára nem teljesen ismert. Off-label kontextusban orvosi felügyelet kötelező (3 havi bloodwork)."}
  ],
