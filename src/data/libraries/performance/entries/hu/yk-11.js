...
export default {
  ...
  "keyInfo": [
    {
      ...
      "value": "Steroidal SARM (5α-androsztán-váz) + myostatin-pathway inhibitor (follistatin-felregulálás)"
    },
    {
      "label": "Klinikai precedens",
      "value": "Phase 0 in vitro only (Kanno 2011/2013, Yatsu 2018). Nincs Phase I/II/III emberben."
    },
    {
      "label": "Anabolikus aktivitás",
      "value": "AR-binding ~50% testosterone (in vitro) + myostatin-blokk dual-effekt"
    },
    {
      "label": "Felezési idő",
      "value": "~6-10 h (orális, becsült)"
    },
    {
      "label": "Jogi státusz",
  ...
  "expectations": [
    {
      "label": "Első 1-2 hét",
      "body": "Anekdotikus erő-növekedés. Klinikai precedens nincs."
    },
    {
      "label": "4-6. hét",
      "body": "Anekdotikus lean mass gain 2-4 kg + 'jól-érzem-magam-natural-cap-feletti' UGL-szubjektív jelentés. Hepatikus markerek emelkedhetnek (ALT 1,5-3x)."
    },
    {
      "label": "6-8 hét vége",
      "body": "Maximum effekt (3-5 kg lean mass), HPTA-szuppresszió teljes, PCT-tervezés. Hepatikus monitor kritikus."
    }
  ],
  "quality": {
    "pure": [
  ...
  "anecdote": "Az anekdotikus beszámolók szerint a YK-11 gyors növekedést produkál az izomteltségben, az erőben, a glikogén-tárolásban, az agresszióban és az általános vizuális sűrűségben. A vegyület follisztatint felülszabályozó hatását teszik felelőssé a felhasználók által tapasztalt izomgyarapodás nagy részéért. Sok közösségi beszámoló a YK-11-et inkább száraz orális anabolikumként írja le, mint tipikus SARM-ként, jellegzetesen száraz vizuális karakterrel. A jelentett mellékhatások közé tartozik az agresszió, álmatlanság, ingerlékenység és libidó-ingadozás. A YK-11-re gyakran alkalmazott 'miosztatin-inhibitor' címke mechanisztikusan pontatlan — a valódi gyógyszeripari minőségű miosztatin-gátlás monoklonális antitesteket vagy géncélzott terápiát igényel. A YK-11 nem közvetlenül gátolja a miosztatint; inkább úgy tűnik, hogy a follisztatin felülszabályozásán keresztül befolyásolja az útvonalat. Összességében a közösségi beszámolók gyors méret- és erőgyarapodást és figyelemre méltó hatékonyságot jelentenek egy SARM esetében, miközben érdemi elméleti és klinikai aggályokat is jeleznek — beleértve a 17α-szteroidszerű hepatotoxicitási profilt és a HPTA-szuppressziót. Végezz saját kutatást."
}
