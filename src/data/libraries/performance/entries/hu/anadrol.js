...
export default {
  ...
  "keyInfo": [
    {"label": "Hatásmechanizmus", "value": "AR-agonista + direkt ER-agonista (paradox)"},
    {"label": "Anabolikus:Androgén", "value": "320:45"},
    {"label": "Felezési idő", "value": "8-9 óra (orális)"},
    {"label": "Hatáskezdet", "value": "1-2 óra (orális)"},
    {"label": "Jogi státusz", "value": "FDA Rx (Anadrol-50), Schedule III, WADA tiltott"}
  ],
  ...
  "expectations": [
    {"label": "Első hét", "body": "Akut súlygyarapodás 2-4 kg (víz + glikogén). Erő-növekedés markáns, edzés-pumpa drasztikus."},
    {"label": "3-4. hét", "body": "Maximum bulking effekt. 8-12 kg össz-súlygyarapodás. ALT/AST 3-5x felső normál gyakran ekkor manifesztálódik — KÖTELEZŐ ciklus-megszakítás 4. hét végén."},
    {"label": "Post-ciklus", "body": "Súly-vesztés 30-50% (víz-elvesztés a leállás után 2-3 héten belül). Pure lean mass-megőrzés ~4-6 kg dokumentált. Hepatikus recovery 4-8 hét."}
  ],
  "quality": {
    "pure": [
