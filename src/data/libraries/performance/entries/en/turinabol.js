...
export default {
  "id": "turinabol",
  "sideEffects": [
    { "hu": "HPTA-szuppresszió: a természetes tesztoszteron-termelés leáll (LH/FSH visszaszorítás), tesztisz-atrófia, csökkent libidó és fertilitás; PCT nélkül elhúzódó hipogonadizmus.", "en": "HPTA suppression: endogenous testosterone production shuts down (LH/FSH suppression), testicular atrophy, reduced libido and fertility; prolonged hypogonadism without PCT.", "pl": "Supresja HPTA: produkcja endogennego testosteronu zostaje zahamowana (supresja LH/FSH), atrofia jąder, obniżone libido i płodność; przedłużony hipogonadyzm bez PCT." },
    { "hu": "Lipidprofil-romlás: HDL-koleszterin mérsékelt-jelentős csökkenése (15-25%) és LDL-emelkedés, ami orális 17α-alkilált AAS-eknél kifejezett; hosszú távon ateroszklerózis-kockázat.", "en": "Adverse lipid changes: moderate-to-marked HDL drop (15-25%) and LDL rise, pronounced with oral 17alpha-alkylated AAS; long-term atherosclerosis risk.", "pl": "Niekorzystne zmiany lipidowe: umiarkowany do znacznego spadek HDL (15-25%) i wzrost LDL, wyraźny przy doustnych AAS 17alfa-alkilowanych; długoterminowe ryzyko miażdżycy." },
    { "hu": "Hepatotoxicitás (orális 17α-metil): ALT/AST 2-3-szoros emelkedése 6+ hetes ciklusban; klinikailag enyhébb mint Dianabol/Anadrol (4-kloro-védettség), de a máj-stressz valós, cholestasis és peliosis hepatis ritkán előfordulhat.", "en": "Hepatotoxicity (oral 17alpha-methyl): ALT/AST elevation 2-3x over 6+ week cycles; clinically milder than Dianabol/Anadrol (4-chloro protection), but liver stress is real, with rare cholestasis and peliosis hepatis.", "pl": "Hepatotoksyczność (doustny 17alfa-metyl): wzrost ALT/AST 2-3x przy cyklach 6+ tygodni; klinicznie łagodniejszy niż Dianabol/Anadrol (ochrona 4-chloro), ale stres wątrobowy jest realny, rzadko cholestaza i peliosis hepatis." },
    { "hu": "Virilizáció nőknél: az alacsony androgén-arány ellenére >10 mg/nap és hosszabb expozíció IRREVERZIBILIS hangmélyülést, klitorisz-hipertrófiát, hirsutizmust okozhat (dokumentált NDK-eset: Heidi/Andreas Krieger).", "en": "Virilization in women: despite the low androgenic ratio, >10 mg/day and longer exposure can cause IRREVERSIBLE voice deepening, clitoral enlargement, hirsutism (documented GDR case: Heidi/Andreas Krieger).", "pl": "Wirylizacja u kobiet: mimo niskiego współczynnika androgennego, >10 mg/dobę i dłuższa ekspozycja mogą powodować NIEODWRACALNE pogłębienie głosu, przerost łechtaczki, hirsutyzm (udokumentowany przypadek NRD: Heidi/Andreas Krieger)." },
    { "hu": "Vérnyomás-emelkedés: hipertónia gyakori AAS-ciklus alatt; a HDL-csökkenéssel és hematokrit-változással együtt fokozza a kardiovaszkuláris terhelést.", "en": "Elevated blood pressure: hypertension is common during AAS cycles; combined with HDL decline and hematocrit changes it increases cardiovascular load.", "pl": "Podwyższone ciśnienie krwi: nadciśnienie jest częste podczas cykli AAS; w połączeniu ze spadkiem HDL i zmianami hematokrytu zwiększa obciążenie sercowo-naczyniowe." },
    { "hu": "Pszichiátriai hatások: irritabilitás, agresszió, hangulat-ingadozás ciklus alatt, valamint depresszió és csökkent libidó a leállás/PCT időszakában; AAS-függőség kialakulhat.", "en": "Psychiatric effects: irritability, aggression, mood swings on cycle, plus depression and low libido during cessation/PCT; AAS dependence can develop.", "pl": "Efekty psychiatryczne: drażliwość, agresja, wahania nastroju w trakcie cyklu, oraz depresja i niskie libido podczas odstawienia/PCT; może rozwinąć się uzależnienie od AAS." },
    { "hu": "Androgén bőrhatások: akne és zsíros bőr előfordulhat; a fejbőr-hajritkulás kockázata viszont alacsony, mert a Turinabol nem 5α-reduktáz-szubsztrát (nincs DHT-átalakulás).", "en": "Androgenic skin effects: acne and oily skin can occur; scalp hair-loss risk is low, however, since Turinabol is not a 5alpha-reductase substrate (no DHT conversion).", "pl": "Androgenne efekty skórne: trądzik i przetłuszczanie skóry mogą wystąpić; ryzyko utraty włosów jest jednak niskie, ponieważ Turinabol nie jest substratem 5alfa-reduktazy (brak konwersji do DHT)." }
  ],
  "contraindications": [
    { "hu": "Terhesség és szoptatás: a virilizáció és magzati fejlődési rendellenességek kockázata miatt abszolút ellenjavallt (az NDK-program neonatális rendellenességeket dokumentált a dopping-anyák gyermekeinél).", "en": "Pregnancy and breastfeeding: absolutely contraindicated due to virilization and risk of fetal developmental abnormalities (the GDR program documented neonatal abnormalities in children of doped mothers).", "pl": "Ciąża i karmienie piersią: bezwzględnie przeciwwskazane ze względu na wirylizację i ryzyko wad rozwojowych płodu (program NRD udokumentował wady noworodków u dzieci dopingowanych matek)." },
    { "hu": "Bármilyen máj-betegség vagy emelkedett májenzimek: a 17α-metil-csoport hepatikus stresszt ad, ezért meglévő májkárosodásnál nem használható.", "en": "Any liver disease or elevated liver enzymes: the 17alpha-methyl group adds hepatic stress, so it must not be used with pre-existing liver impairment.", "pl": "Jakakolwiek choroba wątroby lub podwyższone enzymy wątrobowe: grupa 17alfa-metylowa obciąża wątrobę, więc nie należy stosować przy istniejącym uszkodzeniu wątroby." },
    { "hu": "Kardiovaszkuláris betegség, hipertónia vagy kedvezőtlen lipidprofil: a HDL-csökkenés és vérnyomás-emelkedés súlyosbítja a meglévő szív-érrendszeri kockázatot.", "en": "Cardiovascular disease, hypertension or adverse lipid profile: HDL decline and raised blood pressure worsen existing cardiovascular risk.", "pl": "Choroba sercowo-naczyniowa, nadciśnienie lub niekorzystny profil lipidowy: spadek HDL i wzrost ciśnienia pogarszają istniejące ryzyko sercowo-naczyniowe." },
    { "hu": "Hormonérzékeny daganatok (prosztata- vagy emlőkarcinóma): androgén-receptor-agonistaként ellenjavallt.", "en": "Hormone-sensitive tumors (prostate or breast carcinoma): contraindicated as an androgen-receptor agonist.", "pl": "Nowotwory hormonozależne (rak prostaty lub piersi): przeciwwskazany jako agonista receptora androgenowego." },
    { "hu": "WADA-tesztelt sportolók: extra hosszú detection-window (vizeletből 12-18 hónap a Sobolevsky-Rodchenkov 2012 hosszú-távú metabolitok miatt); karrier-szakasztól függetlenül kerülendő.", "en": "WADA-tested athletes: extra-long detection window (12-18 months in urine due to Sobolevsky-Rodchenkov 2012 long-term metabolites); to be avoided at any career stage.", "pl": "Sportowcy testowani przez WADA: bardzo długie okno wykrywalności (12-18 miesięcy w moczu z powodu długoterminowych metabolitów Sobolevsky-Rodchenkov 2012); należy unikać na każdym etapie kariery." },
    { "hu": "Pszichiátriai prediszpozíció (depresszió, bipoláris zavar, agresszió-kontroll problémák): a hangulati mellékhatások és a leállási depresszió súlyosbíthatják.", "en": "Psychiatric predisposition (depression, bipolar disorder, aggression-control problems): mood side effects and post-cycle depression can exacerbate it.", "pl": "Predyspozycja psychiatryczna (depresja, choroba dwubiegunowa, problemy z kontrolą agresji): efekty nastrojowe i depresja po cyklu mogą ją nasilić." },
    { "hu": "Serdülők és növésben lévő fiatalok: az AAS korai epifízis-záródást és visszafordíthatatlan fejlődési hatásokat okozhat.", "en": "Adolescents and growing youths: AAS can cause premature epiphyseal closure and irreversible developmental effects.", "pl": "Młodzież i osoby w fazie wzrostu: AAS mogą powodować przedwczesne zamknięcie nasad kości i nieodwracalne skutki rozwojowe." }
  ],
  ...
  "keyInfo": [
    {
      "label": "Mechanism",
      "value": "AR agonist, 17α-methyl-4-chloro-Δ1-T, NOT aromatized"
    },
    {
    ...
    {
      "label": "Legal status",
      "value": "Jenapharm Rx (DE) discontinued 1994; UGL today. Schedule III."
    }
  ],
  ...
  "expectations": [
    {
      "label": "First week",
      "body": "Acute effect minimal. Strength gain perceptible after 3-5 days, lean mass gain not yet."
    },
    {
      "label": "Week 4-6",
      "body": "Maximum lean mass gain 3-5 kg, strength gain 10-15% 1RM. Lipid panel HDL drop moderate (15-25%)."
    },
    {
      "label": "Post-cycle",
      "body": "Lean mass preservation relatively good (water loss minimal). Hepatic recovery 4-6 weeks. Detection window 12-18 months at WADA labs."
    }
  ],
  "quality": {
    "pure": [
  ...
  "faq": [
    ...
    },
    {
      ...
      "a": "GDR rowing team's 1968-1988 Olympic dominance (~30 medals) was largely Turinabol-driven (Franke-Berendonk 1997 PMID 9302891). Mechanism: 17α-methyl AAS erythropoietic effect + neuromuscular efficiency increase + recovery acceleration. WADA-banned in modern endurance sports, and Schänzer 2006 metabolites bring extra-detection risk."
    }
  ],
  "related": [
    "dianabol-info",
