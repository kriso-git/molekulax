...
export default {
  "id": "winstrol-info",
  "sideEffects": [
    { "hu": "Hepatotoxicitás: 17α-alkilált molekula mindkét formában (orális ÉS vizes IM) máj-stresszt okoz, ALT/AST 2-4x emelkedés, cholestasis, ritkán peliosis hepatis. A depot IM NEM kíméletesebb, ugyanaz a 17α-metil molekula hat szisztémásan.", "en": "Hepatotoxicity: the 17α-alkylated molecule stresses the liver in BOTH forms (oral and aqueous IM), with ALT/AST rising 2-4x, cholestasis, rarely peliosis hepatis. The depot IM is NOT gentler, the same 17α-methyl molecule acts systemically.", "pl": "Hepatotoksyczność: cząsteczka 17α-alkilowana obciąża wątrobę w OBU formach (doustnej i wodnej IM), ALT/AST rośnie 2-4x, cholestaza, rzadko peliosis hepatis. Depot IM NIE jest łagodniejszy, ta sama cząsteczka 17α-metylu działa systemowo." },
    { "hu": "Drasztikus lipid-romlás: a HDL gyakran >30%-kal csökken baseline-hez képest, az LDL emelkedik (Bausserman 1997). A stanozolol az egyik legkeményebb AAS a lipidprofilra, fokozott atherosclerosis- és szív-érrendszeri kockázat.", "en": "Severe lipid deterioration: HDL often drops >30% from baseline and LDL rises (Bausserman 1997). Stanozolol is one of the harshest AAS on lipids, raising atherosclerosis and cardiovascular risk.", "pl": "Poważne pogorszenie lipidów: HDL często spada >30% względem wartości wyjściowej, a LDL rośnie (Bausserman 1997). Stanozolol to jeden z najostrzejszych AAS dla lipidów, zwiększa ryzyko miażdżycy i sercowo-naczyniowe." },
    { "hu": "Androgén mellékhatások: akne, zsíros bőr, fejtetői hajritkulás (androgenetikus alopecia hajlamosaknál). DHT-származékként erősen androgén a 320:30 arány ellenére, nem aromatizál, így nincs ösztrogén-puffer.", "en": "Androgenic effects: acne, oily skin, crown hair thinning (androgenetic alopecia in predisposed users). As a DHT derivative it is strongly androgenic despite the 320:30 ratio, and it does not aromatize, so there is no estrogen buffer.", "pl": "Efekty androgenne: trądzik, przetłuszczająca się skóra, przerzedzenie włosów na czubku głowy (łysienie androgenowe u osób predysponowanych). Jako pochodna DHT jest silnie androgenny mimo stosunku 320:30 i nie aromatyzuje, więc brak bufora estrogenowego." },
    { "hu": "Ínszakadás-veszély (Liow 1995): a stanozolol gyorsabban növeli az izomerőt, mint ahogy az ínkollagén keresztkötés-érettsége követni tudja, ez dokumentált ín- és ínszalag-szakadásokat okozott, különösen sprinter/explosive sportokban.", "en": "Tendon rupture risk (Liow 1995): stanozolol increases muscle strength faster than tendon collagen cross-link maturity can keep up, causing documented tendon and ligament ruptures, especially in sprint/explosive sports.", "pl": "Ryzyko zerwania ścięgna (Liow 1995): stanozolol zwiększa siłę mięśni szybciej niż dojrzewają wiązania krzyżowe kolagenu ścięgna, co powodowało udokumentowane zerwania ścięgien i więzadeł, zwłaszcza w sportach sprinterskich/eksplozywnych." },
    { "hu": "Ízületi szárazság és fájdalom (\"Winstrol joint pain\"): a vegyület csökkenti az ízületi folyadékot, ami szubjektíven kínzó, száraz, recsegő ízületeket okoz, fokozva a sérülés-kockázatot.", "en": "Joint dryness and pain (\"Winstrol joint pain\"): the compound reduces synovial fluid, producing subjectively painful, dry, creaking joints and raising injury risk.", "pl": "Suchość i ból stawów (\"Winstrol joint pain\"): związek zmniejsza płyn maziowy, powodując subiektywnie bolesne, suche, trzeszczące stawy i zwiększając ryzyko kontuzji." },
    { "hu": "HPTA-szuppresszió: a saját tesztoszteron-termelés és spermiogenezis leáll, csökkent libidó, here-zsugorodás és átmeneti meddőség. PCT (post-cycle therapy) szükséges a helyreállításhoz.", "en": "HPTA suppression: endogenous testosterone production and spermatogenesis shut down, with reduced libido, testicular atrophy and temporary infertility. PCT (post-cycle therapy) is needed for recovery.", "pl": "Supresja HPTA: produkcja endogennego testosteronu i spermatogeneza zatrzymują się, obniżone libido, zanik jąder i przejściowa niepłodność. PCT (terapia po cyklu) jest konieczna do regeneracji." },
    { "hu": "Virilizáció nőknél: mély hang, arc- és testszőrösödés, klitorisz-megnagyobbodás és menstruációs zavar, melyek részben visszafordíthatatlanok lehetnek. A női dózis ezért szigorúan max 5-10 mg/nap.", "en": "Virilization in women: voice deepening, facial and body hair growth, clitoral enlargement and menstrual disruption, some of which can be irreversible. Female dosing is therefore strictly capped at 5-10 mg/day.", "pl": "Wirylizacja u kobiet: obniżenie głosu, owłosienie twarzy i ciała, powiększenie łechtaczki i zaburzenia miesiączkowania, częściowo nieodwracalne. Dawka dla kobiet jest dlatego ściśle ograniczona do 5-10 mg/dzień." },
    { "hu": "Injekciós (vizes IM) forma-specifikus: a mikrokristályok fizikailag irritálják az izomszövetet, nagyon fájdalmas injekciót (PIP), ödémát és abszcessz-veszélyt okozva, aszeptikus technikát igényelve.", "en": "Injectable (aqueous IM) form-specific: the microcrystals physically irritate muscle tissue, causing very painful injection (PIP), edema and abscess risk, requiring aseptic technique.", "pl": "Specyficzne dla formy iniekcyjnej (wodnej IM): mikrokryształy fizycznie drażnią tkankę mięśniową, powodując bardzo bolesną iniekcję (PIP), obrzęk i ryzyko ropnia, wymagając aseptycznej techniki." }
  ],
  "contraindications": [
    { "hu": "Bármilyen meglévő máj-betegség (zsírmáj, hepatitis, cholestasis, korábbi májkárosodás): a 17α-alkilált stanozolol mindkét formában jelentősen hepatotoxikus, súlyosbíthat egy fennálló máj-állapotot.", "en": "Any pre-existing liver disease (fatty liver, hepatitis, cholestasis, prior liver injury): 17α-alkylated stanozolol is markedly hepatotoxic in both forms and can worsen an existing liver condition.", "pl": "Jakakolwiek istniejąca choroba wątroby (stłuszczenie, zapalenie wątroby, cholestaza, wcześniejsze uszkodzenie): 17α-alkilowany stanozolol jest wyraźnie hepatotoksyczny w obu formach i może pogorszyć istniejący stan wątroby." },
    { "hu": "Terhesség és szoptatás: az androgén hatás virilizálja a magzatot (különösen a női magzatot), súlyos fejlődési károsodás kockázatával. Abszolút ellenjavallat.", "en": "Pregnancy and breastfeeding: the androgenic action virilizes the fetus (especially a female fetus), with serious developmental harm risk. Absolute contraindication.", "pl": "Ciąża i karmienie piersią: działanie androgenne wirylizuje płód (zwłaszcza płód żeński), z ryzykiem poważnych wad rozwojowych. Bezwzględne przeciwwskazanie." },
    { "hu": "Fennálló dyslipidaemia vagy szív-érrendszeri betegség (koszorúér-betegség, korábbi infarktus, kontrollálatlan magas vérnyomás): a HDL drasztikus csökkenése és az LDL emelkedése jelentősen rontja a kardiovaszkuláris kockázatot.", "en": "Existing dyslipidemia or cardiovascular disease (coronary artery disease, prior heart attack, uncontrolled hypertension): the drastic HDL drop and LDL rise markedly worsen cardiovascular risk.", "pl": "Istniejąca dyslipidemia lub choroba sercowo-naczyniowa (choroba wieńcowa, wcześniejszy zawał, niekontrolowane nadciśnienie): drastyczny spadek HDL i wzrost LDL znacznie pogarszają ryzyko sercowo-naczyniowe." },
    { "hu": "Prosztata-karcinóma vagy emlőrák (férfiaknál): mint androgén, az AAS hormonérzékeny daganatok progresszióját stimulálhatja. Ismert vagy gyanított ilyen daganat esetén ellenjavallt.", "en": "Prostate carcinoma or male breast cancer: as an androgen, AAS can stimulate progression of hormone-sensitive tumors. Contraindicated with known or suspected such cancer.", "pl": "Rak prostaty lub rak piersi (u mężczyzn): jako androgen, AAS może stymulować progresję nowotworów hormonozależnych. Przeciwwskazany przy znanym lub podejrzewanym takim nowotworze." },
    { "hu": "Egyidejű warfarin/véralvadásgátló kezelés vagy alkohol- és paracetamol-fogyasztás: a stanozolol potencírozza a warfarin hatását (vérzés-veszély), a máj-toxikus szerek pedig összeadódó hepatotoxicitást okoznak.", "en": "Concurrent warfarin/anticoagulant therapy or alcohol and paracetamol use: stanozolol potentiates warfarin (bleeding risk), and hepatotoxic agents compound the liver toxicity.", "pl": "Jednoczesna terapia warfaryną/antykoagulantami lub spożycie alkoholu i paracetamolu: stanozolol nasila działanie warfaryny (ryzyko krwawienia), a środki hepatotoksyczne sumują toksyczność wątrobową." },
    { "hu": "Más 17α-alkilált orális AAS (Anadrol, Dianabol, Superdrol, Anavar) egyidejű használata: a kombinált first-pass máj-terhelés extrém, súlyos hepatotoxicitást és cholestasist okozhat.", "en": "Concurrent use of other 17α-alkylated oral AAS (Anadrol, Dianabol, Superdrol, Anavar): the combined first-pass liver load is extreme and can cause severe hepatotoxicity and cholestasis.", "pl": "Jednoczesne stosowanie innych 17α-alkilowanych doustnych AAS (Anadrol, Dianabol, Superdrol, Anavar): połączone obciążenie wątroby first-pass jest ekstremalne i może powodować ciężką hepatotoksyczność i cholestazę." },
    { "hu": "Sprinter/explosive sportoló aktív edzésciklusban: a Liow 1995 által dokumentált ínszakadás-veszély fokozott, mert az izomerő gyorsabban nő, mint az ín teherbírása.", "en": "Sprint/explosive athlete in an active training cycle: the tendon rupture risk documented by Liow 1995 is heightened because muscle strength rises faster than tendon load capacity.", "pl": "Sportowiec sprinterski/eksplozywny w aktywnym cyklu treningowym: ryzyko zerwania ścięgna udokumentowane przez Liow 1995 jest podwyższone, ponieważ siła mięśni rośnie szybciej niż wytrzymałość ścięgna." }
  ],
  "name": "Winstrol",
