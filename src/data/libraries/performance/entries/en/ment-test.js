...
export default {
  "id": "ment-test",
  "sideEffects": [
    { "hu": "Erős HPTA-szuppresszió: a here saját tesztoszteron- és spermatermelése leáll, a fogamzóképesség visszaesik (a MENT eredetileg férfi-fogamzásgátló-jelölt volt, épp emiatt); a felépülés lassú és nem mindig teljes.", "en": "Strong HPTA suppression: endogenous testosterone and sperm production shut down and fertility drops (MENT was originally a male contraceptive candidate precisely for this), with slow and not always complete recovery.", "pl": "Silna supresja HPTA: produkcja własnego testosteronu i plemników zostaje wyłączona, a płodność spada (MENT był pierwotnie kandydatem na męski środek antykoncepcyjny właśnie z tego powodu); powrót do normy jest powolny i nie zawsze pełny." },
    { "hu": "Prolaktin-emelkedés a 19-nor progesztogén aktivitás miatt: csökkent libidó, erekciós zavar (deca-dick-szerű hatás), tejcsorgás és progesztogén-vezérelt gynecomastia, akkor is, ha az ösztrogén alacsony.", "en": "Prolactin elevation from the 19-nor progestogenic activity: lowered libido, erectile dysfunction (a deca-dick-like effect), nipple discharge and progestogen-driven gynecomastia even when estrogen is low.", "pl": "Wzrost prolaktyny z powodu progestagennej aktywności 19-nor: obniżone libido, zaburzenia erekcji (efekt typu deca-dick), wyciek z brodawek i ginekomastia napędzana progestagenem, nawet przy niskim estrogenie." },
    { "hu": "Kedvezőtlen lipidprofil és kardiovaszkuláris terhelés: a HDL (jó koleszterin) mérsékelten-erősen csökken, az LDL nőhet, ami tartós használatnál érelmeszesedési és szívkockázatot jelent.", "en": "Adverse lipid profile and cardiovascular strain: HDL (good cholesterol) drops moderately to markedly and LDL can rise, raising atherosclerotic and cardiac risk with prolonged use.", "pl": "Niekorzystny profil lipidowy i obciążenie sercowo-naczyniowe: HDL (dobry cholesterol) spada umiarkowanie do znacznie, LDL może rosnąć, co zwiększa ryzyko miażdżycowe i sercowe przy długim stosowaniu." },
    { "hu": "Ösztrogénhatás aromatizációból: a MENT 7α-metilösztradiollá aromatizál (gyengébb, mint a sima ösztradiol, de nem nulla) – vízvisszatartás, vérnyomás-emelkedés, ösztrogén-vezérelt gynecomastia, főleg a Test-tartalmú mixture variánsoknál.", "en": "Estrogenic effects from aromatization: MENT aromatizes to 7α-methylestradiol (weaker than plain estradiol but not zero) causing water retention, raised blood pressure and estrogen-driven gynecomastia, especially in the Test-containing mixture variants.", "pl": "Działanie estrogenne z aromatyzacji: MENT aromatyzuje do 7α-metyloestradiolu (słabszego niż czysty estradiol, ale nie zerowego), powodując zatrzymanie wody, wzrost ciśnienia i ginekomastię napędzaną estrogenem, zwłaszcza w wariantach mieszanki zawierających Test." },
    { "hu": "Hangulati és pszichés hatások: ingerlékenység, agresszió, alvászavar, és a progesztogén/prolaktin aktivitás miatt ritka esetekben depresszív epizódok – fokozott rizikó meglévő pszichiátriai hajlamnál.", "en": "Mood and psychiatric effects: irritability, aggression, sleep disturbance, and rarely depressive episodes linked to the progestogenic/prolactin activity, with increased risk in those with pre-existing psychiatric predisposition.", "pl": "Efekty nastrojowe i psychiczne: drażliwość, agresja, zaburzenia snu oraz rzadko epizody depresyjne związane z aktywnością progestagenną/prolaktynową, ze zwiększonym ryzykiem u osób z istniejącą predyspozycją psychiatryczną." },
    { "hu": "Androgén bőr- és hajhatások: akne, zsíros bőr, fokozott testszőrzet, és hajlamosaknál fejtetői hajhullás – a MENT nem alakul DHT-vá, így a fejtetői és prosztata-androgén hatás enyhébb, mint a tesztoszteroné, de nem szűnik meg.", "en": "Androgenic skin and hair effects: acne, oily skin, increased body hair and scalp hair loss in predisposed users; MENT does not convert to DHT, so scalp and prostate androgen effects are milder than testosterone but not absent.", "pl": "Androgenne efekty skórne i włosowe: trądzik, przetłuszczona skóra, nadmierne owłosienie ciała i wypadanie włosów na czubku głowy u osób predysponowanych; MENT nie konwertuje do DHT, więc działanie androgenne na skórę głowy i prostatę jest łagodniejsze niż testosteronu, ale nieobecne." },
    { "hu": "Injekciós helyi reakció (PIP, fájdalom, duzzanat, gyulladás) – kifejezettebb a rövid Acetát-mixture-nél (alacsonyabb oldhatóság, gyakori, akár napi szúrás), enyhébb a lassú Enantát-mixture-nél.", "en": "Injection-site reaction (PIP, pain, swelling, inflammation) more pronounced with the short Acetate mixture (lower solubility, frequent, even daily injections) and milder with the slow Enanthate mixture.", "pl": "Reakcja w miejscu wstrzyknięcia (PIP, ból, obrzęk, stan zapalny) bardziej nasilona przy krótkiej mieszance Acetate (niższa rozpuszczalność, częste, nawet codzienne iniekcje) i łagodniejsza przy wolnej mieszance Enanthate." },
    { "hu": "Vörösvértest-szám és hematokrit emelkedése (mint az androgéneknél általában) – sűrűbb vér, ami trombózis- és vérnyomás-kockázatot növelhet, főleg tartós, magasabb dózisú használatnál.", "en": "Raised red blood cell count and hematocrit (as with androgens generally) thickening the blood and potentially increasing thrombosis and blood-pressure risk, especially with prolonged higher-dose use.", "pl": "Podwyższona liczba krwinek czerwonych i hematokryt (jak przy androgenach ogólnie), zagęszczające krew i potencjalnie zwiększające ryzyko zakrzepicy i ciśnienia, zwłaszcza przy długim stosowaniu wyższych dawek." }
  ],
  "contraindications": [
    { "hu": "Nők, különösen terhesség vagy annak lehetősége esetén: a MENT rendkívül erős androgén, gyors és nagyrészt visszafordíthatatlan virilizációt (mély hang, szőrösödés, klitorisz-megnagyobbodás) okoz, és magzati fejlődési ártalmat is jelent.", "en": "Women, especially in or considering pregnancy: MENT is an extremely strong androgen causing rapid and largely irreversible virilization (voice deepening, hair growth, clitoral enlargement) and posing a risk of fetal harm.", "pl": "Kobiety, zwłaszcza w ciąży lub ją rozważające: MENT jest niezwykle silnym androgenem powodującym szybką i w dużej mierze nieodwracalną wirylizację (pogłębienie głosu, owłosienie, powiększenie łechtaczki) oraz ryzyko uszkodzenia płodu." },
    { "hu": "Prolaktinóma, hyperprolaktinaemia vagy bármilyen prolaktin-érzékeny állapot: a 19-nor progesztogén aktivitás miatt abszolút ellenjavallat (a meglévő prolaktin-problémát súlyosbítja).", "en": "Prolactinoma, hyperprolactinemia or any prolactin-sensitive condition: an absolute contraindication because of the 19-nor progestogenic activity, which worsens existing prolactin problems.", "pl": "Prolaktynoma, hiperprolaktynemia lub jakikolwiek stan wrażliwy na prolaktynę: bezwzględne przeciwwskazanie z powodu progestagennej aktywności 19-nor, która nasila istniejące problemy z prolaktyną." },
    { "hu": "Meglévő szív- és érrendszeri betegség, kontrollálatlan magas vérnyomás vagy kedvezőtlen lipidprofil: az androgén HDL-csökkentő, vízvisszatartó és hematokrit-emelő hatása fokozza a kardiovaszkuláris eseménykockázatot.", "en": "Pre-existing cardiovascular disease, uncontrolled hypertension or an adverse lipid profile: the androgen's HDL-lowering, fluid-retaining and hematocrit-raising effects increase cardiovascular event risk.", "pl": "Istniejąca choroba sercowo-naczyniowa, niekontrolowane nadciśnienie lub niekorzystny profil lipidowy: obniżanie HDL, zatrzymywanie płynów i podnoszenie hematokrytu przez androgen zwiększają ryzyko zdarzeń sercowo-naczyniowych." },
    { "hu": "Aktuális vagy közeljövőben tervezett apaság: az erős HPTA-szuppresszió és spermatogenezis-leállás miatt a fogamzóképesség jelentősen csökken, és a felépülés bizonytalan.", "en": "Current or near-future plans for fatherhood: strong HPTA suppression and shutdown of spermatogenesis markedly reduce fertility, with uncertain recovery.", "pl": "Aktualne lub bliskie plany ojcostwa: silna supresja HPTA i zahamowanie spermatogenezy znacznie obniżają płodność, a powrót do normy jest niepewny." },
    { "hu": "Pszichiátriai hajlam (depresszió, szorongás, agresszió-kontroll zavar): a progesztogén/prolaktin és androgén hatás hangulati instabilitást és depresszív epizódokat válthat ki.", "en": "Psychiatric predisposition (depression, anxiety, aggression-control disorders): the progestogenic/prolactin and androgenic effects can trigger mood instability and depressive episodes.", "pl": "Predyspozycja psychiatryczna (depresja, lęk, zaburzenia kontroli agresji): działanie progestagenne/prolaktynowe i androgenne może wywołać niestabilność nastroju i epizody depresyjne." },
  ...
  "aromatization": "Yes — CYP19 substrate, metabolite 7α-methylestradiol (lower ER affinity than plain E2); clinically E2 elevation moderate-low (Sundaram 1993 PMID 8489761, Pope-Kanayama 2014 PMID 24423981)",
  ...
  "bindingAffinity": "Extremely high AR affinity (~8-10x testosterone in vitro, Sundaram 1993 PMID 8489761) + moderate PR activity.",
