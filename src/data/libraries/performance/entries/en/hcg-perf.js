...
export default {
  ...
  "keyInfo": [
    {"label": "Mechanism", "value": "Leydig-cell LHCGR receptor agonist (LH structural analog, ~80% β-subunit identity)"},
    {"label": "Dosing (PCT-blast)", "value": "1500-2500 IU EOD × 10-14 days"},
    {"label": "Dosing (mid-cycle)", "value": "250-500 IU 2-3x/week"},
    {"label": "Half-life", "value": "uHCG: 24-36 h / rHCG (Ovidrel): 30-50 h"},
    {"label": "Legal status", "value": "FDA + EMA Rx (fertility indications), WADA S2 (banned in+out-of-competition)"}
  ],
  ...
  "expectations": [
    {"label": "Mid-cycle week 1", "body": "Testicular fullness returns (visibly measurable if atrophy already set in). Subjective: 'slightly better' sensation."},
    {"label": "Mid-cycle chronic", "body": "Testicular volume stabilizes at baseline (NOT full regrowth, only prevention). E2 may rise → AI co-admin may be needed."},
    {"label": "PCT-blast weeks 1-2", "body": "Measurable Test rise (3-7 days), endogenous Leydig functionality activates. E2 rebound monitor."},
    {"label": "PCT-blast end + SERM transition", "body": "HCG stop, SERM PCT (Nolvadex) start. HPTA recovery 4-6 weeks."}
  ],
  "quality": {
    "pure": [
