...
export default {
  ...
  "keyInfo": [
    {"label": "Mechanism", "value": "Non-steroidal selective AR modulator (aryl-propionamide). Strong AR agonist in muscle, moderate prostate."},
    {"label": "Anabolic activity (Dalton 2011)", "value": "1.3 kg lean body mass gain @ 3 mg/day, 16 weeks, cancer cachexia patients."},
    {"label": "Half-life", "value": "~24 h (oral)"},
    {"label": "Onset", "value": "2-4 weeks"},
    {"label": "Legal status", "value": "Never FDA-approved (Phase III POWER failed 2016). UGL 'research chemical'. WADA-banned S1.2."}
  ],
  ...
  "expectations": [
    {"label": "First 2 weeks", "body": "Anecdotal strength gain moderate, lean mass change NOT yet measurable."},
    {"label": "Weeks 4-8", "body": "Lean mass gain 1-3 kg (UGL anecdotes at 12.5-25 mg/day), HPTA suppression begins (LH/FSH ~30-50%)."},
    {"label": "End of week 8", "body": "Maximum effect (2-4 kg lean mass UGL), PCT planning. Hepatic monitoring."}
  ],
  "quality": {
    "pure": [
