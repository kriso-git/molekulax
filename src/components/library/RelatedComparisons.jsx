  ...
  return (
    <section className="px-6 sm:px-10 py-3">
      <div className="flex flex-wrap items-center gap-x-3 gap-y-2">
        <h2 className="text-[11px] uppercase tracking-[0.2em] inline-flex items-center gap-1.5 shrink-0" style={{ color: 'var(--text-muted)' }}>
          <GitCompareArrows size={14} strokeWidth={2} aria-hidden="true" style={{ color: '#818cf8' }} />
        ...
        {cmps.map((cmp) => {
          ...
          return (
            <a
              ...
              className="group inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[13px] no-underline transition-all duration-300"
              style={{ background: 'rgba(129,140,248,0.10)', border: '1px solid rgba(129,140,248,0.28)', color: 'var(--text-primary)' }}
            >
