...
function ParticleField({ color = '#a78bfa', count = 32 }) {
 const ref = useRef(null)
 useEffect(() => {
...
function LabTerminal({ rows, accent, tr }) {
...
// ─── Section eyebrow ────────────────────────────────────────────────
function Eyebrow({ icon: Icon, label, accent }) {
 return (
...
function GlassCard({ children, accent, className = '', style = {}, area, tilt = true }) {
...
function TabPills({ tabs, active, onChange, accent }) {
 return (
 <div
