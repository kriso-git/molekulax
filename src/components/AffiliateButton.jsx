...
// coupon. Doesn't animate with scroll; just always sits in the corner.
// Localised label via useLang(). External link opens in a new tab.
...
export default function AffiliateButton() {
  ...
  return (
    <a
      ...
      className="
        hidden md:inline-flex group fixed top-3 left-3 z-[60]
        items-center gap-2.5 pl-2.5 pr-3.5 py-2
        rounded-full backdrop-blur-md
        transition-all duration-200
        hover:-translate-y-px hover:shadow-[0_8px_24px_-8px_rgba(0,255,153,0.45)]
      "
      style={{
