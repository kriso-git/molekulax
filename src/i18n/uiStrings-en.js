...
export const UI_EN = {
  ...
  "form.eyebrow": "Personalized consultation",
  "form.title": "Want a detailed conversation tailored to your data?",
  "form.body": "Fill out the short intake form (your goals, training and health data), and the advisor prepares from it to give genuinely personalized guidance.",
  "form.cta": "Fill out the form",
  "form.note": "~5–10 min · confidential · GDPR-compliant",
